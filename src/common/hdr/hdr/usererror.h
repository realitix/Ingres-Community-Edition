...
**	    Added E_US119A_ASSERTION_FAILED for ASSERT
**	28-Apr-2011 (kschendel) m1920
**	    Add 24F8 NO_KEYSET_VW.
**	29-Jul-2011 (kschendel) SIR 125587
**	    Add 24F7 for vwloader.
**/

/*
...
#define			E_US0045_CHARSET_CONFLICT   0x45
...
/* User error for ASSERT function */
#define			E_US119A_ASSERTION_FAILED (E_US_MASK + 0x119AL)
...
/* IVW related errors */
/* ******* FIXME lots of 'em need proper definitions here */

#define		E_US24F7_9463_NOT_VW_TABLE		(E_US_MASK + 0x24F7)
#define		E_US24F8_9464_NO_KEYSET_VW		(E_US_MASK + 0x24F8)
