...
**          Added SC930_LTYPE_QFETCH and SC930_LTYPE_QCLOSE for QUEL cursors
**          and bumped SC930_VERSION
**      02-Jun-2011 (maspa05) bug 123897
**          Added ult_set_trace_blobseg() and ult_trace_blogsegs
**          Also define SC930_DATAVAL_BUFSIZE in terms of BLOB_SEGMENT_SIZE
**      08-Jun-2011 (maspa05) bug 123897
**          define ult_set_trace_blobseg(void) for fussier versions of GCC
**      17-Jun-2011 (hanal04) Bug 125454
**          Bump sc930 output version now that LOB Locator types are
**          supported.
**      22-Jul-2011 (maspa05)
**          Added SC930_LTYPE_VECTORWISE_QRY for Vectorwise query text
**/
...
#define	SC930_VERSION		12	/* version of SC930 output */
...
#define SC930_LTYPE_QCLOSE		35
#define SC930_LTYPE_QFETCH		36
#define SC930_LTYPE_VECTORWISE_QRY      37

/* size of blob segment */
#define ULF_BLOB_SEGMENT_LENGTH       2000

/* Buffer size for SC930 data values - used by adu_sc930prtdataval 
** needs to be at least as large as the blob segment size 
*/

#define SC930_DATAVAL_BUFSIZE         (ULF_BLOB_SEGMENT_LENGTH + 48)

/* set/get number of blob segments for SC930 to output */
FUNC_EXTERN void ult_set_trace_blobseg(i4);
FUNC_EXTERN i4 ult_trace_blobsegs(void);

/* default value for number of blob segments to output in SC930 tracing */
#define SC930_DEFAULT_BLOBSEGS        16
