...
**      09-Mar-2011 (maspa05) b125166
**          Added W_DU1013_UTIL_ABORT 
**      12-apr-2011 (stial01) m1577
**          Added E_DU503F_VERIFY_UNSUPPORTED
**      20-Sep-2010 (hanal04) SIR 125772
**          Added E_DU6522_CHARSET_CONFLICT. Updated 
**          E_DU6521_UNORM_NFC_WITH_NFD to E_DU6521_UNICODE_FLAG_CONFLICT.
**/
...
#define			W_DU1013_UTIL_ABORT		(E_DUF_MASK + 0x1013L)
...
#define                 E_DU503F_VERIFY_UNSUPPORTED	(E_DUF_MASK + 0x503FL)
...
#define			E_DU6521_UNICODE_FLAG_CONFLICT	(E_DUF_MASK + 0X6521L)
#define			E_DU6522_CHARSET_CONFLICT	(E_DUF_MASK + 0X6522L)
