...
**	    Comment-only update re message type size (i2).
*/
...
**
** Note: although the message type is usually if not always declared as
** an i4 here in gca.h, there's at least one place in SCF (the SCC_GCMSG)
** that wants to squeeze it into an i2.  Keep message types no larger
** than i2-sized (shouldn't be hard!).
**
