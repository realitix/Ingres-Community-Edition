...
**	    Added further bitsettings for word delimiters from
**	    WordBreakProperty.txt (6.0.0)
*/
...
#define		CE_COLLATEFRENCH 0x00100 /* This is a french collation, really
					 ...
					 */
/* Supporting v6 wordpreakproperty.txt */
#define		CE_ALetter	0x00200
#define		CE_Extend	0x00400
#define		CE_ExtendNumLet	0x00800
#define		CE_Format	0x01000
#define		CE_Katakana	0x02000
#define		CE_MidLetter	0x04000
#define		CE_MidNum	0x10000
#define		CE_MidNumLet	0x20000
#define		CE_Newline	0x40000
#define		CE_Numeric	0x80000
