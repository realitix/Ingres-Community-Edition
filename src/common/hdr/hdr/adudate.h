...
**          Add prototype for adu_21ansi_alltodt_with_precision().
**	31-Aug-2011 (kiria01) b125709
**	    Moved adu_llday_of_year & adu_3llday_of_date from static
**/
...
/*
** Define constant marker for time/timezone handling when
** the precision is not available, and then needs fixing up. 
*/
#define AD_UNKN_PREC 0
#if defined(conf_IVW)
#define AD_DFLT_TM_PREC 6 
#else
#define AD_DFLT_TM_PREC 9 
#endif
...
FUNC_EXTERN DB_STATUS adu_21ansi_alltodt_with_precision(ADF_CB          *adf_scb,
					DB_DATA_VALUE   *str_dv,
...
/* Compute day number in this year. */
FUNC_EXTERN i4 adu_llday_of_year(i4 year, i4 month, i4 day);

/* Compute absolute number of days since Fri Jan 1, 1582 */
FUNC_EXTERN i4 adu_3llday_of_date(i4 year, i4 month, i4 day);
