/*
** Copyright (c) 2002, 2006 Actian Corporation. All Rights Reserved.
*/
	...
	**	28-oct-11 (thoda04)
	**	    Class IngresException should be a sub-class of
	**	    DbException, not SystemException.  Bug 125900.
	*/
...
namespace Ingres.Client 
{
	...
	*/
	...
	[Serializable]
	public sealed class IngresException : System.Data.Common.DbException
	{
