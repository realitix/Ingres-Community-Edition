...
**         Change data type of BindOffsetPtr and similar fields from
**         (SQLUINTEGER *) to (SQLULEN *) for 64-bit.
*/
    ...
    SQLINTEGER  *pStringLength)
{
    ...
    SQLULEN     *pvParamulen  = (SQLULEN *)ValuePtr;
    ...
    SQLULEN    **pvParampulen = (SQLULEN**)ValuePtr;
    SQLINTEGER   StringLength = sizeof(i4);  /* default Stringlength */
    RETCODE      rc     = SQL_SUCCESS;
    ...
    case SQL_CURSOR_TYPE:
        if (pdbc->fAPILevel >= IIAPI_LEVEL_5)
        {
            if (vParamuint == SQL_CURSOR_FORWARD_ONLY || vParamuint ==
                ...
                pdbc->fCursorType = (UWORD)vParamuint;
            break;
        }
