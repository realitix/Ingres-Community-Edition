...
**      28-Mar-2011 (hanal04) SIR 125220
**          Added ISO4T and ISO4TC support.
*/
...
GLOBALDEF AIT_SYMINT	CP_DATE_FORMAT_TBL[MAX_CP_DATE_FORMAT] =
{
	...
	{"IIAPI_CPV_DFRMT_ISO4T",	IIAPI_CPV_DFRMT_ISO4T},		/* 10 */
	{"IIAPI_CPV_DFRMT_ISO4TC",	IIAPI_CPV_DFRMT_ISO4TC}		/* 11 */
};
...
GLOBALDEF AIT_SYMINT	EP_SYMINT_TBL[MAX_EP_SYMINT] =
{
	...
	*/
	...
	{"IIAPI_EPV_DFRMT_ISO4T",	IIAPI_EPV_DFRMT_ISO4T},		/* 10 */
	{"IIAPI_EPV_DFRMT_ISO4TC",	IIAPI_EPV_DFRMT_ISO4TC}		/* 11 */
};
