...
**	    Minor tweaks to prototype fixes.
**	27-May-2011 (kiria01) b125386
**	    Employ table macros for generating constant lists for 
**	    debug trace.
**	10-Oct-2011 (smeke01) b125834
**          Add ADI_INTMATH_FIXED to lnc_name. Also add ADI_LONGER23RES,
**          ADI_RPT and ADI_CAST as these were missing. Remove ADI_IMULI,
**          ADI_IADDI, ADI_ISUBI and ADI_IDIVI as these are no longer used.
**/
...
static VOID	   ade_2prvalue(VOID          (*fcn)(char *, ...),
				DB_DATA_VALUE  *db_dv);
...
/* 40 - 59 */
    ...
    "ADI_DECROUND",  "ADI_DECCEILFL", "ADI_O1UNIDBL", NULL,
    NULL,	     NULL,	      NULL,	      "ADI_MINADD1",
/* 60 - 79 */
    "ADI_O1UNORM",   "ADI_PATCOMP",   "ADI_PATCOMPU", "ADI_O1AES",
    "ADI_LONGER23RES", "ADI_RPT",     "ADI_CAST",     "ADI_INTMATH_FIXED",
    NULL,	     NULL,	      NULL,  	      NULL,
    NULL,	     NULL,	      NULL,  	      NULL,
    NULL,	     NULL,	      NULL,	      NULL,
...
**          Use FEXI function table to print adf trace message and 
**          remove reference to scf.h file.
**	09-dec-2010 (gupsh01) SIR 124685.
**	    Prototype fixup.
[@history_template@]...
*/
static VOID
...
ADI_FI_ID	    *instr)
{
	...
	switch (adi_fid)
	{
#define _DEFINE(name,val) case val: adf_printf(#name);break;
#define _DEFINE2(name,val) case val: adf_printf(#name);break;
#define _ENDDEFINE
	ADE_INSTR_MACRO
	ADE_CXI_MACRO
#undef _DEFINE
