...
**      05-Apr-2011 (coomi10) b125238
**          Add II_FID_F1_VARFI corresponding with ADI_F1_VARFI to
**          flag functions with non-constant results.
[@history_template@]...
*/
...
#define                 II_FID_F1_VARFI        1 /* Indicates that the FI may
                                                 ** return a variable result
