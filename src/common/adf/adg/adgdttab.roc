...
**          Add dt uni, to show the unicode equivalent type for a given
**          datatype. In most instances this will be the same as the
**          datatype as no unicode equivalent exists.
**/
...
/*---------------------------------------------------------------------------*/
/* { { datatype name }, datatype id, dt family id, dt touni, status_bits,    */ 
/*      <unused>,                                                            */
...
/* }                                                                         */
/*---------------------------------------------------------------------------*/
    { { "abrtsstr" },   DB_DYC_TYPE,    0,      DB_DYC_TYPE, 0,          0,
    ...
    { { "c" },          DB_CHR_TYPE,    0, DB_CHR_TYPE, AD_INTR | AD_INDB,  0,
    ...
    { { "char" },       DB_CHA_TYPE,    0, DB_NCHR_TYPE, AD_INTR | AD_INDB,  0, 
    ...
    { { "float" },      DB_FLT_TYPE,    0, DB_FLT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "integer" },    DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "decimal" },  DB_DEC_TYPE,    0, DB_DEC_TYPE, 
    ...
    { { "longtext" },   DB_LTXT_TYPE,   0, DB_LTXT_TYPE, AD_INTR,            0, 
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
    ...
    { { "money" },      DB_MNY_TYPE,              0, DB_MNY_TYPE, AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
    ...
    { { "text" },       DB_TXT_TYPE,    0, DB_TXT_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE,  1, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_textcmp,        adu_cbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "varchar" },    DB_VCH_TYPE,    0, DB_NVCHR_TYPE, AD_INTR | AD_INDB,  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_varcharcmp,     adu_cbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "boolean" },    DB_BOO_TYPE,    0, DB_BOO_TYPE, AD_INTR | AD_INDB, 0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
    ...
    { { "table_key" },     DB_TABKEY_TYPE,    0, DB_TABKEY_TYPE, 
                           (AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
    ...
    { { "object_key" },    DB_LOGKEY_TYPE,    0, DB_LOGKEY_TYPE,
                           (AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_1logkey_cmp,    adu_bbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "long varchar" },    DB_LVCH_TYPE, 0, DB_LNVCHR_TYPE,
    ...
    { { "bit varying" },    DB_VBIT_TYPE, 0, DB_VBIT_TYPE,
			(AD_INTR /* | AD_INDB */ | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_bit_compare,	adu_bitbldkey,
    ...
    { { "byte" },    DB_BYTE_TYPE, 0, DB_BYTE_TYPE,
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "byte varying" },    DB_VBYTE_TYPE, 0, DB_VBYTE_TYPE,
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_byte_compare,	adu_bitbldkey,
    ...
    { { "long byte" },    DB_LBYTE_TYPE, 0, DB_LBYTE_TYPE,
...
*/
    { { "character" },  DB_CHA_TYPE,    0, DB_NCHR_TYPE, AD_INTR | AD_INDB,  0, 
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_varcharcmp,     adu_cbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_inplace_hashprep, adc_1helem_rti,
    ...
    { { "character varying" },    DB_VCH_TYPE,    0, DB_NVCHR_TYPE, 
                            AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_varcharcmp,     adu_cbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "vchar" },      DB_TXT_TYPE,    0, DB_TXT_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE,  1, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_textcmp,        adu_cbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "clob" },    DB_LVCH_TYPE, 0, DB_LNVCHR_TYPE, 
			(AD_INDB | AD_PERIPHERAL |
				AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, DB_VCH_TYPE,
				/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "character large object" },    DB_LVCH_TYPE, 0, DB_LNVCHR_TYPE,
			(AD_INDB | AD_PERIPHERAL |
				AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, DB_VCH_TYPE,
				/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "char large object" },    DB_LVCH_TYPE, 0, DB_LNVCHR_TYPE,
			(AD_INDB | AD_PERIPHERAL |
				AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, DB_VCH_TYPE,
				/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "varbyte" },    DB_VBYTE_TYPE, 0, DB_VBYTE_TYPE,
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_byte_compare,	adu_bitbldkey,
    ...
    { { "binary large object" },    DB_LBYTE_TYPE, 0, DB_LBYTE_TYPE,
			(AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
				AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
			/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "blob" },    DB_LBYTE_TYPE, 0, DB_LBYTE_TYPE,
			(AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
				AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
			/*	{ embed#, (#), def len, scale, prec } */
    ...
    { { "binary" },    DB_BYTE_TYPE, 0, DB_BYTE_TYPE,
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_byte_compare,	adu_bitbldkey,
    ...
    { { "binary varying" },    DB_VBYTE_TYPE, 0, DB_VBYTE_TYPE,
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_byte_compare,	adu_bitbldkey,
    ...
    { { "varbinary" },    DB_VBYTE_TYPE, 0, DB_VBYTE_TYPE, 
			(AD_INTR | AD_INDB | AD_CONDEXPORT),  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
			/*	{ embed#, (#), def len, scale, prec } */
	    {   adc_1lenchk_rti,    adc_byte_compare,	adu_bitbldkey,
    ...
    { { "f" },          DB_FLT_TYPE,    0, DB_FLT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "real" },       DB_FLT_TYPE,    0, DB_FLT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "double precision" }, DB_FLT_TYPE, 0, DB_FLT_TYPE, AD_INTR | AD_INDB, 0,
    ...
    { { "int" },        DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ TRUE,  FALSE, 4, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adc_int_compare,    adu_ibldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "i" },          DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ TRUE,  FALSE, 4, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adc_int_compare,    adu_ibldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "smallint" },   DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "bigint" },   DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 8, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adc_int_compare,    adu_ibldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "tinyint" },   DB_INT_TYPE,    0, DB_INT_TYPE, AD_INTR | AD_INDB,  0,  
    ...
    { { "dec" },      DB_DEC_TYPE,    0, DB_DEC_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 3, 5, 0 }, 0,
	    {   adc_1lenchk_rti,    adc_dec_compare,    adu_decbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "numeric" },  DB_DEC_TYPE,    0, DB_DEC_TYPE, AD_INTR | AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 3, 5, 0 }, 0,
	    {   adc_1lenchk_rti,    adc_dec_compare,    adu_decbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
...
*/
    { { "ingresdate" },       DB_DTE_TYPE,    DB_DTE_TYPE, DB_DTE_TYPE, 
                            AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
    ...
    { { "ansidate" },       DB_ADTE_TYPE,    DB_DTE_TYPE, DB_ADTE_TYPE, 
                            AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "time without time zone" },       DB_TMWO_TYPE,    DB_DTE_TYPE, 
                            DB_TMWO_TYPE, AD_INDB,  0,  
    ...
    { { "time" },       DB_TMWO_TYPE,    DB_DTE_TYPE, DB_TMWO_TYPE, AD_INDB,  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "time with time zone" },       DB_TMW_TYPE,    DB_DTE_TYPE, DB_TMW_TYPE,
                            AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "time with local time zone" },       DB_TME_TYPE,    DB_DTE_TYPE, 
                            DB_TME_TYPE, AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "timestamp without time zone" },  DB_TSWO_TYPE,    DB_DTE_TYPE, 
                            DB_TSWO_TYPE, AD_INDB,  0,  
    ...
    { { "timestamp" },  DB_TSWO_TYPE,    DB_DTE_TYPE, DB_TSWO_TYPE, AD_INDB,  0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 6 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "timestamp with time zone" },  DB_TSW_TYPE,    DB_DTE_TYPE, DB_TSW_TYPE,
                            AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 6 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
    ...
    { { "timestamp with local time zone" },  DB_TSTMP_TYPE,    DB_DTE_TYPE, 
                            DB_TSTMP_TYPE, AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 6 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "interval year to month" },   DB_INYM_TYPE,    DB_DTE_TYPE, 
                            DB_INYM_TYPE, AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
    ...
    { { "interval day to second" },   DB_INDS_TYPE,    DB_DTE_TYPE, 
                            DB_INDS_TYPE, AD_INDB,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 0, 0, 0 }, 0,
	    {   adc_1lenchk_rti,    adu_4date_cmp,      adu_dbldkey,
		adc_1getempty_rti,  adc_1klen_rti,      adc_2kcvt_rti,
		adc_1valchk_rti,    adc_1hashprep_rti,  adc_1helem_rti,
...
*/
    { { "fe_query" },   DB_QUE_TYPE,            0, DB_QUE_TYPE, 0,          0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
...
*/
    { { "II_DIFFERENT" },     DB_DIF_TYPE,      0, DB_DIF_TYPE, 0,          0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
...
*/
    { { "UTF8" },     DB_UTF8_TYPE,      0, DB_UTF8_TYPE, 0,          0,
	{ 0, }, { 0, },     NULL,       { FALSE, FALSE, 0, 0, 0 }, 0,
            {   adc_1lenchk_rti,               NULL,               NULL,
                NULL,               NULL,               NULL,
                NULL,               NULL,               NULL,
...
*/
    { { "nchar" },  DB_NCHR_TYPE, 0, DB_NCHR_TYPE, 
			(AD_INTR | AD_INDB),  0,
	{ 0, }, { 0, },     NULL,       { FALSE, TRUE, 1, 0, 0 }, 0,
...
*/
    { { "nvarchar" },  DB_NVCHR_TYPE, 0, DB_NVCHR_TYPE,
			(AD_INTR | AD_INDB),  0,
	{ 0, }, { 0, },     NULL,       { FALSE, TRUE, 1, 0, 0 }, 0,
            {   adc_1lenchk_rti,     adu_nvchrcomp,      adu_nvchbld_key,
                adc_1getempty_rti,   adc_1klen_rti,      adc_2kcvt_rti,
...
*/
    { { "long nvarchar" },    DB_LNVCHR_TYPE, 0, DB_LNVCHR_TYPE,
                        (AD_INDB | AD_PERIPHERAL |
                                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
...
*/
    { { "nclob" },    DB_LNVCHR_TYPE, 0, DB_LNVCHR_TYPE,
                        (AD_INDB | AD_PERIPHERAL |
                                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },     NULL,       { FALSE, TRUE, 0, 0, 0 }, DB_NVCHR_TYPE,
                                /*      { embed#, (#), def len, scale, prec } */
...
*/
    { { "nchar large object" },    DB_LNVCHR_TYPE, 0, DB_LNVCHR_TYPE,
                        (AD_INDB | AD_PERIPHERAL |
                                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },     NULL,       { FALSE, TRUE, 0, 0, 0 }, DB_NVCHR_TYPE,
                                /*      { embed#, (#), def len, scale, prec } */
...
*/
    { { "national character large object" },    DB_LNVCHR_TYPE, 0,
                        DB_LNVCHR_TYPE, (AD_INDB | AD_PERIPHERAL |
                                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
	{ 0, }, { 0, },     NULL,       { FALSE, TRUE, 0, 0, 0 }, DB_NVCHR_TYPE,
                                /*      { embed#, (#), def len, scale, prec } */
            {   adc_1lenchk_rti,    adu_lvarcharcmp,    NULL,
...
*/
    { { "II_NOTUSED SEC LBL" },     DB_SEC_TYPE,      0, DB_SEC_TYPE, 0, 0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
    ...
    { { "II_NOTUSED SEC LBL1" },     DB_SECID_TYPE,      0, DB_SECID_TYPE, 0, 0,
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
...
*/
    { { "long nvarchar locator" },    DB_LNLOC_TYPE, 0, DB_LNLOC_TYPE,
...
** long byte locator
*/
    { { "long byte locator" },    DB_LBLOC_TYPE, 0, DB_LBLOC_TYPE,
                        (AD_INTR | AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY | AD_LOCATOR),  0,
...
*/
    { { "long varchar locator" },    DB_LCLOC_TYPE, 0, DB_LCLOC_TYPE,
                        (AD_INTR | AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY | AD_LOCATOR),  0,
    ...
    { { "pattern" },    DB_PAT_TYPE,    0, DB_PAT_TYPE, AD_INTR,  0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, TRUE, 1, 0, 0 }, 0,
...
/* GeometryCollection type - to be treated the same as LBYTE */
    { { "geometrycollection" },    DB_GEOMC_TYPE, DB_GEOM_TYPE, DB_GEOMC_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Geometry type - abstract container of Geometry Family 
   To be treated the same as LBYTE */
    { { "geometry" },    DB_GEOM_TYPE, DB_GEOM_TYPE, DB_GEOM_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Point in the geometry family */
    { { "point" },    DB_POINT_TYPE, DB_GEOM_TYPE, DB_POINT_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiPoint in the geometry family */
    { { "multipoint" },    DB_MPOINT_TYPE, DB_GEOM_TYPE, DB_MPOINT_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* LineString in the geometry family*/
    { { "linestring" },    DB_LINE_TYPE, DB_GEOM_TYPE, DB_LINE_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiLineString in the geometry family*/
    { { "multilinestring" },    DB_MLINE_TYPE, DB_GEOM_TYPE, DB_MLINE_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Polygon in the geometry family */
    { { "polygon" },    DB_POLY_TYPE, DB_GEOM_TYPE, DB_POLY_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiPolygon in the geometry family */
    { { "multipolygon" },    DB_MPOLY_TYPE, DB_GEOM_TYPE, DB_MPOLY_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* GeometryCollection type - to be treated the same as LBYTE */
    { { "st_geometrycollection" },   DB_GEOMC_TYPE, DB_GEOM_TYPE, DB_GEOMC_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Geometry type - abstract container of Geometry Family 
   To be treated the same as LBYTE */
    { { "st_geometry" },    DB_GEOM_TYPE, DB_GEOM_TYPE, DB_GEOM_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Point in the geometry family */
    { { "st_point" },    DB_POINT_TYPE, DB_GEOM_TYPE, DB_POINT_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiPoint in the geometry family */
    { { "st_multipoint" },    DB_MPOINT_TYPE, DB_GEOM_TYPE, DB_MPOINT_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* LineString in the geometry family*/
    { { "st_linestring" },    DB_LINE_TYPE, DB_GEOM_TYPE, DB_LINE_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiLineString in the geometry family*/
    { { "st_multilinestring" },    DB_MLINE_TYPE, DB_GEOM_TYPE, DB_MLINE_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* Polygon in the geometry family */
    { { "st_polygon" },    DB_POLY_TYPE, DB_GEOM_TYPE, DB_POLY_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* MultiPolygon in the geometry family */
    { { "st_multipolygon" },    DB_MPOLY_TYPE, DB_GEOM_TYPE, DB_MPOLY_TYPE,
            (AD_INDB | AD_PERIPHERAL | AD_CONDEXPORT |
                AD_NOHISTOGRAM | AD_NOSORT | AD_NOKEY),  0,
    { 0, }, { 0, },     NULL,   { FALSE, TRUE, 0, 0, 0 }, DB_VBYTE_TYPE,
            /*  { embed#, (#), def len, scale, prec } */
...
/* NBR type - DB_GEOM_TYPE family for indexing, but not a typcial geom type.*/
    { { "NBR" },    DB_NBR_TYPE, DB_GEOM_TYPE, DB_NBR_TYPE,
...
** END OF DATA TYPES
*/
    { { "END_OF_DTs" }, DB_NODT,                0, DB_NODT, 0,          0,  
	{ 0, }, { 0, },	    NULL,	{ FALSE, FALSE, 0, 0, 0 }, 0,
	    {   NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
		NULL,               NULL,               NULL,
