...
**	    Added ASSERT
**       08-Apr-2011 (horda03) b125177
**          Add Illegal datatype combination functions.
**      18-Apr-2011 (hanal04) SIR 125274
**          Add ADFI_2061_C_COPYTO_UTF8, ADFI_2062_TEXT_COPYTO_UTF8, 
**          ADFI_2063_UTF8_C, ADFI_2064_UTF8_TEXT to allow copydb/unloaddb 
**          to generate portable UTF8 data files.
**	04-May-2011 (kiria01) SIR 125342
**	    Added INITCAP support
**	8-may-2011 (dougi)
**	    Added rank(), dense_rank(), row_number(), percent_rank() &
**	    cume_dist() windowing functions.
**	04-Jun-2011 (kiria01) SIR 125419
**	    Add REPEAT function constants
**	5-june-2011 (dougi) Code sprint
**	    Add entries for rand(), rand(int) and srand().
**      07-Jun-2011 (coomi01) b125400
**          Add 4 variants of DATE_PART_DECIMAL constants
**	07-Jul-2011 (kiria01) b125508
**	    Add ADFI_1496_ABS_DATE
**	18-Jul-2011 (kiria01) b125530
**	    Added further spatial ids for better coercion handling.
**	28-Jul-2011 (kiria01) b125530
**	    Added signalling coercions to properly trap truncation
**	    when using length qualified explicit coercions.
**	09-Aug-2011 (kiria01) b125634
**	    Added distinct substr() functions and addd missing
**	    substring for varbyte.
**	26-Aug-2011 (kiria01) SIR 125693
**	    Add ids for date_format/time_format, dayofweek, dayofmonth,
**	    dayofyear/doy, unix_timestamp, from_unixtime, last_day and
**	    months_between.
**	31-Aug-2011 (kiria01) b125709
**	    Add millisecond(), dayofweek(date,i) & block intervals
**	    with date_format.
**	12-Oct-2011 (kiria01) b125835 
**	    Added ADFI_1545_ANSIDATE_SUB_INDS, ADFI_1546_ANSIDATE_ADD_INDS,
**	    ADFI_1541_I_TO_INDS, ADFI_1542_INDS_TO_I, ADFI_1543_INDS_I and
**	    ADFI_1544_INT4_INDS to support ANSIDATE INT arithmetic.
**	01-Nov-2011 (kiria01) b125852
**	    Added ADFI_1553_INGRESDATE_ALL
**	03-Nov-2011 (kiria01) b125919, m2836
**	    Add ADFI_1554_ANSIDATE_SUB_INDS, ADFI_1555_ANSIDATE_SUB_INYM
**	    and ADFI_1556_ANSIDATE_SUB_DTE
**/
...
#define ADFI_1476_ASSERT_I		(ADI_FI_ID)1476 /* ASSERT(bool,int) */
#define ADFI_1477_ASSERT_S		(ADI_FI_ID)1477 /* ASSERT(bool,varchar) */
#define ADFI_1478_INITCAP_VCH		(ADI_FI_ID)1478 /* InitCap(varchar) */
#define ADFI_1479_INITCAP_NVCH		(ADI_FI_ID)1479 /* InitCap(nvarchar) */
#define ADFI_1480_REPEAT_VCH		(ADI_FI_ID)1480 /* REPEAT(varchar, int) */
#define ADFI_1481_REPEAT_NVCH		(ADI_FI_ID)1481 /* REPEAT(nvarchar, int) */
#define	ADFI_1482_RANK			(ADI_FI_ID)1482 /* rank() OVER () */
#define	ADFI_1483_DENSERANK		(ADI_FI_ID)1483 /* dense_rank() OVER () */
#define	ADFI_1484_ROWNUM		(ADI_FI_ID)1484 /* row_number() OVER () */
#define	ADFI_1485_PERRANK		(ADI_FI_ID)1485 /* percent_rank() OVER () */
#define	ADFI_1486_CUMEDIST		(ADI_FI_ID)1486 /* cume_dist() OVER () */
#define ADFI_1487_SRAND                 (ADI_FI_ID)1487 /* Srand(int) */
#define ADFI_1488_RAND                  (ADI_FI_ID)1488 /* Rand() */
#define ADFI_1489_RAND_INT              (ADI_FI_ID)1489 /* Rand(int) */
#define ADFI_1490_ANSI_TSWO_PRECISION   (ADI_FI_ID)1490 /* timestamp_wo_tz(all,int) */
#define ADFI_1491_ANSI_TMWO_PRECISION   (ADI_FI_ID)1491 /* time_wo_tz(all,int) */
#define ADFI_1492_ANSI_LCTME_PRECISION  (ADI_FI_ID)1492 /* time_local(all,int) */
#define ADFI_1493_ANSI_TSW_PRECISION    (ADI_FI_ID)1493 /* timestamp_with_tz(all,int) */
#define ADFI_1494_ANSI_TSTMP_PRECISION  (ADI_FI_ID)1494 /* timestamp_local(all,int) */
#define ADFI_1495_ANSI_TMW_PRECISION    (ADI_FI_ID)1495 /* time_with_tz(all,int) */
#define ADFI_1496_ABS_DATE		(ADI_FI_ID)1496 /* abs(date) */
#define	ADFI_1497_NTILE			(ADI_FI_ID)1497 /* ntile(int) */
#define ADFI_1498_ABS_ADTE		(ADI_FI_ID)1498 /* abs(adte) is illegal */
#define ADFI_1499_ABS_TSW		(ADI_FI_ID)1499 /* abs(tsw) is illegal */
#define ADFI_1500_ABS_TSWO		(ADI_FI_ID)1500 /* abs(tswo) is illegal */
#define ADFI_1501_ABS_TSTMP		(ADI_FI_ID)1501 /* abs(tstmp) is illegal */
#define ADFI_1502_ABS_TMW		(ADI_FI_ID)1502 /* abs(tmw) is illegal */
#define ADFI_1503_ABS_TMWO		(ADI_FI_ID)1503 /* abs(tmwo) is illegal */
#define ADFI_1504_ABS_TME		(ADI_FI_ID)1504 /* abs(tme) is illegal */
#define ADFI_1505_ASCII_ALL_I_B		(ADI_FI_ID)1505 /* c := c(all,i,b) */
#define ADFI_1506_CHAR_ALL_I_B		(ADI_FI_ID)1506 /* char := char(all,i,b) */
#define ADFI_1507_TEXT_ALL_I_B		(ADI_FI_ID)1507 /* text := text(all,i,b) */
#define ADFI_1508_VCH_ALL_I_B		(ADI_FI_ID)1508 /* vch := varchar(all,i,b) */
#define ADFI_1509_BYTE_ALL_I_B		(ADI_FI_ID)1509 /* byte := byte(all,i,b) */
#define ADFI_1510_VBYTE_ALL_I_B		(ADI_FI_ID)1510 /* vbyte := vbyte(all,i,b) */
#define ADFI_1511_NCHR_ALL_I_B		(ADI_FI_ID)1511 /* nchr := nchar(all,i,b) */
#define ADFI_1512_NVCHR_ALL_I_B		(ADI_FI_ID)1512 /* nvch := nvarchar(all,i,b) */
#define ADFI_1513_SUBSTRING_VBYTE_I	(ADI_FI_ID)1513 /* vbyte:=substring(vbyte,i) */
#define ADFI_1514_SUBSTRING_VBYTE_I_I	(ADI_FI_ID)1514 /* vbyte:=substring(vbyte,i,i) */
#define ADFI_1515_SUBSTR_VCH_I		(ADI_FI_ID)1515 /* vch:=substr(vch,i) */
#define ADFI_1516_SUBSTR_VCH_I_I	(ADI_FI_ID)1516 /* vch:=substr(vch,i,i) */
#define ADFI_1517_SUBSTR_VBYTE_I	(ADI_FI_ID)1517 /* vbyte:=substr(vbyte,i) */
#define ADFI_1518_SUBSTR_VBYTE_I_I	(ADI_FI_ID)1518 /* vbyte:=substr(vbyte,i) */
#define ADFI_1519_SUBSTR_NVCHR_I	(ADI_FI_ID)1519 /* nvch:=substr(nvch,i) */
#define ADFI_1520_SUBSTR_NVCHR_I_I	(ADI_FI_ID)1520 /* nvch:=substr(nvch,i,i) */
#define ADFI_1521_SUBSTR_LVCH_I		(ADI_FI_ID)1521 /* lvch:=substr(lvch,i) */
#define ADFI_1522_SUBSTR_LBYTE_I	(ADI_FI_ID)1522 /* lbyte:=substr(lbyte,i) */
#define ADFI_1523_SUBSTR_LNVCHR_I	(ADI_FI_ID)1523 /* lnvch:=substr(lnvch,i) */
#define ADFI_1524_SUBSTR_LVCH_I_I	(ADI_FI_ID)1524 /* lvch:=substr(lvch,i,i) */
#define ADFI_1525_SUBSTR_LBYTE_I_I	(ADI_FI_ID)1525 /* lbyte:=substr(lbyte,i,i) */
#define ADFI_1526_SUBSTR_LNVCHR_I_I	(ADI_FI_ID)1526 /* lnvch:=substr(lnvch,i,i) */
#define ADFI_1527_DATEFMT_DTE_VCH	(ADI_FI_ID)1527 /* vch:=date_format(date,vch) */
#define ADFI_1528_DAYOFWK_DTE		(ADI_FI_ID)1528 /* i:=dayofweek(date) */
#define ADFI_1529_DAYOFMTH_DTE		(ADI_FI_ID)1529 /* i:=dayofmonth(date) */
#define ADFI_1530_DAYOFYR_DTE		(ADI_FI_ID)1530 /* i:=daofyear(date) */
#define ADFI_1531_UNXTMSTMP		(ADI_FI_ID)1531 /* i4 := unix_timestamp() */
#define ADFI_1532_UNXTMSTMP_DTE		(ADI_FI_ID)1532 /* i4 := unix_timestamp(date) */
#define ADFI_1533_FROMUNXTM_I		(ADI_FI_ID)1533 /* tswo := from_unixtime(i) */
#define ADFI_1534_FROMUNXTM_I_VCH	(ADI_FI_ID)1534 /* vch := from_unixtime(i,vch) */
#define ADFI_1535_LASTDAY_DTE		(ADI_FI_ID)1535 /* i4 := last_day(date) */
#define ADFI_1536_MTHSBTWN_DTE_DTE	(ADI_FI_ID)1536 /* dec := months_between(date,date) */
#define ADFI_1537_MILLISECONDPART	(ADI_FI_ID)1537 /* i4 := millseconds(date) */
#define ADFI_1538_DAYOFWK_DTE_I		(ADI_FI_ID)1538	/* i:=dayofweek(date) */
#define ADFI_1539_DATEFMT_INDS_VCH	(ADI_FI_ID)1539 /* BAD:=date_format(inds,vch) */
#define ADFI_1540_DATEFMT_INYM_VCH	(ADI_FI_ID)1540 /* BAD:=date_format(inym,vch) */
#define ADFI_1541_I_TO_INDS		(ADI_FI_ID)1541 /* i->INDS */
#define ADFI_1542_INDS_TO_I		(ADI_FI_ID)1542 /* INDS->i */
#define ADFI_1543_INDS_I		(ADI_FI_ID)1543 /* inds:=interval_dtos(i) */
#define ADFI_1544_INT4_INDS		(ADI_FI_ID)1544 /* i:=int(inds) */
#define ADFI_1545_DATE_SUB_INDS		(ADI_FI_ID)1545 /* dte:=dte-inds */
#define ADFI_1546_ANSIDATE_SUB_ANSIDATE	(ADI_FI_ID)1546 /* int:=adte-adte */
#define ADFI_1547_INT8_INDS		(ADI_FI_ID)1547 /* i:=int8(inds) */
#define ADFI_1548_DAYPART_INDS		(ADI_FI_ID)1548 /* i:=day(inds) */
#define ADFI_1549_INDS_DIV_DTE		(ADI_FI_ID)1549 /* f:=inds/date */
#define ADFI_1550_DTE_DIV_INDS		(ADI_FI_ID)1550 /* f:=dte/inds */
#define ADFI_1551_DATE_PART_VCH_INDS	(ADI_FI_ID)1551 /* i:=extract(c from inds) */
#define ADFI_1552_DATE_TRUNC_VCH_INDS	(ADI_FI_ID)1552 /* inds:=trunc(c,inds) */
#define ADFI_1553_INGRESDATE_ALL	(ADI_FI_ID)1553 /* ingresdate:=ingresdate(all) */
#define ADFI_1554_ANSIDATE_SUB_INDS	(ADI_FI_ID)1554 /* adte:=adte-inds */
#define ADFI_1555_ANSIDATE_SUB_INYM	(ADI_FI_ID)1555 /* adte:=adte-inym */
#define ADFI_1556_ANSIDATE_SUB_DTE	(ADI_FI_ID)1556 /* ingresdate:=ingresdate(all) */

/* Spatial starts at 1600 */
#define ADFI_1600_GEOM_GEOM		(ADI_FI_ID)1600 /* geometry(geom) */
#define ADFI_1601_POINT_GEOM		(ADI_FI_ID)1601 /* point(geom) */
#define ADFI_1602_LINE_GEOM		(ADI_FI_ID)1602 /* line(geom) */
#define ADFI_1603_POLY_GEOM		(ADI_FI_ID)1603 /* poly(geom) */
#define ADFI_1604_POINT_X               (ADI_FI_ID)1604 /* x(point)        */
#define ADFI_1605_POINT_Y               (ADI_FI_ID)1605 /* y(point)        */
#define ADFI_1606_MPOINT_GEOM		(ADI_FI_ID)1606 /* mpoint(geom) */
#define ADFI_1607_MLINE_GEOM		(ADI_FI_ID)1607 /* mline(geom) */
#define ADFI_1608_MPOLY_GEOM		(ADI_FI_ID)1608 /* mpoly(geom) */
#define ADFI_1609_GEOMC_GEOM		(ADI_FI_ID)1609 /* geomc(geom) */
#define ADFI_1610_GEOM_FROM_TEXT_VC	(ADI_FI_ID)1610 /* geomfromtext(vch) */
#define ADFI_1611_GEOM_S_FROM_TEXT_VC	(ADI_FI_ID)1611 /* geomfromtext(vch,srid) */
#define ADFI_1612_GEOM_FROM_WKB_VB	(ADI_FI_ID)1612 /* geomfromwkb(vbyte) */
#define ADFI_1613_GEOM_S_FROM_WKB_VB	(ADI_FI_ID)1613 /* geomfromwkb(vbyte,srid) */
#define ADFI_1614			(ADI_FI_ID)1614 /* */
#define ADFI_1615			(ADI_FI_ID)1615 /* */
#define ADFI_1616			(ADI_FI_ID)1616 /* */
#define ADFI_1617			(ADI_FI_ID)1617 /* */
...
#define ADFI_1701_ADTE_NE_TSTMP		(ADI_FI_ID)1701 /* ansidate                      <> timestamp with local timezone */
#define ADFI_1702_ADTE_NE_TSW		(ADI_FI_ID)1702 /* ansidate                      <> timestamp with timezone */
#define ADFI_1703_ADTE_NE_TSWO		(ADI_FI_ID)1703 /* ansidate                      <> timestamp without timezone */
#define ADFI_1704_ADTE_NE_TME		(ADI_FI_ID)1704 /* ansidate                      <> time with local timezone */
#define ADFI_1705_ADTE_NE_TMW		(ADI_FI_ID)1705 /* ansidate                      <> time with timezone */
#define ADFI_1706_ADTE_NE_TMWO		(ADI_FI_ID)1706 /* ansidate                      <> time without timezone */
#define ADFI_1707_ADTE_NE_INYM		(ADI_FI_ID)1707 /* ansidate                      <> interval year to month */
#define ADFI_1708_ADTE_NE_INDS		(ADI_FI_ID)1708 /* ansidate                      <> interval day to second */
#define ADFI_1709_TSTMP_NE_ADTE		(ADI_FI_ID)1709 /* timestamp with local timezone <> ansidate */
#define ADFI_1710_TSTMP_NE_TME		(ADI_FI_ID)1710 /* timestamp with local timezone <> time with local timezone */
#define ADFI_1711_TSTMP_NE_TMW		(ADI_FI_ID)1711 /* timestamp with local timezone <> time with timezone */
#define ADFI_1712_TSTMP_NE_TMWO		(ADI_FI_ID)1712 /* timestamp with local timezone <> time without timezone */
#define ADFI_1713_TSTMP_NE_INYM		(ADI_FI_ID)1713 /* timestamp with local timezone <> interval year to month */
#define ADFI_1714_TSTMP_NE_INDS		(ADI_FI_ID)1714 /* timestamp with local timezone <> interval day to second */
#define ADFI_1715_TSW_NE_ADTE		(ADI_FI_ID)1715 /* timestamp with timezone       <> ansidate */
#define ADFI_1716_TSW_NE_TME		(ADI_FI_ID)1716 /* timestamp with timezone       <> time with local timezone */
#define ADFI_1717_TSW_NE_TMW		(ADI_FI_ID)1717 /* timestamp with timezone       <> time with timezone */
#define ADFI_1718_TSW_NE_TMWO		(ADI_FI_ID)1718 /* timestamp with timezone       <> time without timezone */
#define ADFI_1719_TSW_NE_INYM		(ADI_FI_ID)1719 /* timestamp with timezone       <> interval year to month */
#define ADFI_1720_TSW_NE_INDS		(ADI_FI_ID)1720 /* timestamp with timezone       <> interval day to second */
#define ADFI_1721_TSWO_NE_ADTE		(ADI_FI_ID)1721 /* timestamp without timezone    <> ansidate */
#define ADFI_1722_TSWO_NE_TME		(ADI_FI_ID)1722 /* timestamp without timezone    <> time with local timezone */
#define ADFI_1723_TSWO_NE_TMW		(ADI_FI_ID)1723 /* timestamp without timezone    <> time with timezone */
#define ADFI_1724_TSWO_NE_TMWO		(ADI_FI_ID)1724 /* timestamp without timezone    <> time without timezone */
#define ADFI_1725_TSWO_NE_INYM		(ADI_FI_ID)1725 /* timestamp without timezone    <> interval year to month */
#define ADFI_1726_TSWO_NE_INDS		(ADI_FI_ID)1726 /* timestamp without timezone    <> interval day to second */
#define ADFI_1727_TME_NE_ADTE		(ADI_FI_ID)1727 /* time with local timezone      <> ansidate */
#define ADFI_1728_TME_NE_TSTMP		(ADI_FI_ID)1728 /* time with local timezone      <> timestamp with local timezone*/
#define ADFI_1729_TME_NE_TSW		(ADI_FI_ID)1729 /* time with local timezone      <> timestamp with timezone */
#define ADFI_1730_TME_NE_TSWO		(ADI_FI_ID)1730 /* time with local timezone      <> timestamp without timezone */
#define ADFI_1731_TME_NE_INYM		(ADI_FI_ID)1731 /* time with local timezone      <> interval year to month */
#define ADFI_1732_TME_NE_INDS		(ADI_FI_ID)1732 /* time with local timezone      <> interval day to second */
#define ADFI_1733_TMW_NE_ADTE		(ADI_FI_ID)1733 /* time with timezone            <> ansidate */
#define ADFI_1734_TMW_NE_TSTMP		(ADI_FI_ID)1734 /* time with timezone            <> timestamp with local timezone*/
#define ADFI_1735_TMW_NE_TSW		(ADI_FI_ID)1735 /* time with timezone            <> timestamp with timezone */
#define ADFI_1736_TMW_NE_TSWO		(ADI_FI_ID)1736 /* time with timezone            <> timestamp without timezone */
#define ADFI_1737_TMW_NE_INYM		(ADI_FI_ID)1737 /* time with timezone            <> interval year to month */
#define ADFI_1738_TMW_NE_INDS		(ADI_FI_ID)1738 /* time with timezone            <> interval day to second */
#define ADFI_1739_TMWO_NE_ADTE		(ADI_FI_ID)1739 /* time without timezone         <> ansidate */
#define ADFI_1740_TMWO_NE_TSTMP		(ADI_FI_ID)1740 /* time without timezone         <> timestamp with local timezone*/
#define ADFI_1741_TMWO_NE_TSW		(ADI_FI_ID)1741 /* time without timezone         <> timestamp with timezone */
#define ADFI_1742_TMWO_NE_TSWO		(ADI_FI_ID)1742 /* time without timezone         <> timestamp without timezone */
#define ADFI_1743_TMWO_NE_INYM		(ADI_FI_ID)1743 /* time without timezone         <> interval year to month */
#define ADFI_1744_TMWO_NE_INDS		(ADI_FI_ID)1744 /* time without timezone         <> interval day to second */
#define ADFI_1745_INYM_NE_ADTE		(ADI_FI_ID)1745 /* interval year to month        <> ansidate */
#define ADFI_1746_INYM_NE_TSTMP		(ADI_FI_ID)1746 /* interval year to month        <> timestamp with local timezone*/
#define ADFI_1747_INYM_NE_TSW		(ADI_FI_ID)1747 /* interval year to month        <> timestamp with timezone */
#define ADFI_1748_INYM_NE_TSWO		(ADI_FI_ID)1748 /* interval year to month        <> timestamp without timezone */
#define ADFI_1749_INYM_NE_TME		(ADI_FI_ID)1749 /* interval year to month        <> time with local timezone */
#define ADFI_1750_INYM_NE_TMW		(ADI_FI_ID)1750 /* interval year to month        <> time with timezone */
#define ADFI_1751_INYM_NE_TMWO		(ADI_FI_ID)1751 /* interval year to month        <> time without timezone */
#define ADFI_1752_INYM_NE_INDS		(ADI_FI_ID)1752 /* interval year to month        <> interval day to second */
#define ADFI_1753_INDS_NE_ADTE		(ADI_FI_ID)1753 /* interval day to second        <> ansidate */
#define ADFI_1754_INDS_NE_TSTMP		(ADI_FI_ID)1754 /* interval day to second        <> timestamp with local timezone*/
#define ADFI_1755_INDS_NE_TSW		(ADI_FI_ID)1755 /* interval day to second        <> timestamp with timezone */
#define ADFI_1756_INDS_NE_TSWO		(ADI_FI_ID)1756 /* interval day to second        <> timestamp without timezone */
#define ADFI_1757_INDS_NE_TME		(ADI_FI_ID)1757 /* interval day to second        <> time with local timezone */
#define ADFI_1758_INDS_NE_TMW		(ADI_FI_ID)1758 /* interval day to second        <> time with timezone */
#define ADFI_1759_INDS_NE_TMWO		(ADI_FI_ID)1759 /* interval day to second        <> time without timezone */
#define ADFI_1760_INDS_NE_INYM		(ADI_FI_ID)1760 /* interval day to second        <> interval interval year to month */
#define ADFI_1761_ADTE_LT_TSTMP		(ADI_FI_ID)1761 /* ansidate                      <  timestamp with local timezone */
#define ADFI_1762_ADTE_LT_TSW		(ADI_FI_ID)1762 /* ansidate                      <  timestamp with timezone */
#define ADFI_1763_ADTE_LT_TSWO		(ADI_FI_ID)1763 /* ansidate                      <  timestamp without timezone */
#define ADFI_1764_ADTE_LT_TME		(ADI_FI_ID)1764 /* ansidate                      <  time with local timezone */
#define ADFI_1765_ADTE_LT_TMW		(ADI_FI_ID)1765 /* ansidate                      <  time with timezone */
#define ADFI_1766_ADTE_LT_TMWO		(ADI_FI_ID)1766 /* ansidate                      <  time without timezone */
#define ADFI_1767_ADTE_LT_INYM		(ADI_FI_ID)1767 /* ansidate                      <  interval year to month */
#define ADFI_1768_ADTE_LT_INDS		(ADI_FI_ID)1768 /* ansidate                      <  interval day to second */
#define ADFI_1769_TSTMP_LT_ADTE		(ADI_FI_ID)1769 /* timestamp with local timezone <  ansidate */
#define ADFI_1770_TSTMP_LT_TME		(ADI_FI_ID)1770 /* timestamp with local timezone <  time with local timezone */
#define ADFI_1771_TSTMP_LT_TMW		(ADI_FI_ID)1771 /* timestamp with local timezone <  time with timezone */
#define ADFI_1772_TSTMP_LT_TMWO		(ADI_FI_ID)1772 /* timestamp with local timezone <  time without timezone */
#define ADFI_1773_TSTMP_LT_INYM		(ADI_FI_ID)1773 /* timestamp with local timezone <  interval year to month */
#define ADFI_1774_TSTMP_LT_INDS		(ADI_FI_ID)1774 /* timestamp with local timezone <  interval day to second */
#define ADFI_1775_TSW_LT_ADTE		(ADI_FI_ID)1775 /* timestamp with timezone       <  ansidate */
#define ADFI_1776_TSW_LT_TME		(ADI_FI_ID)1776 /* timestamp with timezone       <  time with local timezone */
#define ADFI_1777_TSW_LT_TMW		(ADI_FI_ID)1777 /* timestamp with timezone       <  time with timezone */
#define ADFI_1778_TSW_LT_TMWO		(ADI_FI_ID)1778 /* timestamp with timezone       <  time without timezone */
#define ADFI_1779_TSW_LT_INYM		(ADI_FI_ID)1779 /* timestamp with timezone       <  interval year to month */
#define ADFI_1780_TSW_LT_INDS		(ADI_FI_ID)1780 /* timestamp with timezone       <  interval day to second */
#define ADFI_1781_TSWO_LT_ADTE		(ADI_FI_ID)1781 /* timestamp without timezone    <  ansidate */
#define ADFI_1782_TSWO_LT_TME		(ADI_FI_ID)1782 /* timestamp without timezone    <  time with local timezone */
#define ADFI_1783_TSWO_LT_TMW		(ADI_FI_ID)1783 /* timestamp without timezone    <  time with timezone */
#define ADFI_1784_TSWO_LT_TMWO		(ADI_FI_ID)1784 /* timestamp without timezone    <  time without timezone */
#define ADFI_1785_TSWO_LT_INYM		(ADI_FI_ID)1785 /* timestamp without timezone    <  interval year to month */
#define ADFI_1786_TSWO_LT_INDS		(ADI_FI_ID)1786 /* timestamp without timezone    <  interval day to second */
#define ADFI_1787_TME_LT_ADTE		(ADI_FI_ID)1787 /* time with local timezone      <  ansidate */
#define ADFI_1788_TME_LT_TSTMP		(ADI_FI_ID)1788 /* time with local timezone      <  timestamp with local timezone*/
#define ADFI_1789_TME_LT_TSW		(ADI_FI_ID)1789 /* time with local timezone      <  timestamp with timezone */
#define ADFI_1790_TME_LT_TSWO		(ADI_FI_ID)1790 /* time with local timezone      <  timestamp without timezone */
#define ADFI_1791_TME_LT_INYM		(ADI_FI_ID)1791 /* time with local timezone      <  interval year to month */
#define ADFI_1792_TME_LT_INDS		(ADI_FI_ID)1792 /* time with local timezone      <  interval day to second */
#define ADFI_1793_TMW_LT_ADTE		(ADI_FI_ID)1793 /* time with timezone            <  ansidate */
#define ADFI_1794_TMW_LT_TSTMP		(ADI_FI_ID)1794 /* time with timezone            <  timestamp with local timezone*/
#define ADFI_1795_TMW_LT_TSW		(ADI_FI_ID)1795 /* time with timezone            <  timestamp with timezone */
#define ADFI_1796_TMW_LT_TSWO		(ADI_FI_ID)1796 /* time with timezone            <  timestamp without timezone */
#define ADFI_1797_TMW_LT_INYM		(ADI_FI_ID)1797 /* time with timezone            <  interval year to month */
#define ADFI_1798_TMW_LT_INDS		(ADI_FI_ID)1798 /* time with timezone            <  interval day to second */
#define ADFI_1799_TMWO_LT_ADTE		(ADI_FI_ID)1799 /* time without timezone         <  ansidate */
#define ADFI_1800_TMWO_LT_TSTMP		(ADI_FI_ID)1800 /* time without timezone         <  timestamp with local timezone*/
#define ADFI_1801_TMWO_LT_TSW		(ADI_FI_ID)1801 /* time without timezone         <  timestamp with timezone */
#define ADFI_1802_TMWO_LT_TSWO		(ADI_FI_ID)1802 /* time without timezone         <  timestamp without timezone */
#define ADFI_1803_TMWO_LT_INYM		(ADI_FI_ID)1803 /* time without timezone         <  interval year to month */
#define ADFI_1804_TMWO_LT_INDS		(ADI_FI_ID)1804 /* time without timezone         <  interval day to second */
#define ADFI_1805_INYM_LT_ADTE		(ADI_FI_ID)1805 /* interval year to month        <  ansidate */
#define ADFI_1806_INYM_LT_TSTMP		(ADI_FI_ID)1806 /* interval year to month        <  timestamp with local timezone*/
#define ADFI_1807_INYM_LT_TSW		(ADI_FI_ID)1807 /* interval year to month        <  timestamp with timezone */
#define ADFI_1808_INYM_LT_TSWO		(ADI_FI_ID)1808 /* interval year to month        <  timestamp without timezone */
#define ADFI_1809_INYM_LT_TME		(ADI_FI_ID)1809 /* interval year to month        <  time with local timezone */
#define ADFI_1810_INYM_LT_TMW		(ADI_FI_ID)1810 /* interval year to month        <  time with timezone */
#define ADFI_1811_INYM_LT_TMWO		(ADI_FI_ID)1811 /* interval year to month        <  time without timezone */
#define ADFI_1812_INYM_LT_INDS		(ADI_FI_ID)1812 /* interval year to month        <  interval day to second */
#define ADFI_1813_INDS_LT_ADTE		(ADI_FI_ID)1813 /* interval day to second        <  ansidate */
#define ADFI_1814_INDS_LT_TSTMP		(ADI_FI_ID)1814 /* interval day to second        <  timestamp with local timezone*/
#define ADFI_1815_INDS_LT_TSW		(ADI_FI_ID)1815 /* interval day to second        <  timestamp with timezone */
#define ADFI_1816_INDS_LT_TSWO		(ADI_FI_ID)1816 /* interval day to second        <  timestamp without timezone */
#define ADFI_1817_INDS_LT_TME		(ADI_FI_ID)1817 /* interval day to second        <  time with local timezone */
#define ADFI_1818_INDS_LT_TMW		(ADI_FI_ID)1818 /* interval day to second        <  time with timezone */
#define ADFI_1819_INDS_LT_TMWO		(ADI_FI_ID)1819 /* interval day to second        <  time without timezone */
#define ADFI_1820_INDS_LT_INYM		(ADI_FI_ID)1820 /* interval day to second        <  interval interval year to month */
#define ADFI_1821_ADTE_LE_TSTMP		(ADI_FI_ID)1821 /* ansidate                      <= timestamp with local timezone */
#define ADFI_1822_ADTE_LE_TSW		(ADI_FI_ID)1822 /* ansidate                      <= timestamp with timezone */
#define ADFI_1823_ADTE_LE_TSWO		(ADI_FI_ID)1823 /* ansidate                      <= timestamp without timezone */
#define ADFI_1824_ADTE_LE_TME		(ADI_FI_ID)1824 /* ansidate                      <= time with local timezone */
#define ADFI_1825_ADTE_LE_TMW		(ADI_FI_ID)1825 /* ansidate                      <= time with timezone */
#define ADFI_1826_ADTE_LE_TMWO		(ADI_FI_ID)1826 /* ansidate                      <= time without timezone */
#define ADFI_1827_ADTE_LE_INYM		(ADI_FI_ID)1827 /* ansidate                      <= interval year to month */
#define ADFI_1828_ADTE_LE_INDS		(ADI_FI_ID)1828 /* ansidate                      <= interval day to second */
#define ADFI_1829_TSTMP_LE_ADTE		(ADI_FI_ID)1829 /* timestamp with local timezone <= ansidate */
#define ADFI_1830_TSTMP_LE_TME		(ADI_FI_ID)1830 /* timestamp with local timezone <= time with local timezone */
#define ADFI_1831_TSTMP_LE_TMW		(ADI_FI_ID)1831 /* timestamp with local timezone <= time with timezone */
#define ADFI_1832_TSTMP_LE_TMWO		(ADI_FI_ID)1832 /* timestamp with local timezone <= time without timezone */
#define ADFI_1833_TSTMP_LE_INYM		(ADI_FI_ID)1833 /* timestamp with local timezone <= interval year to month */
#define ADFI_1834_TSTMP_LE_INDS		(ADI_FI_ID)1834 /* timestamp with local timezone <= interval day to second */
#define ADFI_1835_TSW_LE_ADTE		(ADI_FI_ID)1835 /* timestamp with timezone       <= ansidate */
#define ADFI_1836_TSW_LE_TME		(ADI_FI_ID)1836 /* timestamp with timezone       <= time with local timezone */
#define ADFI_1837_TSW_LE_TMW		(ADI_FI_ID)1837 /* timestamp with timezone       <= time with timezone */
#define ADFI_1838_TSW_LE_TMWO		(ADI_FI_ID)1838 /* timestamp with timezone       <= time without timezone */
#define ADFI_1839_TSW_LE_INYM		(ADI_FI_ID)1839 /* timestamp with timezone       <= interval year to month */
#define ADFI_1840_TSW_LE_INDS		(ADI_FI_ID)1840 /* timestamp with timezone       <= interval day to second */
#define ADFI_1841_TSWO_LE_ADTE		(ADI_FI_ID)1841 /* timestamp without timezone    <= ansidate */
#define ADFI_1842_TSWO_LE_TME		(ADI_FI_ID)1842 /* timestamp without timezone    <= time with local timezone */
#define ADFI_1843_TSWO_LE_TMW		(ADI_FI_ID)1843 /* timestamp without timezone    <= time with timezone */
#define ADFI_1844_TSWO_LE_TMWO		(ADI_FI_ID)1844 /* timestamp without timezone    <= time without timezone */
#define ADFI_1845_TSWO_LE_INYM		(ADI_FI_ID)1845 /* timestamp without timezone    <= interval year to month */
#define ADFI_1846_TSWO_LE_INDS		(ADI_FI_ID)1846 /* timestamp without timezone    <= interval day to second */
#define ADFI_1847_TME_LE_ADTE		(ADI_FI_ID)1847 /* time with local timezone      <= ansidate */
#define ADFI_1848_TME_LE_TSTMP		(ADI_FI_ID)1848 /* time with local timezone      <= timestamp with local timezone*/
#define ADFI_1849_TME_LE_TSW		(ADI_FI_ID)1849 /* time with local timezone      <= timestamp with timezone */
#define ADFI_1850_TME_LE_TSWO		(ADI_FI_ID)1850 /* time with local timezone      <= timestamp without timezone */
#define ADFI_1851_TME_LE_INYM		(ADI_FI_ID)1851 /* time with local timezone      <= interval year to month */
#define ADFI_1852_TME_LE_INDS		(ADI_FI_ID)1852 /* time with local timezone      <= interval day to second */
#define ADFI_1853_TMW_LE_ADTE		(ADI_FI_ID)1853 /* time with timezone            <= ansidate */
#define ADFI_1854_TMW_LE_TSTMP		(ADI_FI_ID)1854 /* time with timezone            <= timestamp with local timezone*/
#define ADFI_1855_TMW_LE_TSW		(ADI_FI_ID)1855 /* time with timezone            <= timestamp with timezone */
#define ADFI_1856_TMW_LE_TSWO		(ADI_FI_ID)1856 /* time with timezone            <= timestamp without timezone */
#define ADFI_1857_TMW_LE_INYM		(ADI_FI_ID)1857 /* time with timezone            <= interval year to month */
#define ADFI_1858_TMW_LE_INDS		(ADI_FI_ID)1858 /* time with timezone            <= interval day to second */
#define ADFI_1859_TMWO_LE_ADTE		(ADI_FI_ID)1859 /* time without timezone         <= ansidate */
#define ADFI_1860_TMWO_LE_TSTMP		(ADI_FI_ID)1860 /* time without timezone         <= timestamp with local timezone*/
#define ADFI_1861_TMWO_LE_TSW		(ADI_FI_ID)1861 /* time without timezone         <= timestamp with timezone */
#define ADFI_1862_TMWO_LE_TSWO		(ADI_FI_ID)1862 /* time without timezone         <= timestamp without timezone */
#define ADFI_1863_TMWO_LE_INYM		(ADI_FI_ID)1863 /* time without timezone         <= interval year to month */
#define ADFI_1864_TMWO_LE_INDS		(ADI_FI_ID)1864 /* time without timezone         <= interval day to second */
#define ADFI_1865_INYM_LE_ADTE		(ADI_FI_ID)1865 /* interval year to month        <= ansidate */
#define ADFI_1866_INYM_LE_TSTMP		(ADI_FI_ID)1866 /* interval year to month        <= timestamp with local timezone*/
#define ADFI_1867_INYM_LE_TSW		(ADI_FI_ID)1867 /* interval year to month        <= timestamp with timezone */
#define ADFI_1868_INYM_LE_TSWO		(ADI_FI_ID)1868 /* interval year to month        <= timestamp without timezone */
#define ADFI_1869_INYM_LE_TME		(ADI_FI_ID)1869 /* interval year to month        <= time with local timezone */
#define ADFI_1870_INYM_LE_TMW		(ADI_FI_ID)1870 /* interval year to month        <= time with timezone */
#define ADFI_1871_INYM_LE_TMWO		(ADI_FI_ID)1871 /* interval year to month        <= time without timezone */
#define ADFI_1872_INYM_LE_INDS		(ADI_FI_ID)1872 /* interval year to month        <= interval day to second */
#define ADFI_1873_INDS_LE_ADTE		(ADI_FI_ID)1873 /* interval day to second        <= ansidate */
#define ADFI_1874_INDS_LE_TSTMP		(ADI_FI_ID)1874 /* interval day to second        <= timestamp with local timezone*/
#define ADFI_1875_INDS_LE_TSW		(ADI_FI_ID)1875 /* interval day to second        <= timestamp with timezone */
#define ADFI_1876_INDS_LE_TSWO		(ADI_FI_ID)1876 /* interval day to second        <= timestamp without timezone */
#define ADFI_1877_INDS_LE_TME		(ADI_FI_ID)1877 /* interval day to second        <= time with local timezone */
#define ADFI_1878_INDS_LE_TMW		(ADI_FI_ID)1878 /* interval day to second        <= time with timezone */
#define ADFI_1879_INDS_LE_TMWO		(ADI_FI_ID)1879 /* interval day to second        <= time without timezone */
#define ADFI_1880_INDS_LE_INYM		(ADI_FI_ID)1880 /* interval day to second        <= interval interval year to month */
#define ADFI_1881_ADTE_EQ_TSTMP		(ADI_FI_ID)1881 /* ansidate                      =  timestamp with local timezone */
#define ADFI_1882_ADTE_EQ_TSW		(ADI_FI_ID)1882 /* ansidate                      =  timestamp with timezone */
#define ADFI_1883_ADTE_EQ_TSWO		(ADI_FI_ID)1883 /* ansidate                      =  timestamp without timezone */
#define ADFI_1884_ADTE_EQ_TME		(ADI_FI_ID)1884 /* ansidate                      =  time with local timezone */
#define ADFI_1885_ADTE_EQ_TMW		(ADI_FI_ID)1885 /* ansidate                      =  time with timezone */
#define ADFI_1886_ADTE_EQ_TMWO		(ADI_FI_ID)1886 /* ansidate                      =  time without timezone */
#define ADFI_1887_ADTE_EQ_INYM		(ADI_FI_ID)1887 /* ansidate                      =  interval year to month */
#define ADFI_1888_ADTE_EQ_INDS		(ADI_FI_ID)1888 /* ansidate                      =  interval day to second */
#define ADFI_1889_TSTMP_EQ_ADTE		(ADI_FI_ID)1889 /* timestamp with local timezone =  ansidate */
#define ADFI_1890_TSTMP_EQ_TME		(ADI_FI_ID)1890 /* timestamp with local timezone =  time with local timezone */
#define ADFI_1891_TSTMP_EQ_TMW		(ADI_FI_ID)1891 /* timestamp with local timezone =  time with timezone */
#define ADFI_1892_TSTMP_EQ_TMWO		(ADI_FI_ID)1892 /* timestamp with local timezone =  time without timezone */
#define ADFI_1893_TSTMP_EQ_INYM		(ADI_FI_ID)1893 /* timestamp with local timezone =  interval year to month */
#define ADFI_1894_TSTMP_EQ_INDS		(ADI_FI_ID)1894 /* timestamp with local timezone =  interval day to second */
#define ADFI_1895_TSW_EQ_ADTE		(ADI_FI_ID)1895 /* timestamp with timezone       =  ansidate */
#define ADFI_1896_TSW_EQ_TME		(ADI_FI_ID)1896 /* timestamp with timezone       =  time with local timezone */
#define ADFI_1897_TSW_EQ_TMW		(ADI_FI_ID)1897 /* timestamp with timezone       =  time with timezone */
#define ADFI_1898_TSW_EQ_TMWO		(ADI_FI_ID)1898 /* timestamp with timezone       =  time without timezone */
#define ADFI_1899_TSW_EQ_INYM		(ADI_FI_ID)1899 /* timestamp with timezone       =  interval year to month */
#define ADFI_1900_TSW_EQ_INDS		(ADI_FI_ID)1900 /* timestamp with timezone       =  interval day to second */
#define ADFI_1901_TSWO_EQ_ADTE		(ADI_FI_ID)1901 /* timestamp without timezone    =  ansidate */
#define ADFI_1902_TSWO_EQ_TME		(ADI_FI_ID)1902 /* timestamp without timezone    =  time with local timezone */
#define ADFI_1903_TSWO_EQ_TMW		(ADI_FI_ID)1903 /* timestamp without timezone    =  time with timezone */
#define ADFI_1904_TSWO_EQ_TMWO		(ADI_FI_ID)1904 /* timestamp without timezone    =  time without timezone */
#define ADFI_1905_TSWO_EQ_INYM		(ADI_FI_ID)1905 /* timestamp without timezone    =  interval year to month */
#define ADFI_1906_TSWO_EQ_INDS		(ADI_FI_ID)1906 /* timestamp without timezone    =  interval day to second */
#define ADFI_1907_TME_EQ_ADTE		(ADI_FI_ID)1907 /* time with local timezone      =  ansidate */
#define ADFI_1908_TME_EQ_TSTMP		(ADI_FI_ID)1908 /* time with local timezone      =  timestamp with local timezone*/
#define ADFI_1909_TME_EQ_TSW		(ADI_FI_ID)1909 /* time with local timezone      =  timestamp with timezone */
#define ADFI_1910_TME_EQ_TSWO		(ADI_FI_ID)1910 /* time with local timezone      =  timestamp without timezone */
#define ADFI_1911_TME_EQ_INYM		(ADI_FI_ID)1911 /* time with local timezone      =  interval year to month */
#define ADFI_1912_TME_EQ_INDS		(ADI_FI_ID)1912 /* time with local timezone      =  interval day to second */
#define ADFI_1913_TMW_EQ_ADTE		(ADI_FI_ID)1913 /* time with timezone            =  ansidate */
#define ADFI_1914_TMW_EQ_TSTMP		(ADI_FI_ID)1914 /* time with timezone            =  timestamp with local timezone*/
#define ADFI_1915_TMW_EQ_TSW		(ADI_FI_ID)1915 /* time with timezone            =  timestamp with timezone */
#define ADFI_1916_TMW_EQ_TSWO		(ADI_FI_ID)1916 /* time with timezone            =  timestamp without timezone */
#define ADFI_1917_TMW_EQ_INYM		(ADI_FI_ID)1917 /* time with timezone            =  interval year to month */
#define ADFI_1918_TMW_EQ_INDS		(ADI_FI_ID)1918 /* time with timezone            =  interval day to second */
#define ADFI_1919_TMWO_EQ_ADTE		(ADI_FI_ID)1919 /* time without timezone         =  ansidate */
#define ADFI_1920_TMWO_EQ_TSTMP		(ADI_FI_ID)1920 /* time without timezone         =  timestamp with local timezone*/
#define ADFI_1921_TMWO_EQ_TSW		(ADI_FI_ID)1921 /* time without timezone         =  timestamp with timezone */
#define ADFI_1922_TMWO_EQ_TSWO		(ADI_FI_ID)1922 /* time without timezone         =  timestamp without timezone */
#define ADFI_1923_TMWO_EQ_INYM		(ADI_FI_ID)1923 /* time without timezone         =  interval year to month */
#define ADFI_1924_TMWO_EQ_INDS		(ADI_FI_ID)1924 /* time without timezone         =  interval day to second */
#define ADFI_1925_INYM_EQ_ADTE		(ADI_FI_ID)1925 /* interval year to month        =  ansidate */
#define ADFI_1926_INYM_EQ_TSTMP		(ADI_FI_ID)1926 /* interval year to month        =  timestamp with local timezone*/
#define ADFI_1927_INYM_EQ_TSW		(ADI_FI_ID)1927 /* interval year to month        =  timestamp with timezone */
#define ADFI_1928_INYM_EQ_TSWO		(ADI_FI_ID)1928 /* interval year to month        =  timestamp without timezone */
#define ADFI_1929_INYM_EQ_TME		(ADI_FI_ID)1929 /* interval year to month        =  time with local timezone */
#define ADFI_1930_INYM_EQ_TMW		(ADI_FI_ID)1930 /* interval year to month        =  time with timezone */
#define ADFI_1931_INYM_EQ_TMWO		(ADI_FI_ID)1931 /* interval year to month        =  time without timezone */
#define ADFI_1932_INYM_EQ_INDS		(ADI_FI_ID)1932 /* interval year to month        =  interval day to second */
#define ADFI_1933_INDS_EQ_ADTE		(ADI_FI_ID)1933 /* interval day to second        =  ansidate */
#define ADFI_1934_INDS_EQ_TSTMP		(ADI_FI_ID)1934 /* interval day to second        =  timestamp with local timezone*/
#define ADFI_1935_INDS_EQ_TSW		(ADI_FI_ID)1935 /* interval day to second        =  timestamp with timezone */
#define ADFI_1936_INDS_EQ_TSWO		(ADI_FI_ID)1936 /* interval day to second        =  timestamp without timezone */
#define ADFI_1937_INDS_EQ_TME		(ADI_FI_ID)1937 /* interval day to second        =  time with local timezone */
#define ADFI_1938_INDS_EQ_TMW		(ADI_FI_ID)1938 /* interval day to second        =  time with timezone */
#define ADFI_1939_INDS_EQ_TMWO		(ADI_FI_ID)1939 /* interval day to second        =  time without timezone */
#define ADFI_1940_INDS_EQ_INYM		(ADI_FI_ID)1940 /* interval day to second        =  interval interval year to month */
#define ADFI_1941_ADTE_GT_TSTMP		(ADI_FI_ID)1941 /* ansidate                      >  timestamp with local timezone */
#define ADFI_1942_ADTE_GT_TSW		(ADI_FI_ID)1942 /* ansidate                      >  timestamp with timezone */
#define ADFI_1943_ADTE_GT_TSWO		(ADI_FI_ID)1943 /* ansidate                      >  timestamp without timezone */
#define ADFI_1944_ADTE_GT_TME		(ADI_FI_ID)1944 /* ansidate                      >  time with local timezone */
#define ADFI_1945_ADTE_GT_TMW		(ADI_FI_ID)1945 /* ansidate                      >  time with timezone */
#define ADFI_1946_ADTE_GT_TMWO		(ADI_FI_ID)1946 /* ansidate                      >  time without timezone */
#define ADFI_1947_ADTE_GT_INYM		(ADI_FI_ID)1947 /* ansidate                      >  interval year to month */
#define ADFI_1948_ADTE_GT_INDS		(ADI_FI_ID)1948 /* ansidate                      >  interval day to second */
#define ADFI_1949_TSTMP_GT_ADTE		(ADI_FI_ID)1949 /* timestamp with local timezone >  ansidate */
#define ADFI_1950_TSTMP_GT_TME		(ADI_FI_ID)1950 /* timestamp with local timezone >  time with local timezone */
#define ADFI_1951_TSTMP_GT_TMW		(ADI_FI_ID)1951 /* timestamp with local timezone >  time with timezone */
#define ADFI_1952_TSTMP_GT_TMWO		(ADI_FI_ID)1952 /* timestamp with local timezone >  time without timezone */
#define ADFI_1953_TSTMP_GT_INYM		(ADI_FI_ID)1953 /* timestamp with local timezone >  interval year to month */
#define ADFI_1954_TSTMP_GT_INDS		(ADI_FI_ID)1954 /* timestamp with local timezone >  interval day to second */
#define ADFI_1955_TSW_GT_ADTE		(ADI_FI_ID)1955 /* timestamp with timezone       >  ansidate */
#define ADFI_1956_TSW_GT_TME		(ADI_FI_ID)1956 /* timestamp with timezone       >  time with local timezone */
#define ADFI_1957_TSW_GT_TMW		(ADI_FI_ID)1957 /* timestamp with timezone       >  time with timezone */
#define ADFI_1958_TSW_GT_TMWO		(ADI_FI_ID)1958 /* timestamp with timezone       >  time without timezone */
#define ADFI_1959_TSW_GT_INYM		(ADI_FI_ID)1959 /* timestamp with timezone       >  interval year to month */
#define ADFI_1960_TSW_GT_INDS		(ADI_FI_ID)1960 /* timestamp with timezone       >  interval day to second */
#define ADFI_1961_TSWO_GT_ADTE		(ADI_FI_ID)1961 /* timestamp without timezone    >  ansidate */
#define ADFI_1962_TSWO_GT_TME		(ADI_FI_ID)1962 /* timestamp without timezone    >  time with local timezone */
#define ADFI_1963_TSWO_GT_TMW		(ADI_FI_ID)1963 /* timestamp without timezone    >  time with timezone */
#define ADFI_1964_TSWO_GT_TMWO		(ADI_FI_ID)1964 /* timestamp without timezone    >  time without timezone */
#define ADFI_1965_TSWO_GT_INYM		(ADI_FI_ID)1965 /* timestamp without timezone    >  interval year to month */
#define ADFI_1966_TSWO_GT_INDS		(ADI_FI_ID)1966 /* timestamp without timezone    >  interval day to second */
#define ADFI_1967_TME_GT_ADTE		(ADI_FI_ID)1967 /* time with local timezone      >  ansidate */
#define ADFI_1968_TME_GT_TSTMP		(ADI_FI_ID)1968 /* time with local timezone      >  timestamp with local timezone*/
#define ADFI_1969_TME_GT_TSW		(ADI_FI_ID)1969 /* time with local timezone      >  timestamp with timezone */
#define ADFI_1970_TME_GT_TSWO		(ADI_FI_ID)1970 /* time with local timezone      >  timestamp without timezone */
#define ADFI_1971_TME_GT_INYM		(ADI_FI_ID)1971 /* time with local timezone      >  interval year to month */
#define ADFI_1972_TME_GT_INDS		(ADI_FI_ID)1972 /* time with local timezone      >  interval day to second */
#define ADFI_1973_TMW_GT_ADTE		(ADI_FI_ID)1973 /* time with timezone            >  ansidate */
#define ADFI_1974_TMW_GT_TSTMP		(ADI_FI_ID)1974 /* time with timezone            >  timestamp with local timezone*/
#define ADFI_1975_TMW_GT_TSW		(ADI_FI_ID)1975 /* time with timezone            >  timestamp with timezone */
#define ADFI_1976_TMW_GT_TSWO		(ADI_FI_ID)1976 /* time with timezone            >  timestamp without timezone */
#define ADFI_1977_TMW_GT_INYM		(ADI_FI_ID)1977 /* time with timezone            >  interval year to month */
#define ADFI_1978_TMW_GT_INDS		(ADI_FI_ID)1978 /* time with timezone            >  interval day to second */
#define ADFI_1979_TMWO_GT_ADTE		(ADI_FI_ID)1979 /* time without timezone         >  ansidate */
#define ADFI_1980_TMWO_GT_TSTMP		(ADI_FI_ID)1980 /* time without timezone         >  timestamp with local timezone*/
#define ADFI_1981_TMWO_GT_TSW		(ADI_FI_ID)1981 /* time without timezone         >  timestamp with timezone */
#define ADFI_1982_TMWO_GT_TSWO		(ADI_FI_ID)1982 /* time without timezone         >  timestamp without timezone */
#define ADFI_1983_TMWO_GT_INYM		(ADI_FI_ID)1983 /* time without timezone         >  interval year to month */
#define ADFI_1984_TMWO_GT_INDS		(ADI_FI_ID)1984 /* time without timezone         >  interval day to second */
#define ADFI_1985_INYM_GT_ADTE		(ADI_FI_ID)1985 /* interval year to month        >  ansidate */
#define ADFI_1986_INYM_GT_TSTMP		(ADI_FI_ID)1986 /* interval year to month        >  timestamp with local timezone*/
#define ADFI_1987_INYM_GT_TSW		(ADI_FI_ID)1987 /* interval year to month        >  timestamp with timezone */
#define ADFI_1988_INYM_GT_TSWO		(ADI_FI_ID)1988 /* interval year to month        >  timestamp without timezone */
#define ADFI_1989_INYM_GT_TME		(ADI_FI_ID)1989 /* interval year to month        >  time with local timezone */
#define ADFI_1990_INYM_GT_TMW		(ADI_FI_ID)1990 /* interval year to month        >  time with timezone */
#define ADFI_1991_INYM_GT_TMWO		(ADI_FI_ID)1991 /* interval year to month        >  time without timezone */
#define ADFI_1992_INYM_GT_INDS		(ADI_FI_ID)1992 /* interval year to month        >  interval day to second */
#define ADFI_1993_INDS_GT_ADTE		(ADI_FI_ID)1993 /* interval day to second        >  ansidate */
#define ADFI_1994_INDS_GT_TSTMP		(ADI_FI_ID)1994 /* interval day to second        >  timestamp with local timezone*/
#define ADFI_1995_INDS_GT_TSW		(ADI_FI_ID)1995 /* interval day to second        >  timestamp with timezone */
#define ADFI_1996_INDS_GT_TSWO		(ADI_FI_ID)1996 /* interval day to second        >  timestamp without timezone */
#define ADFI_1997_INDS_GT_TME		(ADI_FI_ID)1997 /* interval day to second        >  time with local timezone */
#define ADFI_1998_INDS_GT_TMW		(ADI_FI_ID)1998 /* interval day to second        >  time with timezone */
#define ADFI_1999_INDS_GT_TMWO		(ADI_FI_ID)1999 /* interval day to second        >  time without timezone */
#define ADFI_2000_INDS_GT_INYM		(ADI_FI_ID)2000 /* interval day to second        >  interval interval year to month */
#define ADFI_2001_ADTE_GE_TSTMP		(ADI_FI_ID)2001 /* ansidate                      >= timestamp with local timezone */
#define ADFI_2002_ADTE_GE_TSW		(ADI_FI_ID)2002 /* ansidate                      >= timestamp with timezone */
#define ADFI_2003_ADTE_GE_TSWO		(ADI_FI_ID)2003 /* ansidate                      >= timestamp without timezone */
#define ADFI_2004_ADTE_GE_TME		(ADI_FI_ID)2004 /* ansidate                      >= time with local timezone */
#define ADFI_2005_ADTE_GE_TMW		(ADI_FI_ID)2005 /* ansidate                      >= time with timezone */
#define ADFI_2006_ADTE_GE_TMWO		(ADI_FI_ID)2006 /* ansidate                      >= time without timezone */
#define ADFI_2007_ADTE_GE_INYM		(ADI_FI_ID)2007 /* ansidate                      >= interval year to month */
#define ADFI_2008_ADTE_GE_INDS		(ADI_FI_ID)2008 /* ansidate                      >= interval day to second */
#define ADFI_2009_TSTMP_GE_ADTE		(ADI_FI_ID)2009 /* timestamp with local timezone >= ansidate */
#define ADFI_2010_TSTMP_GE_TME		(ADI_FI_ID)2010 /* timestamp with local timezone >= time with local timezone */
#define ADFI_2011_TSTMP_GE_TMW		(ADI_FI_ID)2011 /* timestamp with local timezone >= time with timezone */
#define ADFI_2012_TSTMP_GE_TMWO		(ADI_FI_ID)2012 /* timestamp with local timezone >= time without timezone */
#define ADFI_2013_TSTMP_GE_INYM		(ADI_FI_ID)2013 /* timestamp with local timezone >= interval year to month */
#define ADFI_2014_TSTMP_GE_INDS		(ADI_FI_ID)2014 /* timestamp with local timezone >= interval day to second */
#define ADFI_2015_TSW_GE_ADTE		(ADI_FI_ID)2015 /* timestamp with timezone       >= ansidate */
#define ADFI_2016_TSW_GE_TME		(ADI_FI_ID)2016 /* timestamp with timezone       >= time with local timezone */
#define ADFI_2017_TSW_GE_TMW		(ADI_FI_ID)2017 /* timestamp with timezone       >= time with timezone */
#define ADFI_2018_TSW_GE_TMWO		(ADI_FI_ID)2018 /* timestamp with timezone       >= time without timezone */
#define ADFI_2019_TSW_GE_INYM		(ADI_FI_ID)2019 /* timestamp with timezone       >= interval year to month */
#define ADFI_2020_TSW_GE_INDS		(ADI_FI_ID)2020 /* timestamp with timezone       >= interval day to second */
#define ADFI_2021_TSWO_GE_ADTE		(ADI_FI_ID)2021 /* timestamp without timezone    >= ansidate */
#define ADFI_2022_TSWO_GE_TME		(ADI_FI_ID)2022 /* timestamp without timezone    >= time with local timezone */
#define ADFI_2023_TSWO_GE_TMW		(ADI_FI_ID)2023 /* timestamp without timezone    >= time with timezone */
#define ADFI_2024_TSWO_GE_TMWO		(ADI_FI_ID)2024 /* timestamp without timezone    >= time without timezone */
#define ADFI_2025_TSWO_GE_INYM		(ADI_FI_ID)2025 /* timestamp without timezone    >= interval year to month */
#define ADFI_2026_TSWO_GE_INDS		(ADI_FI_ID)2026 /* timestamp without timezone    >= interval day to second */
#define ADFI_2027_TME_GE_ADTE		(ADI_FI_ID)2027 /* time with local timezone      >= ansidate */
#define ADFI_2028_TME_GE_TSTMP		(ADI_FI_ID)2028 /* time with local timezone      >= timestamp with local timezone*/
#define ADFI_2029_TME_GE_TSW		(ADI_FI_ID)2029 /* time with local timezone      >= timestamp with timezone */
#define ADFI_2030_TME_GE_TSWO		(ADI_FI_ID)2030 /* time with local timezone      >= timestamp without timezone */
#define ADFI_2031_TME_GE_INYM		(ADI_FI_ID)2031 /* time with local timezone      >= interval year to month */
#define ADFI_2032_TME_GE_INDS		(ADI_FI_ID)2032 /* time with local timezone      >= interval day to second */
#define ADFI_2033_TMW_GE_ADTE		(ADI_FI_ID)2033 /* time with timezone            >= ansidate */
#define ADFI_2034_TMW_GE_TSTMP		(ADI_FI_ID)2034 /* time with timezone            >= timestamp with local timezone*/
#define ADFI_2035_TMW_GE_TSW		(ADI_FI_ID)2035 /* time with timezone            >= timestamp with timezone */
#define ADFI_2036_TMW_GE_TSWO		(ADI_FI_ID)2036 /* time with timezone            >= timestamp without timezone */
#define ADFI_2037_TMW_GE_INYM		(ADI_FI_ID)2037 /* time with timezone            >= interval year to month */
#define ADFI_2038_TMW_GE_INDS		(ADI_FI_ID)2038 /* time with timezone            >= interval day to second */
#define ADFI_2039_TMWO_GE_ADTE		(ADI_FI_ID)2039 /* time without timezone         >= ansidate */
#define ADFI_2040_TMWO_GE_TSTMP		(ADI_FI_ID)2040 /* time without timezone         >= timestamp with local timezone*/
#define ADFI_2041_TMWO_GE_TSW		(ADI_FI_ID)2041 /* time without timezone         >= timestamp with timezone */
#define ADFI_2042_TMWO_GE_TSWO		(ADI_FI_ID)2042 /* time without timezone         >= timestamp without timezone */
#define ADFI_2043_TMWO_GE_INYM		(ADI_FI_ID)2043 /* time without timezone         >= interval year to month */
#define ADFI_2044_TMWO_GE_INDS		(ADI_FI_ID)2044 /* time without timezone         >= interval day to second */
#define ADFI_2045_INYM_GE_ADTE		(ADI_FI_ID)2045 /* interval year to month        >= ansidate */
#define ADFI_2046_INYM_GE_TSTMP		(ADI_FI_ID)2046 /* interval year to month        >= timestamp with local timezone*/
#define ADFI_2047_INYM_GE_TSW		(ADI_FI_ID)2047 /* interval year to month        >= timestamp with timezone */
#define ADFI_2048_INYM_GE_TSWO		(ADI_FI_ID)2048 /* interval year to month        >= timestamp without timezone */
#define ADFI_2049_INYM_GE_TME		(ADI_FI_ID)2049 /* interval year to month        >= time with local timezone */
#define ADFI_2050_INYM_GE_TMW		(ADI_FI_ID)2050 /* interval year to month        >= time with timezone */
#define ADFI_2051_INYM_GE_TMWO		(ADI_FI_ID)2051 /* interval year to month        >= time without timezone */
#define ADFI_2052_INYM_GE_INDS		(ADI_FI_ID)2052 /* interval year to month        >= interval day to second */
#define ADFI_2053_INDS_GE_ADTE		(ADI_FI_ID)2053 /* interval day to second        >= ansidate */
#define ADFI_2054_INDS_GE_TSTMP		(ADI_FI_ID)2054 /* interval day to second        >= timestamp with local timezone*/
#define ADFI_2055_INDS_GE_TSW		(ADI_FI_ID)2055 /* interval day to second        >= timestamp with timezone */
#define ADFI_2056_INDS_GE_TSWO		(ADI_FI_ID)2056 /* interval day to second        >= timestamp without timezone */
#define ADFI_2057_INDS_GE_TME		(ADI_FI_ID)2057 /* interval day to second        >= time with local timezone */
#define ADFI_2058_INDS_GE_TMW		(ADI_FI_ID)2058 /* interval day to second        >= time with timezone */
#define ADFI_2059_INDS_GE_TMWO		(ADI_FI_ID)2059 /* interval day to second        >= time without timezone */
#define ADFI_2060_INDS_GE_INYM		(ADI_FI_ID)2060 /* interval day to second        >= interval interval year to month */
#define ADFI_2061_C_COPYTO_UTF8		(ADI_FI_ID)2061 /* c -copy-> utf8 */
#define ADFI_2062_TEXT_COPYTO_UTF8	(ADI_FI_ID)2062 /* text -copy-> utf8 */
#define ADFI_2063_UTF8_C		(ADI_FI_ID)2063 /* utf8 -> c */
#define ADFI_2064_UTF8_TEXT		(ADI_FI_ID)2064 /* utf8 -> text */

#define ADFI_2065_DATE_PART_DECIMAL_CHAR_ADTE     (ADI_FI_ID)2065 /* Decimal valued Extract function */
#define ADFI_2066_DATE_PART_DECIMAL_CHAR_INYM     (ADI_FI_ID)2066 /* Decimal valued Extract function */
#define ADFI_2067_DATE_PART_DECIMAL_CHAR_DATE     (ADI_FI_ID)2067 /* Decimal valued Extract function */
