...
**	    Added adu_adu_nvchr_totitle and adu_str_initcap
**	5-june-2011 (dougi) code sprint
**	    Add adu_srand(), adu_randomf_srand().
**      02-jun-2011 (maspa05) bug 123897
**          add adu_getseg() which was previously static so we can call it
**          from adu_sc930dataval()
**	07-Jul-2011 (kiria01) b125508
**	    Add adu_date_abs.
**	09-Aug-2011 (kiria01) b125634
**	    Added distinct substr() functions.
...
**	    Added missing adu_nvchr_chartouni prototype
**	12-Oct-2011 (kiria01) b125835 
**	    Added adu_int_to_intds & adu_intds_to_int prototypes.
...
FUNC_EXTERN ADU_NORM2_FUNC adu_ascii_2arg;  /* Support the two
    	    	    	    	    	    ** argument version of c(), 
                                            ** text(), char() and varchar()
                                            */
FUNC_EXTERN ADU_NORM3_FUNC adu_ascii_3arg;  /* Support the three
    	    	    	    	    	    ** argument version of c(), 
                                            ** text(), char() and varchar()
                                            */
...
FUNC_EXTERN ADU_NORM2_FUNC adu_date_div;    /* Routine to handle division
					    ...
					    */
FUNC_EXTERN ADU_NORM1_FUNC adu_date_abs;    /* Routine to return absolute
...
FUNC_EXTERN ADU_NORM2_FUNC adu_dextract;    /* Routine to get one component of
                                            ...
                                            */
FUNC_EXTERN ADU_NORM2_FUNC adu_dextract_decimal;/* Routine to get one component of
                                            ** a date data value.  For instance,
                                            ** the "month" of "10-jan-1957"
                                            ** would be 1.0, while the "day" of
                                            ** "10-jan-1957" would be 10.0 
                                            */
...
FUNC_EXTERN ADU_NORM1_FUNC adu_second_part;  /* Stub that calls adu_dextract()
					    ** to retrieve specified component.
					    */
FUNC_EXTERN ADU_NORM1_FUNC adu_millisecond_part;  /* Stub that calls adu_dextract()
					    ** to retrieve specified component.
					    */
...
FUNC_EXTERN ADU_NORM2_FUNC adu_3alltobyte;  /* This routine converts any data 
					    ...
					    ** as supporting ALL input types.
					    */
FUNC_EXTERN ADU_NORM3_FUNC adu_3alltobyte3; /* This routine converts any data 
					    ** type into a byte/varbyte data
					    ** value, limiting the output field
					    ** width through a length param.
					    ** Supports "byte/varbyte"
...
FUNC_EXTERN ADU_NORM3_FUNC adu_varbyte_3arg; /* 2 arg version of varbyte */
...
FUNC_EXTERN ADU_NORM1_FUNC adu_srand;	    /* Sets random seed */
FUNC_EXTERN ADU_NORM1_FUNC adu_srand_randomf; /* Sets random seed & returns random float */
...
FUNC_EXTERN ADU_NORM2_FUNC adu_20substr;	/* Routine to substring(c,i) */
FUNC_EXTERN ADU_NORM3_FUNC adu_21substrlen;	/* Routine to substring(c,i,i) */
FUNC_EXTERN ADU_NORM2_FUNC adu_20osubstr;	/* Routine to substr(c,i) */
FUNC_EXTERN ADU_NORM3_FUNC adu_21osubstrlen;	/* Routine to substr(c,i,i) */
...
/* Same as adu_nvchr_trim() only using ANSI semantics */
FUNC_EXTERN DB_STATUS adu_nvchr_atrim(ADF_CB		*adf_scb,
                                       DB_DATA_VALUE	*dv1,
                                       DB_DATA_VALUE	*dv2,
                                       DB_DATA_VALUE	*rdv); 

/* Routine to compute ltrim() on string operand. */
FUNC_EXTERN DB_STATUS adu_nvchr_ltrim(ADF_CB		*adf_scb,
                                       DB_DATA_VALUE	*dv1,
                                       DB_DATA_VALUE	*rdv);
                                            
/* Support the two and three argument versions of nvarchar() */
FUNC_EXTERN ADU_NORM2_FUNC adu_nvchr_2args;
FUNC_EXTERN ADU_NORM3_FUNC adu_nvchr_3args;
...
/* Routine for osubstr1 functions for nchr and nvchr type */
FUNC_EXTERN ADU_NORM2_FUNC adu_nvchr_osubstr1;
/* Routine for osubstr2 functions for nchr and nvchr type */
FUNC_EXTERN ADU_NORM3_FUNC adu_nvchr_osubstr2;
...
/* Routine for coercing char and varchar types to unicode nchar and nvarchar types */
FUNC_EXTERN DB_STATUS adu_nvchr_chartouni(ADF_CB           *scb,
                                          DB_DATA_VALUE    *dv_1,
                                          DB_DATA_VALUE    *dv_2);
...
FUNC_EXTERN ADU_NORM1_FUNC adu_nvchr_toupper;
FUNC_EXTERN ADU_NORM1_FUNC adu_nvchr_totitle;
FUNC_EXTERN ADU_NORM1_FUNC adu_nvchr_tolower;
FUNC_EXTERN ADU_NORM1_FUNC adu_str_initcap;
FUNC_EXTERN ADU_NORM2_FUNC adu_str_repeat;
FUNC_EXTERN ADU_NORM2_FUNC adu_datefmt;
FUNC_EXTERN ADU_NORM1_FUNC adu_dayofwk1;
FUNC_EXTERN ADU_NORM2_FUNC adu_dayofwk2;
FUNC_EXTERN ADU_NORM1_FUNC adu_dayofmth;
FUNC_EXTERN ADU_NORM1_FUNC adu_dayofyr;
FUNC_EXTERN ADU_NORM0_FUNC adu_unxtmstmp;
FUNC_EXTERN ADU_NORM1_FUNC adu_unxtmstmp1;
FUNC_EXTERN ADU_NORM1_FUNC adu_fromunxtm1;
FUNC_EXTERN ADU_NORM2_FUNC adu_fromunxtm2;
FUNC_EXTERN ADU_NORM1_FUNC adu_lastday;
FUNC_EXTERN ADU_NORM2_FUNC adu_mthsbtwn;
FUNC_EXTERN ADU_NORM1_FUNC adu_int_to_intds;
FUNC_EXTERN ADU_NORM1_FUNC adu_intds_to_int;
...
FUNC_EXTERN DB_STATUS adu_getseg( ADF_CB *adf_scb,
		               ADP_POP_CB      *pop_cb,
		               char            **segstart,
		               char            **segend,
		               i4              *done,
