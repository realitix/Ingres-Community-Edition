...
**      03-feb-2011 (stial01)
**          ADI_06TABLEINFO_FEXI (dmf_iitableinfo) return_count i8.
**      03-feb-2011 (stial01)
**          ADI_03ALLOCATED_FEXI, ADI_04OVERFLOW_FEXI return i8
**/
...
DB_DATA_VALUE	    *rdv)
{
    ...
    */
    ...
    db_stat = (*func)( &reltid, 
		       &reltidx, 
		       ADI_03ALLOCATED_FEXI, NULL, &i8temp);

    if (db_stat != E_DB_OK)
        return(adu_error(adf_scb, E_AD2103_ALLOCATED_FCN_ERR, 0));
    *(i4 *)rdv->db_data = (i4)i8temp;
...
DB_DATA_VALUE	    *rdv)
{
    ...
    */
    db_stat = (*func)( &reltid, 
		       &reltidx, 
		       ADI_04OVERFLOW_FEXI, NULL, &i8temp);
