...

/*{
** Name: adu_decprec() - Determine best precision and scale for a conversion.
**
** Description:
**      adu_decprec() Determine best precision and scale for a conversion by
**			inspection.
**
** Inputs:
**	adf_scb				Pointer to an ADF session control block.
...
**	    Extend to give useful values for numeric forms too.
*/
...
)
{
	...
	*ps = dv1->db_prec;
	...
	{
	case 1:
	    *ps = DB_PS_ENCODE_MACRO(AD_I1_TO_DEC_PREC,AD_I1_TO_DEC_SCALE);
	    break;
	case 2:
	    *ps = DB_PS_ENCODE_MACRO(AD_I2_TO_DEC_PREC,AD_I2_TO_DEC_SCALE);
	    break;
	case 4:
	    *ps = DB_PS_ENCODE_MACRO(AD_I4_TO_DEC_PREC,AD_I4_TO_DEC_SCALE);
	    break;
	case 8:
	    *ps = DB_PS_ENCODE_MACRO(AD_I8_TO_DEC_PREC,AD_I8_TO_DEC_SCALE);
	    break;
	}
	return E_AD0000_OK;
