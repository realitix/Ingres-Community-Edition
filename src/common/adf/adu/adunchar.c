/*
** Copyright (c) 2001, 2008, 2010, 2011 Actian Corporation
*/
# include       <compat.h>
# include       <gl.h>
# include       <me.h>
...
** Name: adu_nvchr_osubstr1     - This implements function substr(nvarchar, int)
** Name: adu_nvchr_osubstr2     - Return the substr from a string.
...
** Name: adu_nvchr_totitle()	- Externally visible function call to convert
**				  nchar/nvarchar to titlecase.
...
**          Protype cleanup.
**       3-Feb-2011 (hanal04) Bug 124988
**          Added adu_nvchr_atrim() ANSI trim, and adu_nvchr_ltrim().
**	01-aug-2011 (zhayu01) Bug 125615
**	    Use the correct length to set cdata.db_length to avoid
**	    over writing the buffer when converting float (and other types)
**	    to nvarchar in adu_nvchr_coerce().
**	09-Aug-2011 (kiria01) b125634
**	    Added adu_nvchr_osubstr1 & adu_nvchr_osubstr2 to support
**	    SUBSTR(s,p[,l]) correctly.
**	    Corrected the behaviour of SUBSTRING(s FROM p FOR l) when p
**	    is -ve.
**	10-Oct-2011 (kiria01) b125830
**	    Removed external references.
**	    Tightened type checking of the CM data.
*/
...
i4 adu_nvchr_utf8_bldkey(
	ADF_CB *scb,
	i4 semantics,
	ADC_KEY_BLK *key_block);
i4 adu_nvchr_convert(
	ADF_CB *scb,
	DB_DATA_VALUE *dv_in,
...
i4 adu_nvchr_shift(
	...
	DB_DATA_VALUE *dv2,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_charextract(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_str,
	DB_DATA_VALUE *dv_int,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_substr1(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_substr2(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	DB_DATA_VALUE *dv3,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_osubstr1(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_osubstr2(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	DB_DATA_VALUE *dv3,
...
i4 adu_nvchr_toutf8(
	...
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_fromutf8(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_chartouni(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_unitochar(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);
i4 adu_utf8_to_ucs2(
	...
	UCS2 *targetEnd,
	i2 *reslen);
static i4 adu_ucs2_to_utf8(
	ADF_CB *adf_scb,
	const UCS2 **sourceStart,
	const UCS2 *sourceEnd,
	UTF8 **targetStart,
	UTF8 *targetEnd,
	i2 *reslen);
static bool check_utf8(void);
i4 adu_nvchr_strutf8conv(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *dv_out);
i4 adu_nvchr_toupper(
	ADF_CB *scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_totitle(
	ADF_CB *scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_tolower(
	ADF_CB *scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_utf8comp(
	ADF_CB *scb,
	i4 use_quel_pm,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	i4 *rcmp);
i4 adu_nvchr_utf8like(
	ADF_CB *scb,
	DB_DATA_VALUE *dv1,
	DB_DATA_VALUE *dv2,
	char *eptr,
	i4 *rcmp);
static i4 ad0_nvchr_casemap(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv,
	i4 caseflag);
i4 adu_nvchr_embchartouni(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);
i4 adu_nvchr_embunitochar(
	ADF_CB *adf_scb,
	DB_DATA_VALUE *dv_in,
	DB_DATA_VALUE *rdv);

#define byteMask		(UCS4)0xBF
#define byteMark		(UCS4)0x80
#define halfShift		10
#define halfBase		(UCS4)0x0010000UL
#define halfMask		(UCS4)0x3FFUL
#define kReplacementCharacter	(UCS4)0x0000FFFDUL
#define kMaximumUCS2		(UCS4)0x0000FFFFUL
#define kMaximumUCS4		(UCS4)0x7FFFFFFFUL
#define kSurrogateHighStart	(UCS4)0xD800UL
#define kSurrogateHighEnd	(UCS4)0xDBFFUL
#define kSurrogateLowStart	(UCS4)0xDC00UL
#define kSurrogateLowEnd	(UCS4)0xDFFFUL
	...
	DB_DATA_VALUE	   *result)
{
    ...
    else if (op1->db_datatype == DB_NVCHR_TYPE)
    {
         ...
         if ((u_i4)size1 > DB_MAX_NVARCHARLEN )
             return (adu_error(scb, E_AD5081_UNICODE_FUNC_PARM, 0));
...
DB_DATA_VALUE      *rdv)
{
    ...
    else if (dv1->db_datatype == DB_NVCHR_TYPE)
    {
         ...
         if ((u_i4)len > DB_MAX_NVARCHARLEN )
             return (adu_error(scb, E_AD5081_UNICODE_FUNC_PARM, 0));
...
/*
** Name: adu_nvchr_atrim() - ANSI trim function to trim arbitrary chars from 
**      front and/or back of string. Note that this differs from the Ingres 
**      trim function that simply trims trailing blanks from a string. The ANSI
...
**
**  History:
**       2-Feb-2011 (hanal04) Bug 124988
**          Cloned from adu_atrim().
**	12-Jul-2011 (kschendel) b125538
**	    Advance instart properly for leading trim.
*/
...
DB_DATA_VALUE       *rdv)
{
    ...
    if ((db_stat = adu_lenaddr(adf_scb, dv1, &len, (char **) &instart)) != E_DB_OK)
        return (db_stat);

    /* Save away trim code and character(s). */
    trimspec = *((i2 *)dv2->db_data);
    trimchar[0] = *((UCS2 *)dv2->db_data + 1);
    trimchar[1] = *((UCS2 *)dv2->db_data + 2);
    ...
    */
    ...
    {
        i = len / sizeof(UCS2);
        while ((i)-- && *(instart + i) == trimchar[0]);
        i++;                  /* i leaves loop 1 too small */
                ...
                trimspec == ADF_TRIM_BOTH)
    {
        ...
        if (len)        /* Nothing to do if 0 length string */
         while (*(instart + i) == trimchar[0] && (i++) < (len / sizeof(UCS2)));
...

/*
** Name: adu_nvchr_ltrim() - Trim function to trim blanks from front of string.
...

{
    ...
    dv2.db_length = 6;
    dv2.db_prec = 0;
    dv2.db_collID = DB_UNSET_COLL;
    dv2.db_data = (PTR)&trim;
    trim[0] = (UCS2)ADF_TRIM_LEADING;
    trim[1] = U_BLANK;
    trim[2] = U_NULL;

    return(adu_nvchr_atrim(adf_scb, dv1, &dv2, rdv));
}
...

/*
** Name: adu_nvchr_3args() - Convert a data value to nvchr string data value.
**
** Description:
**      Support the two argument version of NVARCHAR()
**      Simply call adu_nvchr_coerce() to do the real work.
...
**	    .db_data			Ptr to the data to be converted into
**					a character string.
**	dv2				DB_DATA_VALUE describing length - not used
**	dv3				DB_DATA_VALUE describing truncation behaviour
**	rdv				DB_DATA_VALUE describing character
**					string result.
**	    .db_length			The maximum length of the result.
**	    .db_data			Ptr to buffer to hold converted string.
...
DB_DATA_VALUE		*rdv)
{
    DB_STATUS status;
    ADF_STRTRUNC_OPT input_strtrunc = adf_scb->adf_strtrunc_opt;
    DB_ANYTYPE *val = (DB_ANYTYPE*)(dv3->db_data);

    if (dv3->db_datatype != DB_BOO_TYPE)
	return(adu_error(adf_scb, E_AD9999_INTERNAL_ERROR, 0));
    
    if (val->db_booltype)
	adf_scb->adf_strtrunc_opt = ADF_ERR_STRTRUNC;
    else
	adf_scb->adf_strtrunc_opt = ADF_WRN_STRTRUNC;
              ...
              DB_DATA_VALUE     *dv_out)
{
	...
	case DB_MNY_TYPE:
		...
		*/
		...
		/* How big may it be? */
		cdata.db_length = sizeof(utemp); 
                cdata.db_collID = DB_NOCOLLATION;
                cdata.db_prec = 0;
...
DB_DATA_VALUE      *rdv)
{
    ...
    else if (dv2->db_datatype == DB_NVCHR_TYPE)
    {
         ...
         if ((u_i4)size2 > DB_MAX_NVARCHARLEN )
             return (adu_error(adf_scb, E_AD5081_UNICODE_FUNC_PARM, 0));
...
DB_DATA_VALUE      *rdv)
{
    ...
    psave = pout;  
    if (abs(nshift) > size1 || abs(nshift) > sizer)
	ncopy = 0;
    else if (nshift < 0)
    {
...
DB_DATA_VALUE      *rdv)
{
    ...
    else if (dv_str->db_datatype == DB_NVCHR_TYPE)
    {
         ...
         if ((u_i4)slen > DB_MAX_NVARCHARLEN )
             return (adu_error(adf_scb, E_AD5081_UNICODE_FUNC_PARM, 0));
	...
	DB_DATA_VALUE      *rdv)
{
	...
	return (adu_error(adf_scb, E_AD5001_BAD_STRING_TYPE, 0));
    destend = (UCS2 *)(rdv->db_data + rdv->db_length);


    if (dv1->db_datatype == DB_NCHR_TYPE)
    {
	src = (UCS2 *) dv1->db_data;
	srcend = (UCS2 *)(dv1->db_data + dv1->db_length);
    }
    else if (dv1->db_datatype == DB_NVCHR_TYPE)
    {
        srclen = ((DB_NVCHR_STRING *) dv1->db_data)->count;
        if ((u_i4)srclen > DB_MAX_NVARCHARLEN )
             return (adu_error(adf_scb, E_AD5081_UNICODE_FUNC_PARM, 0));
    ...
    if (rdv->db_datatype == DB_NVCHR_TYPE)
	((DB_NVCHR_STRING *) rdv->db_data)->count = dest - dsave;
    else if (rdv->db_datatype == DB_NCHR_TYPE)
	while (dest < destend)
	    *dest++ = U_BLANK;
    else
...
DB_DATA_VALUE	*rdv)
{
    ...
    */
    ...
    if (startpos < 1)
    {
#ifdef ADF_STRICT_ANSI_SUBSTRING
	forlen -= 1-startpos;
#endif /*ADF_STRICT_ANSI_SUBSTRING*/
	startpos = 1;
    }
    startpos--;
    if (forlen > srclen - startpos)
	forlen = srclen - startpos;
    ...
    /* Copy the source string to the result */
    if (forlen > 0)
	memcpy(dest, src, forlen * sizeof(UCS2));
    else
	forlen = 0;
    if (rdv->db_datatype == DB_NVCHR_TYPE)
	((DB_NVCHR_STRING *) rdv->db_data)->count = forlen;
    else
    {
	dest += forlen;
	while (dest < (UCS2 *)(rdv->db_data + rdv->db_length))
	    *dest++ = U_BLANK;
    }
...
/*{
** Name: adu_nvchr_osubstr1      - This implements function substr(nvarchar, int) 
**	                          for unicode data type following Oracle variant.
**
** Description:
**      This file contains an implementation of Oracle SUBSTR(ucs2, int).
**
** Inputs:
**      adf_scb                         Pointer to an ADF session control block.
**          .adf_errcb                  ADF_ERROR struct.
	...
	DB_DATA_VALUE      *rdv)
{
...
#ifdef xDEBUG 
        TRdisplay("adu_nvchr_osubstr1: enter with args:\n");
        adu_prdv(dv1);
        adu_prdv(dv2);
        adu_prdv(rdv);
#endif 
	...
	return (adu_error(adf_scb, E_AD5001_BAD_STRING_TYPE, 0));
    destend = (UCS2 *)(rdv->db_data + dv1->db_length);
...
#ifdef xDEBUG
     TRdisplay("adu_nvchr_osubstr1: returning DB_DATA_VALUE:\n");
     adu_prdv(rdv);
#endif
...
/*{
** Name: adu_nvchr_osubstr2 - Return the substring from a string. 
**
** Description:
**      This file contains an implementation of substr(nvarchar, int, int)
**
** Inputs:
**      adf_scb                         Pointer to an ADF session control block.
**          .adf_errcb                  ADF_ERROR struct.
	...
	DB_DATA_VALUE	*rdv)
{
    ...
    i4                  i;
    i8                  i8temp;
    DB_DATA_VALUE	tdv1, tdv2, tdv3, trdv;

#ifdef xDEBUG 
        TRdisplay("adu_nvchr_osubstr2: enter with args:\n");
        adu_prdv(dv1);
        adu_prdv(dv2);
        adu_prdv(rdv);
#endif 
    ...
    if (dv3->db_datatype < 0)
    {
	if (ADI_ISNULL_MACRO(dv3))
	{
	    ADF_SETNULL_MACRO(rdv);
	    return E_DB_OK;
	}
	tdv3 = *dv3;
	dv3 = &tdv3;
	dv3->db_datatype = -dv3->db_datatype;
	dv3->db_length--;
    }
    ...
    dsave = dest;
    while(dest < destend && src < srcend && forlen--)
	*(dest)++ =  *(src)++;

    ((DB_NVCHR_STRING *) rdv->db_data)->count = dest - dsave;

#ifdef xDEBUG 
     TRdisplay("adu_nvchr_osubstr2: returning DB_DATA_VALUE:\n");
     adu_prdv(rdv);
#endif 
     return (E_DB_OK);
}
...
DB_DATA_VALUE     *rdv)
{
    ...
    if ((db_stat = (adu_ucs2_to_utf8 (adf_scb, &instr, instr+inlen,
                      (UTF8 **)&outstr,(UTF8*)(outstr+outlen),
                              &retlen))) != OK)
      return db_stat;
...
DB_DATA_VALUE     *rdv) 
{
    ...
    if ((db_stat = adu_utf8_to_ucs2 (adf_scb, (UTF8 **)&instr,
               (UTF8 *)(instr+inlen), &outstr,
		    ...
		    count+=1)
        {
            ...
            */
			...
			if (!substitution_err && !substitution_on) 
                    ...
                    {
			/* FIXME: This block of code and similar in this
			** module looks suspect. Whilst possibly working,
			** probably not optimal, certainly not clear.
			** BYTE SWAP inherently needs to operate on known
			** integer sizes, BT_BYTE_NUMS_MACRO and its partner
			** BT_SWAP_BYTES_MACRO in crime are cavalier
			** about this & probably explains the later confusion. */
        ...
        i2              *reslen)
{
    ...
    {
        ch = 0;
        extraBytesToWrite = CM_UTF8trailingbytes(source);
	...
	ch -= CM_offsetsFromUTF8[extraBytesToWrite];
...
{
DB_STATUS           result = E_DB_OK;
register const UCS2*	    source = *sourceStart;
                              ...
                              && source < sourceEnd)
              {
               ...
               switch (bytesToWrite)   /* note: code falls through cases! */
               {
                ...
                case 2:
                        *--target = (ch | byteMark) & byteMask; ch >>= 6;
                case 1:
                        *--target =  ch | CM_UTF8firstByteMask[bytesToWrite];
                }
                target += bytesToWrite;
        }
        *reslen = target - *targetStart;
...
**	    UTF8 data.
**	17-Mar-2011 (kschendel)
**	    Don't use MEreqmem for short strings.  Fix bad indentation.
**	    Delete unused locals.
**      18-Apr-2011 (hanal04) SIR 125274
**          Correct the datatype testing for 'from UTF8' case and add
**          DB_CHR_TYPE and DB_TXT_TYPE to the string types handled.
*/
DB_STATUS
...
DB_DATA_VALUE     *dv_out)
{
    ALIGN_RESTRICT workbuf[(500+DB_ALIGN_SZ-1)/DB_ALIGN_SZ];
    char *workarea = (char *) &workbuf[0];
	...
	dv_tmp.db_prec = 0;
	dv_tmp.db_data = workarea;

	if (dv_tmp.db_length > sizeof(workbuf))
	{
	    dv_tmp.db_data = (char *) MEreqmem (0, dv_tmp.db_length, TRUE, &stat);
	    if (stat != OK)
		return (adu_error(adf_scb, E_AD9998_INTERNAL_ERROR, 2, 0, "MEreqmem failed"));
	}

	if ((dv_in->db_datatype == DB_UTF8_TYPE) &&
	   (dv_out->db_datatype == DB_VCH_TYPE || dv_out->db_datatype == DB_CHA_TYPE
	    || dv_out->db_datatype == DB_CHR_TYPE || dv_out->db_datatype == DB_TXT_TYPE))
	{
	   ...
	   (dv_in->db_datatype == DB_VCH_TYPE || dv_in->db_datatype == DB_CHA_TYPE
	    || dv_in->db_datatype == DB_CHR_TYPE || dv_in->db_datatype == DB_TXT_TYPE))
	{
...
/*
** Name: adu_nvchr_totitle() - Convert unicode string to titlecase.
**
** Description:
**	  This routine is a wrapper to adu_nvchar_casemap. 
**
...
DB_DATA_VALUE       *rdv)
{
    return ( ad0_nvchr_casemap( scb, dv1, rdv, ADU_CASEMAP_TITLE)); 
}
...
**	05-May-2011 (kiria01) SIR 125342
**	    Completed titlecase support by applying UAX29 algorithm to the
**	    data to determine word boundaries as defined by Unicode standard.
**	    This aspect is using the 6.0.0 datafile naming.
*/
static DB_STATUS
ad0_nvchr_casemap(
ADF_CB              *adf_scb,
	...
	** all characters as base characters.
	...
	/* Now convert to upper or lower case based on the request */
	    ...
	    if (subc)
	      ...
	      unicp = basechar;
	    /* Word boundaries - TITLEcase only*/
	    if (caseflag == ADU_CASEMAP_TITLE)
	    {
		prv = cur;
		cur = cetbl[unicp].flags;
		if (unicp == 0x000D || unicp == 0x000A)
		    cur |= CE_Newline;
		/* Distilled from UAX29 WB1-14 - only interested in Aletter
		** followers as these are the only titlecase opportunities
		**   WB3a. 	(Newline|CR|LF) /
		**  Ignore Format and Extend characters, except when they appear
		...
		**   WB7. 	ALetter (MidLetter|MidNumLet) x ALetter
		...
		**   WB14. 	Any / Any
		**
		** Only 6 presents a difficulty in that it needs a lookahead. However,
		** noting that the MidLetter & MidNumLet have no caps issues, we split
		** the rule into two and use 
		*/
/*6pt2&7*/	if (prv & (CE_MidLetter|CE_MidNumLet) && cur & CE_ALetter)
		    /* Leave wordstart state intact WB6 pt2 & WB7 */;
/*3a*/		else if (prv & CE_Newline)
		    wordstart = TRUE;
/*5&6pt1*/	else if (prv & CE_ALetter && cur & (CE_ALetter|CE_MidLetter|CE_MidNumLet))
		    wordstart = FALSE;
/*10*/		else if (prv & (CE_MidLetter|CE_MidNumLet|CE_Numeric) && cur & CE_ALetter)
		    wordstart = FALSE;
/*13*/		else if (prv & CE_Katakana && cur & CE_Katakana)
		    wordstart = FALSE;
/*13a*/		else if (prv & (CE_ALetter|CE_Numeric|CE_Katakana|CE_ExtendNumLet) &&
				cur & CE_ExtendNumLet)
		    wordstart = FALSE;
/*13b*/		else if (prv & CE_ExtendNumLet && cur & (CE_ALetter|CE_Numeric|CE_Katakana))
		    wordstart = FALSE;
/*4*/		else if (cur & (CE_Extend|CE_Format))
		    cur = prv;
		else
		    wordstart = TRUE;
	    }
		...
		switch (caseflag)
		{
		case ADU_CASEMAP_UPPER:
		    lower_lim = casemap->num_lvals + casemap->num_tvals;
		    upper_lim = casemap->num_lvals + casemap->num_tvals + 
		                casemap->num_uvals;
		    break;
		case ADU_CASEMAP_TITLE:
		    if (wordstart)
		    {
			/* Only in 'wordstart' condition should the title case
			** be applied - otherwise it should be lower. */
               ...
               DB_DATA_VALUE     *rdv)
{
    ...
    if (check_utf8())
    {
      if ((db_stat = adu_utf8_to_ucs2 (adf_scb, &instr,
                instr+inlen, &outstr,
                outstr+outlen, &retlen)) != OK)
        return db_stat;
...
**          of adh_chrcvt() in libq.
**      4-May-2010 (hanal04) Bug 125325
**          Replace ifdef BYTE_SWAP with ifdef BIG_ENDIAN_INT to ensure
**          correct conversion from u_i2 to char on BIG_ENDIAN_INT platforms.
*/
DB_STATUS
              ...
              DB_DATA_VALUE     *rdv)
{
    ...
    if (db_stat = adu_3straddr(adf_scb, rdv, (char **)&outstr))
          return (db_stat);
