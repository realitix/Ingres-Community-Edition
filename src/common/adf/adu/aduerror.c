...
**	    Added E_AD106C_ASSERTION_FAILURE mapping to user error
**	    E_US119A_ASSERTION_FAILED for ASSERT function
*/
...
#define MAX_ER_ARGS MAX_ERR_PARAMS / 2
    ...
    */
	...
	break;
      ...
      case E_AD106C_ASSERTION_FAILURE:
	adf_errcb->ad_usererr	= E_US119A_ASSERTION_FAILED;
	break;
