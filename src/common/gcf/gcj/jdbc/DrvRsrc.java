...
**	24-Jan-06 <gordy)
**	    Re-branded for Actian Corporation.
**	27-Jul-07 (gordy)
...
**	15-Feb-11 (gordy)
**	    Added connection property 'identity_query' to control the
**	    additional query for identity values for generated keys.
*/
...
**	RSRC_CP_IDENT_QUERY	Identity Query.
**
**  Public methods:
**
    ...
    extends ListResourceBundle
{
    ...
    */
    ...
    public static final String	RSRC_CP_IDENT_QUERY  = "RSRC_CP_QUERY_IDENT";
