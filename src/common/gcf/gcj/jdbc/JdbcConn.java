...
**	15-Feb-11 (gordy)
**	    Added connection parameter to enable identity query.  Extended
**	    prepared statement class to allow generated key access to be
**	    declared.
*/
...
**	15-Feb-11 (gordy)
**	    Added connection parameter to enable identity query.
*/
    ...
    throws SQLException
{
	...
	case DRV_CP_IDENT_QUERY :
	    /*
	    ** This is a local connection property
	    ** and is not forwarded to the server.
	    */
	    if ( value.equalsIgnoreCase( "on" ) )
		conn.cnf_flags |= conn.CNF_IDENTITY;
	    else  if ( value.equalsIgnoreCase( "off" ) )
		conn.cnf_flags &= ~conn.CNF_IDENTITY;
	    else
	    {
		if ( trace.enabled( 1 ) )
		    trace.write( tr_id + ": identity query '" + value + "'" );
		throw SqlExFactory.get( ERR_GC4010_PARAM_VALUE );
	    }
	    break;
...
**	15-Feb-11 (gordy)
**	    Extended prepared statement class to allow generated key access 
**	    to be declared.
*/
    ...
    throws SQLException
{
    ...
    return( createPrep( sql, ResultSet.TYPE_FORWARD_ONLY,
			DRV_CRSR_DBMS, holdability, false ) );
} // prepareStatement
    ...
    throws SQLException
{
    ...
    return( createPrep( sql, type, concurrency, holdability, false ) );
} // prepareStatement
...
**	concurrency	Cursor concurrency.
**	holdability	ResultSet holdability.
**	loadKeys	Should auto generated keys be retrieved.
**
** Output:
**	None.
**
...
**	    Support scrollable cursors.
**	15-Feb-11 (gordy)
**	    Added parameter for generated key access to pass to 
    ...
    throws SQLException
{
	...
	*/
    ...
    JdbcPrep prep = new JdbcPrep( conn, sql, type, 
				  concurrency, holdability, loadKeys );
