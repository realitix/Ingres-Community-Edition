...
**	15-Feb-11 (gordy)
**	    Added identity query property and bumped patch version to 7:
**	    SIR 125042 -  Add support for identity columns via generated keys.
*/
...
**	DRV_CP_SND_ING_DATE	Connect parameter: send ingres dates.
**	DRV_CP_SND_INT_BOOL	Connect parameter: send integer booleans.
**	DRV_CP_IDENT_QUERY	Connect parameter: identity query.
**
...
**	DRV_PROP_IDENT_QUERY	Identity query connection property.
**
...
**	15-Feb-11 (gordy)
**	    Added DRV_CP_IDENT_QUERY and DRV_PROP_IDENT_QUERY.  Bumped
**	    version to 4.0.7.
*/
...
DrvConst
{
    ...
    ** Driver constants
    */
    String	DRV_VENDOR_NAME		= "Actian Corporation";
    int		DRV_MAJOR_VERSION	= 4;
    int		DRV_MINOR_VERSION	= 0;
    int		DRV_PATCH_VERSION	= 7;
    ...
    */
    ...
    String	DRV_PROP_IDENT_QUERY	= "identity_query";
	...
	new PropInfo( DRV_PROP_IDENT_QUERY, false, "Identity Query",
			prop_valid_off_on[0], prop_valid_off_on,
			DrvRsrc.RSRC_CP_IDENT_QUERY, DRV_CP_IDENT_QUERY ),
    };
	...
	new AttrInfo( "IDENTITY", DRV_PROP_IDENT_QUERY ),
    };
