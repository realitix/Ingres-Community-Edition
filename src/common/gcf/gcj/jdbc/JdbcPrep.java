...
**	15-Feb-11 (gordy)
**	    Configure super-class for generated key access.
*/
...
**	15-Feb-11 (gordy)
**	    Add loadGeneratedKeys to pass generated key access to super-class.
*/
...
**	15-Feb-11 (gordy)
**	    Added loadKeys parameter to allow generated key access to be
**	    specified.
*/
...
( 
    ...
    throws SQLException
{
    this( conn, rs_type, rs_concur, rs_hold, loadKeys );
...
**	15-Feb-11 (gordy)
**	    Call super-class method if generated key access is enabled
    ...
    */
	...
	if ( prepRSMD == null )
	{
	    ...
	    */
		...
		/*
		** Connection may be unlocked during generated
		** key processing.  Check if still locked by
		** current thread.
		*/
