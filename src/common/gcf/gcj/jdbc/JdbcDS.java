/*
** Copyright (c) 2001, 2011 Actian Corporation All Rights Reserved.
*/
...
**	15-Feb-11 (gordy)
**	    Added connection property 'identity_query' to allow support
**	    of identity values via generated keys.
*/
...
public void
setIdentityQuery( String identityQuery )
...
initReference( Reference ref )
{
	...
	ref.add( new StringRefAddr( "identityQuery", identityQuery ) );
...
initInstance( Reference ref )
{
    ...
    if ( (ra = ref.get( "identityQuery" )) != null )
	identityQuery = (String)((StringRefAddr)ra).getContent();
...
getProperties( String user, String password )
{
    ...
    {
	if ( tracing )
	    trace.write( "    " + DRV_PROP_IDENT_QUERY +
			 ": " + identityQuery );
	info.setProperty( DRV_PROP_IDENT_QUERY, identityQuery );
    }
