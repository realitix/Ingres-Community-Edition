...
**	15-Feb-11 (gordy)
**	    Add "identity_query" driver property.
*/
...
#define	PROP_IDENT_QUERY_NAME	"identity_query"
...
#define	PROP_IDENT_QUERY_VAL	"on/off (default:on)"
...
}jdbc_prop_info[] =
{
    ...
    { PROP_IDENTITY_QUERY,	PROP_IDENT_QUERY_NAME,	PROP_IDENT_QUERY_VAL },
};
