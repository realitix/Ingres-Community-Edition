/*
** Copyright (c) 1999, 2010 Actian Corporation All Rights Reserved.
*/
...
**       4-Jun-2011 (hanal04) SIR 125098
**          Add %p PID to II_GCD_LOG.
**       5-Jun-2011 (chris.dawe@iua.org.uk) SIR 125407
**          Add %d (date YYYYMMdd) to II_GCD_LOG.
...
initialize( i4 argc, char **argv )
{
    ...
    /*
    ** Make a unique file-name if $II_GCD_LOG contains exactly one
    ** "%p" (no other %-things):
