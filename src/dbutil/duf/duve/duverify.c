...
**	    verifydb -otable: Issue legal warning after validating table arg
**/

/*
	...
	*/
		   ...
		   (duvecb.duve_operation == DUVE_XTABLE) )
	{
	    ...
	    */
		...
		/*
		** go check the table
		** duve_checktable will issue legal warning and start msg
		** after validating table arg
		*/
		...
		** table */
		...
		/*
		** go patch the table
		** duve_patchtable will issue legal warning and start msg
		** after validating table arg
		*/
