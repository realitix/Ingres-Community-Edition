	...
	*/
	if (duve_cb->duverel->rel[index].du_stat2 & TCB_SUPPORTS_CONSTRAINT)
	{
	    ...
	    */
		...
		index_tbl.indexid, (i4) PSQ_INDEX, (i4) 0, duve_cb);
...
#define 	DROP_THIS_DBPROC	0x02
	...
	*/
	     ...
	     drop_obj = drop_obj->duve_next)
	{
	    ...
	    */
	    cleanup_flag = 
		(type == PSQ_CREDBP && drop_obj->duve_drop_flags & DUVE_DBP_DROP)
		    ? DROP_THIS_DBPROC
		    : 0;
	...
	*/
    ...
    idx_type = PSQ_INDEX;
    tbl_type = PSQ_DB_TABLE;
    view_type = PSQ_VIEW;
    dbp_type = PSQ_CREDBP;
    rule_type = PSQ_RULE;
    cons_type = PSQ_CONS;
    intg_type = PSQ_INTEG;
    event_type = PSQ_EVENT;
    perm_type = PSQ_PROT;
		...
		and (
			...
			(    obj_type = :cons_type 
		         ...
		         and secondary_id = i_qid
					...
					** PSQ_DB_TABLE would be enough, but one of
			 ...
			 and (   dtype = :dbp_type
				  ...
				  and (   deid1 != inid1
					...
					** have dtype==PSQ_DB_TABLE which may 
