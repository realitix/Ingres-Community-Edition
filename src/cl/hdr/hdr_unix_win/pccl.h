...
**	29-sep-2009 (zhayu01) SIR 121210
**		Do not include <process.h> for Pocket PC and Windows CE
...
**	    OSX gcc is complaining because bool isn't i1, PCspawn declaration
**	    incompatibility.  Change declaration here to bool.
*/
