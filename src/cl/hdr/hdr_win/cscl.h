/******************************************************************************
** Copyright (c) 1987, 2004, 2011 Actian Corporation
**
...
**	30-Sep-2011 (kiria01) b125802
**	   Switch to using critical sections instead of mutexes for
**	   CS_synch_xxxxxx.
**
******************************************************************************/

...
#ifndef USE_MTX_FOR_SYNCH
# define CS_SYNCH CRITICAL_SECTION
# define CS_synch_init(synchptr) (InitializeCriticalSection(synchptr),OK)
# define CS_synch_lock(synchptr)     (EnterCriticalSection(synchptr),OK)
# define CS_synch_trylock(synchptr)  (TryCriticalSection(synchptr)?OK:EBUSY)
# define CS_synch_unlock(synchptr)   (LeaveCriticalSection(synchptr),OK)
# define CS_synch_destroy(synchptr)  (DeleteCriticalSection(synchptr),OK)
#else
