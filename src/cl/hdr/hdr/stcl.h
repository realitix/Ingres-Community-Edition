...
**	12-feb-2009 (zhayu01) SIR 121210
**	   Cannot use _mbsncpy with DOUBLEBYTE builds on Windows CE/Pocket PC
**	   because it is not supported. Use new CMccopy() instead.
**	   Define STncasecmp as _strnicmp on Windows CE/Pocket PC
