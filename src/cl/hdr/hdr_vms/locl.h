/*
** Copyright (c) 1985, 2008 Actian Corporation
**
*/
...
**      10-Jul-2011 (horda03)
**          Make VMS LOCATION fields conform to Unix.
**/

/* 
** Defined Constants.
...
typedef struct
{
	...
	char	*node;		/* Pointer to node part of filename */
	char	*path;		/* Pointer to device part of filename */
	char	*dirptr;	/* Pointer to directory part of filename */
	char	*fname;		/* Pointer to name part of filename */
