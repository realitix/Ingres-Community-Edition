...
**      26-Jul-2011 (horda03)
**          The CPP compiler may not define the VMS macro
...
/*
**  May not need to define VMS because it's automatically defined in the
**  cross compiler and in the Alpha C compiler. But then again it may not.
*/
#ifndef VMS
#define VMS
#endif
