/*
** Copyright (c) 1991, 2009 Actian Corporation
*/
...
**          When using OS_THREADS on i64_vms, don't define __FAST_SETJMP as this
**          causes the EXdeclare jump points to be missed.
**/
...
#if defined(i64_vms) && defined(KPS_THREADS)
