...
**      07-Jun-2011 (horda03)
**          Add CMCPYCHAR and CMCPYCHAR_LEN for SIdofrmt(), and the SI_CMCPYCHAR_LEN
**          structure.
**      18-Aug-2011 (horda03) Bug 123092
**          Remove flush_mutex from FILE, also only define FILE if stdio.h has not been
**          included, and prevent stdio.h from defining FILE if it is defined here.
**/

...
*/
   ...
   /* stdio.h has already been included, this is only a problem
   ** if the compilation unit tries to use SI functions.
   */
