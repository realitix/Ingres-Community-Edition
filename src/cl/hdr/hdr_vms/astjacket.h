/*
** Copyright (c) 2007, 2009 Actian Corporation
**
*/
...
**          Added ASTJACKET_DISPATCHER_TIMER to flag that the setimr
**          call should run in the Dispatcher thread (OS Threaded servers
**          only).
*/
...
#ifndef AST_NO_REDEFINE /* Should only be defined when compiling astjacket.c */
...
/* In a OS Threaded System, may need to establish a
** sys$setimr() event that will execute under the AST
** dispatcher thread as the originating thread may not
** exist when the timer expires.
*/
#define ASTJACKET_DISPATCHER_TIMER 0x80000000

#else

#define ASTJACKET_DISPATCHER_TIMER 0
