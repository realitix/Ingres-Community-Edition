...
**	    it for all callers.
**	16-aug-2009 (zhayu01) SIR 121210
**	    Use NULL instead of pSD for lpSecurityDescriptor on Pocket PC
**	    because the pSD is not initialized there.
**	  
*/
STATUS
...
**          Just return FAIL for Pocket PC/Windows CE
**          because CreateWellKnownSid() API is not supported.
}*/
STATUS
