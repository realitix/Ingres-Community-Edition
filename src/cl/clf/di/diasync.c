...
**	01-mar-1995 (anb)
**          Created.
**	7-Jul-2011 (kschendel) b125520
**	    Forgot to set listioSemsInit, so sems were re-inited over and over.
**	    Not a good idea.  One should not be using async_io with OS
**	    threading, but it should work and not spew errors!
*/
DI_AIOCB *
DI_get_aiocb( VOID)
{
