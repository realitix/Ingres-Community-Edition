...
**      10-jul-2009 (zhayu01) SIR 121210
...
{
#ifdef VMS
#   define LOC_PLACE FILES
#else
#   define LOC_PLACE ADMIN
#endif

    if ( NMloc(LOC_PLACE, PATH, (char *)NULL, ploc) != OK )
      return FAIL;
...
# endif /* !DESKTOP */
    ...
    status = sys$connect(&cmcoldle->rab);
    if ((status & 1) == 0)
#else
