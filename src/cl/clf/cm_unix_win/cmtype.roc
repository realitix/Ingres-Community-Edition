/*
** Copyright (c) 1986, 2008, 2011 Actian Corporation
*/

# define __IN_CMTYPE_C__
...
**	10-Oct-2011 (kiria01) b1258308
**	    Moved non-Unicode table refs to here from cmdata.c so that
**	    const references can be supported. Moved UTF-8 parts to
**	    cmutype.roc. Removed external references.
...
GLOBALDEF const u_char CM_DefCaseTab[] = {
	/*	0	1	2	3	4	5	6	7 */
...
GLOBALDEF const u_i2	*CM_AttrTab = CM_DefAttrTab;

GLOBALDEF const u_char	*CM_CaseTab = CM_DefCaseTab;
