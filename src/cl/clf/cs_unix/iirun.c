...
**	30-Sep-2011 (hanje04)
**	    Bug 125688
**	    Allow remote manager process (iimgmtsvr) to be started by iirun
**/
...
static char iimgmtsvr[GL_MAXNAME] = "iimgmtsvr";
...
static	PROG_LIST prog_list[] =
{
	...
	{icestart, C_STDIN|C_EXPAND|C_NEEDRAD, check_dummy, 0, 0},
        ...
        {iimgmtsvr, C_STDIN|C_EXPAND, check_dummy, 0, 0},
	{0, 0, check_dummy, 0, 0}
};

/*
...
get_sys_dependencies()
{
    ...
    STprintf( iimgmtsvr, "%smgmtsvr", SystemAltExecName );
}
