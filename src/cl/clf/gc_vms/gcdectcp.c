...
**          In tcp6_connect(), set the host name size as GC_HOSTNAME_MAX.
**          In GCdns_hostname(), set the host name size as GC_HOSTNAME_MAX.
**      14-Mar-2011 Ralph Loen Sir 122536
**          In GCdns_hostname(), replace GCC_L_NODE with GCC_HOSTNAME_MAX.
**          Remove unused MAXHOSTNAME.
**          
*/
