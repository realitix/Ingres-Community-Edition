...
**      05-Mar-2011 (Ralph Loen) SIR 122536
**          In GChostname(), define the nodename field as GC_HOSTNAME_MAX.
**      13-Jul-2011 (hanal04) SIR 125458
**          Update cs_elog calls inline with sc0e_putAsFcn changes.
**      19-Oct-2011 (horda03) b121386
**          Don't bother checking the aspic->thread_id against the PCtidx()
**          inside a server.
**/
...
VOID  	    (*free)();
{
    ...
    if (!initialized)
    {
        ...
        */
        ...
        if (GC_os_threaded) setimr_last_param = ASTJACKET_DISPATCHER_TIMER;
#endif
...
**      05-Mar-2011 (Ralph Loen) SIR 122536
**          Define the nodename field as GC_HOSTNAME_MAX.
**/
...
#ifdef OS_THREADS_USED
        &&  ( GC_os_threaded && (asipc->chan[i].chan != GC_CH_ID_NONE) )
#endif
           )
           io_count++;
