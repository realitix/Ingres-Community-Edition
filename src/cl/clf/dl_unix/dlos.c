...
**	    Drop obsolete ports.
**	15-June-2011 (frima01) Bug 125465
**	    In iiDLsymfunc check for hpb_us5 as hp8_us5 is not present
**	    anymore. The server couldn't find the kerberos lib and crashed.
*/
#include <compat.h>
#include <gl.h>
#ifdef UNIX
