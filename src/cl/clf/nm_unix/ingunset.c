...
**      17-Mar-2011 (ashco01) Bug: 123940
**          Improved informational message to highlight file write failure.
**/
...
char	**argv;
{
	...
	else if ((errnum = NMzapIngAt(argv[1])) != OK)
	{
		...
		SIprintf("\t%s\n", errbuf);
		SIprintf("\tCheck file access and filespace\n\tonly the %s super-user can use %s\n",
