...
**          Define CS_stall and In a KPS_THREAD system define CS_kp_stall.
**/

/*
...
#ifdef KPS_THREADS
FUNC_EXTERN VOID CS_kp_stall( CS_SCB *scb );

#define CS_stall(save_regs, scb)  CS_kp_stall( scb )

#else

#define CS_stall(save_regs, scb)  CS_ssprsm(save_regs)
