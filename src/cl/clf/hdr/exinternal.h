...
**      09-dec-2010 (joea)
**          Change return type of i_EXestablish to void. Add second argument
**          to EXdump to have one interface on all platforms.
...
FUNC_EXTERN VOID	DIAGerror(const char *format, ...);
