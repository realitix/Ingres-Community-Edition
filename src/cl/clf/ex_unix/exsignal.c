...
**      09-dec-2010 (joea)
**          Change return type of i_EXestablish to void.
**      21-Apr-2011 (horda03) b125299
**          Don't add any signal handlers in User applications when
**          II_APP_NO_SIG_HANDLE is defined.
**      27-May-2011 (frima01) b125299
**          Remove return OK from i_EXestablish since it returns void.
*/
...
i_EXestablish(void)
{
    ...
    if ( (client_type == EX_USER_APPLICATION) &&
         getenv("II_APP_NO_SIG_HANDLE") )
    {
       /* User wants to catch all the SIGNALs */
