$! Copyright (c) 2005, 2009  Actian Corporation
$!
$! Name: bldenv
$!
...
$!!         Define symbol BUILD_WITH_POSIX_THREADS so that it can
$!!         be picked by by the Jamrules.
$!---------------------------------------------------------------
$!
$!
...
$  user = F$USER()
$
$  bwpt = f$trnlnm("BUILD_WITH_POSIX_THREADS")
$  if bwpt .eqs. ""
$  then
$     define /job BUILD_WITH_POSIX_THREADS "N"
$     BUILD_WITH_POSIX_THREADS :== N
$  else
$     BUILD_WITH_POSIX_THREADS == bwpt
$  endif
$
$  if unames .EQS. "Alpha"
$  then
$     config_string :== axm_vms
$  else
$     if unames .EQS. "IA64"
$     then
$        config_string :== i64_vms
$          
$     else
$        if config_string .EQS. ""
$        then 
$           echo "This is an unrecognised platform."
