...
touch -r %1 "%TIMEFILE%"
echo SignCode.exe -sha1 "63a642f197c8c316f1ece767f5b4244dbce3ba25"  -n %1 -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll %1  
SignCode.exe -sha1 "63a642f197c8c316f1ece767f5b4244dbce3ba25"  -n %1 -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll %1  
...
for /F %%I in (%2) do (
touch -r %%I "%TIMEFILE%"
echo SignCode.exe -sha1 "63a642f197c8c316f1ece767f5b4244dbce3ba25"  -n %%I -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll %%I
SignCode.exe -sha1 "63a642f197c8c316f1ece767f5b4244dbce3ba25"  -n %%I -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll %%I    
if NOT ERRORLEVEL 0 goto ERROR
touch -r "%TIMEFILE%" %%I
)
rm "%TIMEFILE%"

REM type "%2"|awk '{print "echo SignCode.exe -sha1 \"63a642f197c8c316f1ece767f5b4244dbce3ba25\"  -n \"Ingres System File\" -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll \""$1"\"""\r\nSignCode.exe -sha1 \"63a642f197c8c316f1ece767f5b4244dbce3ba25\"  -n \"Ingres System File\" -i http://www.actian.com/ -t http://timestamp.verisign.com/scripts/timstamp.dll \""$1"\""}'> %TEMP%\iisign$$1.bat
