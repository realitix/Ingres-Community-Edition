...
##    15-Jul-2009  (hweho01) BUG 125456
##         The AIX config32 string was incorrectly compared with rs4_u5.    
##	22-Nov-2010 (kschendel) SIR 124685
##	    Drop a few more ancient / obsolete ports.
##	    Fix up header comment a wee bit.
##	09-Mau-2011 (hanje04)
##	    Now support building GTK installer on Debian. Also remove
##	    xCL_RPM_EXISTS as we no-longer use the RPM C API
