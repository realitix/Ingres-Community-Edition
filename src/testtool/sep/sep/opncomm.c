...
#ifdef SEP_SYNC
    /*
    ** Do not create TC (data stream) file if using sync (sockets).
    */
...
#ifdef SEP_SYNC
    /*
    ** Do not create TC file if using sync (socket) mode
    */
    if ( ! sepSyncGlobalVars.syncMode )
#endif
    {
...
#ifdef SEP_SYNC
    /*
    ** Do not do these further initialisations if using sync, socket mode
    */
    if ( ! sepSyncGlobalVars.syncMode )
#endif
    {
