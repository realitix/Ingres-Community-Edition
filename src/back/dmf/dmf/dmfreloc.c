...
**          reloc_database() currently unsupported if db has vectorwise tables
**      22-feb-2011 (stial01)
**	    Minor change to error msg.
...
DB_TRAN_ID      *tran_id)
{
    ...
    */
    ...
    /*
    ** relocatedb -new_database not supported if db has VectorWise tables
    */
    if (jsx->jsx_x100_db)
    {
	dmfWriteMsg(NULL, E_DM105E_JSP_UNSUPPORTED, 0);
	return (E_DB_ERROR);
    }
