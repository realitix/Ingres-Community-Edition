...
**      27-Apr-2011 (maspa05) bug 125304
**          Don't output "unrecognised" journal records for EBACKUP, SBACKUP
**          and JNLSWITCH records. This is the same list of records which
**          are considered harmless when deciding whether to output E_DM1205
		...
		*/
			...
			&& h->type != DM0LJNLSWITCH)
		{
	      ...
	      */
		    ...
		    dmd_format_log(TRUE, atp_put_line, record, 
				         atp->atp_block_size, 
		                         line_buffer, sizeof(line_buffer));
		}
	    }
...
**	21-Jul-2010 (stial01)
**          Created.
**	 4-May-2011 (wanfr01) b125326
**	    Need to release rcb if table not found.
*/
static DB_STATUS
get_table_reltup(
DMF_ATP     *atp,
