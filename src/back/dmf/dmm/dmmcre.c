...
**	16-Aug-2011 (kiria01) b125662
**	    Ensure consistent logic applied for collID when the
**	    initial core catalogs are opened. Although the correct
**	    collIDs will be set in the actual catalogs, in order to
**	    access these we need prototype catalogs to perform the
**	    bootstrap lookup. These potentially need fixing up.
*/
