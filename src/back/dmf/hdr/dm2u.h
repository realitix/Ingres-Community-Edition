...
**	13-feb-2010 (dougi)
**	    Added DM2U_2_UPD_RELTUPS to update iirelation.reltups (for X100).
...
/* UPD_RELTUPS doesn't have a corresponding MODIFY option - it is requested
** through DMU_MODIFY calls and was invented for X100. */
#define			DM2U_2_UPD_RELTUPS		0x01000000
/* UPD_RELTUPS adds to reltups, REP_RELTUPS replaces it. */
#define			DM2U_2_REP_RELTUPS		0x02000000
...
#define                 DM2U_IND_ASCII_ID      CV_C_CONST_MACRO('D','M','2','U')
    ...
    bool             	indxcb_unique;
    bool             	indxcb_dmveredo;
    i2			indxcb_index_flags;
#define		DM2U_GATEWAY		0x001	/* Creating gateway index */
#define		DM2U_ONLINE_END		0x002	/* End phase of online modify */
#define		DM2U_ONLINE_MODIFY	0x004	/* Modify phase of online modify */
#define		DM2U_NOFILE		0x008	/* No disk file (VW table) */
