...
**	    Relocate DELETE_INFO structure to this central location.
**	    Remove definition from multiple dmf file locations.
**	    Externalize del_ck_files to be used for removal of
**	    nested VectorWise directories.  
**	13-jul-2011 (stial01) m2109, B65170 B125554 SD 151120
**	    Added RFP_IIRTEMP_SKIP
...
#define		    E_DM907A_CHARSET_CONFLICT		(E_DM_MASK + 0x907AL)
...
#define             E_DM9692_DMVE_NONJNL_PUT            (E_DM_MASK + 0x9692L)
...
#define		    E_DM9C93_DM2T_ALREADY_ON_FTCB	(E_DM_MASK + 0x9C93L)
...
/*
** Externalize del_ck_files to delete
** nested directories.
*/
FUNC_EXTERN STATUS del_ck_files(
