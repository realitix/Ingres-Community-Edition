...
**          Moved x100 location info from dcb to jsx
...
#define		    E_DM105E_JSP_UNSUPPORTED    (E_DM_MASK + 0x105EL)
...
# define                    JSX2_INFO_DBS	    0x01000000L
...
#define JSX_MAX_LOC                          64
    ...
    bool		jsx_x100_db;
    DMP_LOC_ENTRY	jsx_x100_data;
    DMP_LOC_ENTRY	jsx_x100_ckp;
    i4			jsx_x100_ckp_pathlen; /* pathlen without dbname */
