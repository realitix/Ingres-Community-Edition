...
**	    Add include of lg.h, move all public bit declarations to lg.h,
**	    add LFB_STATUS, LFB_ACTIVE_LOG string mappings.
**/

...
struct _LBB
{
    ...
    i4	    	    lbb_state;		/* State, defines are in lg.h: */
#define			LBB_FREE		    LG_BUF_FREE
#define			LBB_MODIFIED		    LG_BUF_MODIFIED
#define			LBB_FORCE		    LG_BUF_FORCE
#define			LBB_PRIMARY_LXB_ASSIGNED    LG_BUF_PRIM_LXB_ASSIGNED
#define			LBB_DUAL_LXB_ASSIGNED	    LG_BUF_DUAL_LXB_ASSIGNED
#define			LBB_PRIM_IO_INPROG	    LG_BUF_PRIM_IO_INPROG
#define			LBB_DUAL_IO_INPROG	    LG_BUF_DUAL_IO_INPROG
#define			LBB_IO_INPROG (LBB_PRIM_IO_INPROG | LBB_DUAL_IO_INPROG)
#define			LBB_PRIM_IO_CMPLT	    LG_BUF_PRIM_IO_CMPLT
#define			LBB_DUAL_IO_CMPLT	    LG_BUF_DUAL_IO_CMPLT
#define			LBB_IO_CMPLT (LBB_PRIM_IO_CMPLT | LBB_DUAL_IO_CMPLT)
#define			LBB_PRIM_IO_NEEDED	    LG_BUF_PRIM_IO_NEEDED
#define			LBB_DUAL_IO_NEEDED	    LG_BUF_DUAL_IO_NEEDED
#define			LBB_ON_WRITE_QUEUE	    LG_BUF_ON_WRITE_QUEUE
#define			LBB_CURRENT	    	    LG_BUF_CURRENT
...
#define			LDB_TYPE	    6
    ...
    u_i4	    ldb_status;		/* Status, defines are in lg.h: */
#define                 LDB_ACTIVE          DB_ACTIVE
#define                 LDB_JOURNAL         DB_JNL
#define                 LDB_INVALID         DB_INVALID
#define                 LDB_NOTDB           DB_NOTDB
#define                 LDB_PURGE           DB_PURGE
#define                 LDB_OPENDB_PEND     DB_OPENDB_PEND
#define                 LDB_CLOSEDB_PEND    DB_CLOSEDB_PEND
#define                 LDB_RECOVER         DB_RECOVER
#define                 LDB_FAST_COMMIT     DB_FAST_COMMIT
#define                 LDB_PRETEND_CONSISTENT DB_PRETEND_CONSISTENT
#define                 LDB_CLOSEDB_DONE    DB_CLOSEDB_DONE
#define                 LDB_OPN_WAIT        DB_OPN_WAIT
#define                 LDB_STALL           DB_STALL
#define                 LDB_BACKUP          DB_BACKUP
#define                 LDB_CKPDB_PEND      DB_CKPDB_PEND
#define			LDB_READONLY	    DB_READONLY	
#define                 LDB_FBACKUP         DB_FBACKUP
#define			LDB_CKPERROR	    DB_CKPDB_ERROR
#define			LDB_JSWITCH	    DB_JSWITCH
#define			LDB_STALL_RW	    DB_STALL_RW
#define			LDB_CKPLK_STALL	    DB_CKPLK_STALL
#define			LDB_CLOSE_WAIT	    DB_CLOSE_WAIT
#define			LDB_MVCC	    DB_MVCC
#define			LDB_RODB	    DB_RODB
...
#define			LPB_TYPE	    4
    ...
    u_i4	    lpb_status;		    /* State of the process,
    					    ** defines are in lg.h: */
#define			LPB_ACTIVE	    PR_ACTIVE
#define			LPB_MASTER	    PR_MASTER
#define			LPB_ARCHIVER	    PR_ARCHIVER
#define			LPB_FCT		    PR_FCT
#define			LPB_RUNAWAY	    PR_RUNAWAY
#define			LPB_SLAVE	    PR_SLAVE
#define                 LPB_CKPDB           PR_CKPDB
#define			LPB_VOID	    PR_VOID
#define                 LPB_SHARED_BUFMGR   PR_SBM
#define                 LPB_IDLE            PR_IDLE
#define                 LPB_DEAD            PR_DEAD
#define                 LPB_DYING           PR_DYING
#define                 LPB_FOREIGN_RUNDOWN PR_FOREIGN
#define			LPB_CPAGENT	    PR_CPAGENT
...
#define			LXB_TYPE	    5
    ...
    u_i4	    lxb_status;		/* Status, defines are in lg.h: */
#define			LXB_INACTIVE		TR_INACTIVE
#define			LXB_ACTIVE		TR_ACTIVE
#define			LXB_CKPDB_PEND		TR_CKPDB_PEND
#define			LXB_PROTECT		TR_PROTECT
#define			LXB_JOURNAL		TR_JOURNAL
#define			LXB_READONLY		TR_READONLY
#define			LXB_NOABORT		TR_NOABORT
#define			LXB_RECOVER		TR_RECOVER
#define			LXB_FORCE_ABORT		TR_FORCE_ABORT
#define			LXB_SESSION_ABORT	TR_SESSION_ABORT
#define			LXB_SERVER_ABORT	TR_SERVER_ABORT
#define			LXB_PASS_ABORT		TR_PASS_ABORT
#define			LXB_ABORT		TR_ABORT
#define			LXB_DBINCONST		TR_DBINCONST
#define			LXB_WAIT		TR_WAIT
#define			LXB_DISTRIBUTED		TR_DISTRIBUTED
#define			LXB_WILLING_COMMIT	TR_WILLING_COMMIT
#define			LXB_REASSOC_WAIT	TR_REASSOC_WAIT
#define			LXB_RESUME		TR_RESUME
#define			LXB_MAN_ABORT		TR_MAN_ABORT
#define			LXB_MAN_COMMIT		TR_MAN_COMMIT
#define			LXB_LOGWRITER_THREAD	TR_LOGWRITER
#define			LXB_NORESERVE		TR_NORESERVE
#define			LXB_ORPHAN		TR_ORPHAN
#define			LXB_WAIT_LBB		TR_WAIT_LBB
#define			LXB_SHARED		TR_SHARED
			    /* This LXB is shared */
#define			LXB_SHARED_HANDLE	TR_SHARED_HANDLE
			    /* Handle LXB to SHARED LXB */
#define			LXB_ET			TR_ET
			    /* ET written for this TXN */
#define			LXB_PREPARED		TR_PREPARED
			    /* Prepared to commit */
#define			LXB_IN_MINI		TR_IN_MINI
			    /* Shared LXB is in mini-transaction */
#define			LXB_ONEPHASE		TR_ONEPHASE
			    /* XA one-phase commit optimization */
#define			LXB_ILOG		TR_ILOG
