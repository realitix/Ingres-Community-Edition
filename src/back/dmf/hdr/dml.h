...
**	    Add prototype for GTT update.
**      07-Jan-2011 (stial01) (b124871)
**          Added scb_etfull_seg (for use with tracepoint dm37)
**/

...
**      07-Oct-2011 (horda03)
**          Add scb_pg_range for DM725. To store the range of pages to
**          be dumped.
*/

struct _DML_SCB
...
#define			SCB_S_FACTOTUM	    0x08L
    ...
    u_i4	scb_trace[100 / BITS_IN(i4)];
					...
					** dmftrace, dmcend */
    DM_PAGENO   scb_pg_range [2];       /* Page range for tracepoint DMxxx */
...
#define		SCB_DOP_DEFAULT		8
    ...
    i4		    scb_etfull_seg;         /* for tracepoint dm37 */
...
FUNC_EXTERN DB_STATUS dmt_destroy_temp(
    ...
    /* Mark temp table as having been updated by this query (for X100) */
FUNC_EXTERN DB_STATUS dmt_gtt_update(
    DMT_CB	*dmt_cb);
