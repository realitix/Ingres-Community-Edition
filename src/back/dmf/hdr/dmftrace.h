...
**         in dmpe_buffered_put. (in case it doesn't work, or you want to 
**         compare to non-buffered puts.)
**/

/*
...
**  37 n            etab full on segment n (test etab full error handling)
**  38              Turn off etab buffered put optimization in dmpe_buffered_put
**  39-95         Not Used.
