...
**	    Renamed to LKshow, no need for static LK_show.
**	    Public lkb_flags renamed to lkb_attribute.
*/
/* ARGSUSED */
STATUS
LKshow(
		...
		if (rsb->rsb_type == RSB_TYPE)
		{
		    ...
		    */
		    ...
		    if (rsb->rsb_grant_q_next)
		    {
			    ...
			    lkbi->lkb_attribute = lkb->lkb_attribute;
		...
		*/
		     ...
		     lkb->lkb_grant_mode == LK_SIX )
		{
		    *context = i;
		    ...
		    blkbi->lkb_attribute = lkb->lkb_attribute & LKB_PHYSICAL;
	    ...
	    */
		     ...
		     (related_llb && related_llb->llb_id.id_id == llb_id->id_id))
		{
			...
			lkbi->lkb_grant_mode = next_lkb->lkb_grant_mode;
                        lkbi->lkb_attribute = next_lkb->lkb_attribute;
...
**	04-Jan-2011 (jonj) SIR 124894 LG/LK/IPM unification
**	    Deleted obsolete LK_EXTEND_FILE, LK_OWNER_ID, LK_PH_PAGE
**	    lock types.
*/
char *
