...
**	    AIC flag gone, fix here.
**	16-Aug-2011 (kiria01) b125662
**	    Delay the call to dmm_init_catalog_templates() to after
**	    the options have been read. Then we can ensure consistent
**	    logic applied for collID when the initial core catalogs
**	    are opened.
*/

DB_STATUS
...
#           define DAWDLE_TIME        5 /* Seconds to wait for lock */
	...
	** SCF doesn't know when DMF is active and when it isn't,
	** so ask for "always" notification.
	*/
