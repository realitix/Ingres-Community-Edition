...
**          Init scb_etfull_seg (for use with tracepoint dm37)
...
**      07-Oct-2011 (horda03)
**          Initialise scb_pg_range, the range of pages to be
**          dumped by TP dm725.
*/

DB_STATUS
...
DMC_CB    *dmc_cb)
{
	...
	*/
	...
	scb->scb_qfun_errptr = NULL;
        MEfill(sizeof(scb->scb_pg_range), 0, &scb->scb_pg_range);
