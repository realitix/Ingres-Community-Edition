...
**	    Use predefined bit mapping constant strings
...
char *userbuf )
{
    ...
    TRformat(NULL, 0, format_buf, sizeof(format_buf), "%v",
	    DB_STATUS_MEANING, ldb->ldb_status);
...
char *userbuf )
{
    ...
    TRformat(NULL, 0, format_buf, sizeof(format_buf), "%v",
	    TR_STATUS_MEANING, lxb->lxb_status);
...
char *userbuf )
{
    ...
    TRformat(NULL, 0, format_buf, sizeof(format_buf), "%w",
	    LGH_STATUS, lfb->lfb_header.lgh_status);
...
char *userbuf )
{
    ...
    TRformat(NULL, 0, format_buf, sizeof(format_buf), "%v",
	    LFB_ACTIVE_LOG, lfb->lfb_active_log);
...
char *userbuf )
{
    ...
    TRformat(NULL, 0, format_buf, sizeof(format_buf), "%w",
	    LG_WAIT_REASON, lxb->lxb_wait_reason);
