...
**	18-feb-2010 (dougi)
**	    Identify X100 tables and avoid some error detection.
...
**	21-Sep-2010 (kschendel)
**	    Delete an MEfill of adf_scb, it's a pointer, not a cb.
...
DB_ERROR	*dberr)
{
    ...
    */
	...
	x100 = (t->tcb_rel.relspec == TCB_X100 ||
			t->tcb_rel.relspec == TCB_X100CL ||
			t->tcb_rel.relspec == TCB_X100IX ||
			t->tcb_rel.relspec == TCB_X100RW);
