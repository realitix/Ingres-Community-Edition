/*
** Copyright 2004, 2008 Actian Corporation
*/
...
GLOBALDEF const INTXLATE Uld_ahd_xlatetab[] =
{
	...
	{QEA_HAGGF, "HAGF"},
	{QEA_X100_QRY, "X100Q"},
	{QEA_X100_CRTABLE, "X100CT"},
	{QEA_X100_CRCONSTRAINT, "X100CC"},
	{QEA_D0_NIL, "DNIL"},
	{QEA_D1_QRY, "DQRY"},
	{QEA_D2_GET, "DGET"},
	{QEA_D3_XFR, "DXFR"},
...
**	26-aug-2008 (dougi)
**	    Add DB_X100_STORE for X100 support.
**	5-jan-2009 (dougi)
**	    Add DB_X100CL_STORE and DB_X100IX_STORE, too.
**	20-oct-2009 (dougi)
**	    Add "vectorwise" as synonym for "x100".
**	11-nov-2009 (dougi)
**	    Add "x100cl" and "x100ix" as more synonyms.
**	15-sep-2010 (dougi)
**	    Add "vectorwise_row" as new type.
