	...
	PSS_SESBLK	   *sess_cb)
{
    ...
    {
	(VOID) psf_error(E_PS0D13_SCU_INFO_ERR, (DB_ERROR *)NULL, PSF_INTERR,
	...
	{
	    (VOID)psf_error(E_US1862_EXCESSIVE_MAXIO, (DB_ERROR *)NULL,  
                    PSF_USERERR, &err_code, &psy_cb->psy_error, (i4)2,
	...
	{
	    (VOID)psf_error(E_US1864_EXCESSIVE_MAXROW, (DB_ERROR *)NULL, 
                    PSF_USERERR, &err_code, &psy_cb->psy_error, (i4)2,
	...
	{
	    (VOID)psf_error(E_US1861_EXCESSIVE_MAXCPU, (DB_ERROR *)NULL, 
                    PSF_USERERR, &err_code, &psy_cb->psy_error, (i4)2,
	...
	{
	    (VOID)psf_error(E_US1863_EXCESSIVE_MAXPAGE, (DB_ERROR *)NULL, 
                    PSF_USERERR, &err_code, &psy_cb->psy_error, (i4)2,
	...
	{
	    (VOID)psf_error(E_US1860_EXCESSIVE_MAXCOST, (DB_ERROR *)NULL, 
                    PSF_USERERR, &err_code, &psy_cb->psy_error, (i4)2,
    ...
    {
	(VOID) psf_error(E_QE0210_QEC_ALTER, (DB_ERROR *)NULL, PSF_INTERR,
