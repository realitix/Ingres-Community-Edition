...
**      14-jun-2011 (huazh01) b125351
**          process QLEND qual node.  
*/
	...
	DB_ERROR	*err_blk)
{
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0D07_VARNO_OUT_OF_RANGE, (DB_ERROR *)NULL, 
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0D08_RNGVAR_UNUSED, (DB_ERROR *)NULL, 
            PSF_INTERR, &err_code, err_blk, 0);
	return (E_DB_SEVERE);
    }
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0D09_MRG_DIFF_TABS, (DB_ERROR *)NULL, 
            PSF_INTERR, &err_code, err_blk, 0);
	return (E_DB_SEVERE);
    }
	...
	...)
{
	...
	(VOID) psf_error(errorno, (DB_ERROR *)NULL, PSF_USERERR, 
                         &err_code, err_blk, 5,
