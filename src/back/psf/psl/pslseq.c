	...
	DB_ERROR   *err_blk)
{
	...
	** is big enough to require decimal. So coerce all to decimal. */
	...
	minmaxdv.db_collID = DB_UNSET_COLL;
  ...
  seq_bigerr:
	...
	** sequence type. */
	(void)psf_error(6320L, (DB_ERROR *)NULL, PSF_USERERR,
	    &err_code, err_blk, 1,
	...
	** increment. */
	(void)psf_error(6317L, (DB_ERROR *)NULL, PSF_USERERR,
	    &err_code, err_blk, 1,
	...
	bool	    minus)
{
	...
	** sequences), RESTART only allowed on ALTER SEQUENCE. */
	...
	(void)psf_error(6316L, (DB_ERROR *)NULL, PSF_USERERR,
	...
	*iparmp = intval;
    ...
    {
	(void)psf_error(6322L, (DB_ERROR *)NULL, PSF_USERERR,
