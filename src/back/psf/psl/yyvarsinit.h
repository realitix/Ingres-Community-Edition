...
yyvars.active_target_clauses = 0;
memset(yyvars.in_target_clause, 0, sizeof(yyvars.in_target_clause));
yyvars.in_groupby_clause = FALSE;
yyvars.in_update_set_clause = FALSE;
yyvars.in_orderby       = FALSE;
yyvars.in_window        = FALSE;
yyvars.in_rule		= 0;
yyvars.sort_list	= 0;
yyvars.sort_by		= 0;
yyvars.agg_func		= 0;
...
memset(&yyvars.fe_cursor_id, 0, sizeof(yyvars.fe_cursor_id));
...
memset(&yyvars.join_tbls, 0, sizeof(yyvars.join_tbls));
...
memset(&yyvars.save_seq_ops, 0, sizeof(yyvars.save_seq_ops));
...
memset(&yyvars.sequence, 0, sizeof(yyvars.sequence));
...
memset(&yyvars.illegal_agg_relmask, 0, sizeof(yyvars.illegal_agg_relmask));
memset(&yyvars.flists[0], 0, sizeof(yyvars.flists[0]));
...
yyvars.arg_ix		= 0;
yyvars.loc_count	= 0;
memset(&yyvars.initial_args[0], 0, sizeof(yyvars.initial_args[0]));
yyvars.union_head	= (PST_QNODE *)NULL;
yyvars.union_prong	= 0;
...
if (cb->pss_distrib & DB_3_DDB_SESS)
{
    ...
    *psq_cb->psq_ldbdesc = *psq_cb->psq_dfltldb;
