...
**	    Last-statement-name moved to PSQ CB, fix here.
*/
DB_STATUS
psq_bgn_session(
	register PSQ_CB     *psq_cb,
	register PSS_SESBLK *sess_cb)
{
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0205_SRV_NOT_INIT, (DB_ERROR *)NULL, PSF_CALLERR, 
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0201_BAD_QLANG, (DB_ERROR *)NULL, PSF_CALLERR, 
            &err_code, &psq_cb->psq_error, 0);
	return (E_DB_ERROR);
    }
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0202_QLANG_NOT_ALLOWED, (DB_ERROR *)NULL, 
    ...
    */
    ...
    {
	(VOID) psf_error(E_PS0203_NO_DECIMAL, (DB_ERROR *)NULL, PSF_CALLERR, 
            &err_code, &psq_cb->psq_error, 0);
	return (E_DB_ERROR);
    }
    ...
    */
    ...
    {
	psf_error(E_PS0204_BAD_DISTRIB, (DB_ERROR *)NULL, PSF_CALLERR, 
            &err_code, &psq_cb->psq_error,0);
	return (E_DB_ERROR);
    }
    ...
    */
	...
	{
	    (VOID) psf_error(E_PS0208_TOO_MANY_SESS, (DB_ERROR *)NULL, 
                PSF_CALLERR, &err_code, &psq_cb->psq_error, 0);
	    status = E_DB_ERROR;
	    break;
	}
    ...
    */
    if (sem_status != OK)
    {
        err_blk.err_code = sem_status;
	(VOID) psf_error(sem_errno, &err_blk, PSF_INTERR,
	    &err_code, &psq_cb->psq_error, 0);
    }
    ...
    */
	...
	{
	    (VOID) psf_error(E_PS0F02_MEMORY_FULL, (DB_ERROR *)NULL, 
                PSF_CALLERR, &err_code, &psq_cb->psq_error, 0);
	}
	else
	{
