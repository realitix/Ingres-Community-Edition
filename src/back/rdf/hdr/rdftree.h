...
**	    Add RDF_WINDOW_IN_QUERY and change to 0x notation.
*/
...
#define                 RDF_WCHK        8
/* TRUE if pst_wchk is TRUE */
#define	    RDF_AGG_IN_OUTERMOST_SUBSEL	0x00000010L
/* set if PST_AGG_IN_OUTERMOST_SUBSEL is set */
#define	    RDF_GROUP_BY_IN_OUTERMOST_SUBSEL	0x00000020L
/* set if PST_GROUP_BY_IN_OUTERMOST_SUBSEL is set */
#define	    RDF_SINGLETON_SUBSEL	0x00000040L
/* set if PST_SINGLETON_SUBSEL is set */
#define	    RDF_CORR_AGGR		0x00000080L
/* set if PST_CORR_AGGR is set */
#define     RDF_SUBSEL_IN_OR_TREE	0x00000100L
/* set if PST_SUBSEL_IN_OR_TREE is set */
#define     RDF_ALL_IN_TREE		0x00000200L
/* set if PST_ALL_IN_TREE is set */
#define     RDF_MULT_CORR_ATTRS		0x00000400L
/* set if PST_MULT_CORR_ATTRS is set */
#define	    RDF_INNER_OJ		0x00000800L
/* set if PST_INNER_OJ is set */
#define	    RDF_AGHEAD_MULTI		0x00001000L
/* set if PST_AGHEAD_MULTI is set */
#define	    RDF_IFNULL_AGHEAD		0x00002000L
/* set if PST_IFNULL_AGHEAD is set */
#define	    RDF_IFNULL_AGHEAD_MULTI	0x00004000L
/* set if PST_IFNULL_AGHEAD_MULTI is set */
#define	    RDF_WINDOW_IN_QUERY		0x00008000L
/* set if PST_WINDOW_IN_QUERY is set */
    i2              resvno;             /* result range number, used
                                        ** by parser in qrymod,
                                        ** probably not needed but
                                        ** code is too hard to change
