...
**			PSQ_VIEW	    Packing view text
**			PSQ_INTEG	    Packing integrity text
**			PSQ_PROT	    Packing permit text
**
**  Outputs:
**	rdf_cb
**	    .rdf_rb
...
**					    here
**		    .rdf_qt_mode	    Query mode
**			PSQ_VIEW	    Packing view tree 
**			PSQ_INTEG	    Packing integrity tree 
**			PSQ_RULE	    Packing rule tree
**
**  Outputs:
**	rdf_cb
**	    .rdf_rb
