	...
	RDD_QDATA   *data)
{
    ...
    /*
    ** for PSQ_VIEW we will be given a (PST_QTREE *) rather than
    ** (PST_PROCEDURE *)
    */
    if (mode != PSQ_VIEW)
    {
	...
	*/
	...
	if ((mode == PSQ_INTEG) || (mode == PSQ_RULE))
	...
	valid_tree = PST_CATUPD_OK | PST_SQL_QUERY | PST_AGG_IN_OUTERMOST_SUBSEL
	    ...
	    | PST_X100_QUERY | PST_X100ONLY_QUERY | PST_WINDOW_IN_QUERY;
...
*/
	...
	if (qtree->pst_mask1 & PST_WINDOW_IN_QUERY)
	    version.mask |= RDF_WINDOW_IN_QUERY;
