...
**	    sc0e_uputFcn   - write an error message to the user
**
**
**  History:
**      30-jun-1986 (fred)    
...

/*{
** Name: sc0e_uputFcn	- write an error message to the user
**
** Description:
...
#define MAX_PARMS	6
    ...
    if ( !detail || err_code )
    {
        localDBerror.err_code = err_code;
	...
	status = uleFormat(detail, 0, os_error, ULE_LOOKUP,
	...
	else
	{
	    ...
	    sc0e_put(E_SC012A_BAD_MESSAGE_FOUND, (DB_ERROR *)NULL, 0, 1,
...
/* Non-variadic form of sc0e_uPutNV, insert __FILE__, __LINE__ manually */
VOID
sc0e_uPutNV(i4 err_code,
         DB_ERROR *dberror,
         CL_ERR_DESC *os_error,
         i4 num_params,
         ... )
