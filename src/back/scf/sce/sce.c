...
#define	SCE_RETRY_MAX	10		/* Maximum attempts */
	...
	if (Sc_main_cb->sc_events < 0)
	{
	    ...
	    sc0ePut(E_SC0284_BUCKET_INIT_ERROR, (DB_ERROR *)NULL, NULL, 1,
	...
	*/
	...
	if (status != E_DB_OK)
	{
	    ...
	    sc0ePut(E_SC0285_EVENT_MEMORY_ALLOC, (DB_ERROR *)NULL, NULL, 2,
	...
	*/
	...
	if (status != OK)
	{
	    sc0ePut(E_SC0286_EVENT_SEM_INIT, (DB_ERROR *)NULL, NULL, 1,
	...
	if ( !is_an_rcp )
	{
	    ...
	    */
	    ...
	    {
		sc0ePut(E_SC0273_EVENT_RETRY, (DB_ERROR *)NULL, NULL, 1,
...
sce_raise( SCF_CB  *scfcb, SCD_SCB *scb )
{
	...
	if (aparm->scfa_text_length > 0)
	{
		...
		sc0e_0_put(E_SC0207_UNEXPECTED_ERROR, (DB_ERROR *)NULL, 0);
...
sce_thread(void)
{
	...
	*/
    ...
    sc0ePut(E_SC0271_EVENT_THREAD, (DB_ERROR *)NULL, NULL, 1,
...
sce_alter( i4 op, i4	value )
{
	...
	else
	{
		...
		{
		    sc0ePut(stat, (DB_ERROR *)NULL, &clerr, 0);
