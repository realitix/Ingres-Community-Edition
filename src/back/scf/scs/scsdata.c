...
GLOBALDEF MO_CLASS_DEF Scs_classes[] =
{
  ...
  { MO_CDATA_INDEX, "exp.scf.scs.scb_query_start_secs",
	MO_SIZEOF_MEMBER( SCD_SCB, scb_sscb.sscb_cquery.cur_start_secs ),
	MO_READ, index_name,
	CL_OFFSETOF( SCD_SCB, scb_sscb.sscb_cquery.cur_start_secs ),
	MOintget, MOnoset, 0, MOidata_index },
