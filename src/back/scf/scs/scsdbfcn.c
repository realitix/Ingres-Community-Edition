	   ...
	   SCV_DBCB  **dbcb_loc )
{
	...
	*/
	...
	{
	    sc0ePut(E_SC0121_DB_OPEN, (DB_ERROR *)NULL, NULL, 4,
	    ...
	    {
		sc0ePut(E_SC010D_DB_LOCATION, (DB_ERROR *)NULL, 0, 3,
	...
	*/
	sc0ePut(E_SC0202_SEM_RELEASE, (DB_ERROR *)NULL, NULL, 0);
	sc0ePut(scf_status, error, NULL, 0);
	ret_val = scf_status;
    }
	...
	sc0ePut( E_US0050_DB_SERVER_INCOMPAT, (DB_ERROR *)NULL, NULL, 2,
             ...
             DMC_CB *dmc )
{
	...
	*/
	...
	if (ret_val = dbop_status)
	{
	    ...
	    sc0ePut(E_SC0122_DB_CLOSE, (DB_ERROR *)NULL, NULL, 2,
		     sizeof(dbcb->db_dbname), (PTR)&dbcb->db_dbname,
		     sizeof(dbcb->db_dbowner), (PTR)&dbcb->db_dbowner);
	    sc0ePut(E_SC010D_DB_LOCATION, (DB_ERROR *)NULL, NULL, 3,
		     sizeof(dbcb->db_location.loc_entry.loc_name),
		     (PTR)&dbcb->db_location.loc_entry.loc_name,
		     dbcb->db_location.loc_entry.loc_l_extent,
		     (PTR)dbcb->db_location.loc_entry.loc_extent,
	...
	{
	    sc0ePut(E_SC0201_SEM_WAIT, (DB_ERROR *)NULL, NULL, 0);
	    sc0ePut(E_SC0122_DB_CLOSE, (DB_ERROR *)NULL, NULL, 2,
		     sizeof(dbcb->db_dbname), (PTR)&dbcb->db_dbname,
		     sizeof(dbcb->db_dbowner), (PTR)&dbcb->db_dbowner);
	    sc0ePut(0, error, NULL, 0);
	}
	else
	{
	    sc0ePut(0, error, NULL, 0);
	...
	if (scf_status)
	{
	    sc0ePut(scf_status, (DB_ERROR *)NULL, NULL, 0);
	    ret_val = E_DB_FATAL;
	}
    }
    scd_note(ret_val, DB_SCF_ID);
...
scs_dbms_task(SCD_SCB *scb )
{
    ...
    */
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0238_FAST_COMMIT_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	...
	*/
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC037C_REP_QMAN_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC031E_RECOVERY_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0320_LOGWRITER_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0322_CHECK_DEAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0324_GROUP_COMMIT_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0326_FORCE_ABORT_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0330_CP_TIMER_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	scb->scb_sscb.sscb_cfac = DB_DMF_ID;
        ...
        { 
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC037F_LK_CALLBACK_THREAD_EXIT, (DB_ERROR *)NULL, 
                    NULL, 0);
        }
        break; 
	...
	*/
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0366_WRITE_ALONG_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0364_READ_AHEAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	scb->scb_sscb.sscb_cfac = DB_DMF_ID;
        ...
        { 
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0372_DEADLOCK_THREAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
        }
        break; 
	...
	scb->scb_sscb.sscb_cfac = DB_DMF_ID;
        ...
        { 
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0397_DIST_DEADLOCK_THR_EXIT, (DB_ERROR *)NULL, NULL, 0);
        }
        break; 
	...
	scb->scb_sscb.sscb_cfac = DB_DMF_ID;
        ...
        { 
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC0399_GLC_SUPPORT_THR_EXIT, (DB_ERROR *)NULL, NULL, 0);
        }
        break; 
	...
	*/
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC02C1_CSP_MAIN_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC02C3_CSP_MSGMON_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;
	...
	{
	    sc0ePut(0, &dmc->error, NULL, 0);
	    sc0ePut(E_SC02C5_CSP_MSGTHR_EXIT, (DB_ERROR *)NULL, NULL, 0);
	}
	break;

      default:
	sc0ePut(E_SC0239_DBMS_TASK_ERROR, (DB_ERROR *)NULL, NULL, 1,
	       ...
	       DB_ERROR *error )
{
    ...
    */
	...
	if (rdf_call(RDF_DDB, (PTR)&rdf_cb) != E_DB_OK)
	{
	    ...
	    /* release semaphore */
	    CSv_semaphore(&Sc_main_cb->sc_kdbl.kdb_semaphore);
	    sc0ePut(E_US0014_DB_UNAVAILABLE, error, NULL, 0);
	    return(E_DB_ERROR);
	}
    ...
    */
	...
	if (rdf_call(RDF_DDB, (PTR)&rdf_cb) != E_DB_OK)
	{
	    ...
	    /* release semaphore */
            CSv_semaphore(&Sc_main_cb->sc_kdbl.kdb_semaphore);
	    sc0ePut(E_SC0395_RDF_DDB_FAILURE, error, NULL, 1, 
	...
	/* release semaphore */
	CSv_semaphore(&Sc_main_cb->sc_kdbl.kdb_semaphore);
	sc0ePut(E_US000C_INVALID_REAL_USER, error, NULL, 0);
	return(E_DB_ERROR);
    }
    ...
    */
	...
	if (rdf_call(RDF_DDB, (PTR)&rdf_cb) != E_DB_OK)
	{
	    ...
	    /* release semaphore */
	    CSv_semaphore(&Sc_main_cb->sc_kdbl.kdb_semaphore);
	    sc0ePut(E_US0041_DBDB_CONFIG_INCON, error, NULL, 0);
	    return(E_DB_ERROR);
	}
    }
    else
    ...
    */
    ...
    {
	sc0ePut(E_US0010_NO_SUCH_DB, error, NULL, 0);
	return(E_DB_ERROR);
    }	
...
scs_audit_thread( SCD_SCB *scb )
{
    ...
    if (status != E_DB_OK)
	sc0ePut(E_SC032A_AUDIT_THREAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
...
scs_check_term_thread( SCD_SCB *scb )
{
    ...
    */
    ...
    if (status != E_DB_OK)
	sc0ePut(E_SC0341_TERM_THREAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
	...
	*/
	if(scb->scb_sscb.sscb_is_idle)
	{
		...
		*/
	    ...
	    sc0ePut(I_SC0344_SESSION_DISCONNECT, (DB_ERROR *)NULL, NULL, 3,
	    ...
	    */
		...
		&& DB_FAILURE_MACRO(sc0a_write_audit(
	        ...
	        */
	        sc0ePut(E_SC023C_SXF_ERROR, (DB_ERROR *)NULL, NULL, 0);
            }
	    scs_remove_sess(scb);
	    break;
	}
...
scs_secaudit_writer_thread( SCD_SCB *scb )
{
    ...
    if (status != E_DB_OK)
	sc0ePut(E_SC0361_SEC_WRITER_THREAD_EXIT, (DB_ERROR *)NULL, NULL, 0);
		...
		DB_ERROR *error)
{
    ...
    {
    	sc0ePut(0, &dmc->error, NULL, 0);
    	sc0ePut(E_SC0365_IOMASTER_OPENDB, (DB_ERROR *)NULL, NULL, 0);
    }
...
scs_dbadduser(SCF_CB	*scf_cb, SCD_SCB *scb )
{
    ...
    */
    ...
    if (notfound)
    {
	sc0ePut(E_SC012D_DB_NOT_FOUND, &scf_cb->scf_error, NULL, 0);
