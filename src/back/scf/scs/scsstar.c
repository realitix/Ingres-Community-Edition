...
scs_dctdesc(SCD_SCB *scb )
{
    ...
    */
    ...
    {
	sc0e_put(status, (DB_ERROR *)NULL, 0, 0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0);
	sc0e_uput(status, (DB_ERROR *)NULL, 0, 0,
		  0, (PTR)0,
		  0, (PTR)0,
		  0, (PTR)0,
		  0, (PTR)0,
	    ...
	    GCA_RV_PARMS **rv )
{
	         ...
	         (scb->scb_cscb.cscb_gci.gca_status == E_GC0023_ASSOC_RLSED))
	{
    	...
    	sc0e_put(scb->scb_cscb.cscb_gci.gca_status, (DB_ERROR *)NULL,
		 ...
		 0, (PTR)0,
		 0, (PTR)0);
    	sc0e_put(E_SC022F_BAD_GCA_READ, (DB_ERROR *)NULL, 0, 0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
...
scs_dcendcpy( SCD_SCB *scb )
{
	...
	if( status2 )
	{
	    sc0e_put( status2, (DB_ERROR *)NULL, 0, 0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0,
            ...
            i4	opcode )
{
    ...
    */
    ...
    {
	sc0e_put(E_SC0024_INTERNAL_ERROR, (DB_ERROR *)NULL, 0, 0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
		 0, (PTR)0,
    ...
    */
	...
	default :
	    ...
	    sc0e_uput( E_SC0226_BAD_GCA_TYPE, (DB_ERROR *)NULL, 0, 1, 
		      ...
		      0, (PTR)0,
		      0, (PTR)0);
	    sc0e_uput( E_SC0206_CANNOT_PROCESS, (DB_ERROR *)NULL, 0, 0,
		      0, (PTR)0,
		      0, (PTR)0,
		      0, (PTR)0,
		      0, (PTR)0,
	   ...
	   i4  opcode )
{
    ...
    *next_op = CS_OUTPUT;
	...
	else
	{
	    ...
	    *qry_status = GCA_FAIL_MASK;
	    sc0e_put(E_SC0226_BAD_GCA_TYPE, (DB_ERROR *)NULL, 0, 0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0,
		     0, (PTR)0);
	    sc0e_uput(E_SC0226_BAD_GCA_TYPE, (DB_ERROR *)NULL, 0, 0,
		      0, (PTR)0,
		      0, (PTR)0,
		      0, (PTR)0,
		      0, (PTR)0,
