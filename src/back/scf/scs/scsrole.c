...
scs_get_session_roles(SCD_SCB *scb)
{
	...
	*/
	...
	if (status)
	{
		...
		sc0e_0_put(E_US247B_9339_IIROLEGRANT_OPEN, (DB_ERROR *)NULL, 0);
		break;
	}
	opened = TRUE;
	...
	*/
	...
	if (status)
	{
		sc0e_0_put(0, &rqeu.error, 0);
		sc0e_0_put(E_SC0352_IIROLE_ERROR, (DB_ERROR *)NULL, 0);
		break;
	}
	...
	*/
	...
	{
		sc0e_0_put(0, &qeu.error, 0);
		sc0e_0_put(E_US247C_9340_IIROLEGRANT_ERROR, 
                           (DB_ERROR *)NULL, 0);
	}
    }
    ...
    */
    if(status!=E_DB_OK)
    {
	sc0e_0_put(E_SC0353_SESSION_ROLE_ERR, (DB_ERROR *)NULL, 0);
    }
    return status;
}

	...
	*/
	...
	do {
	    ...
	    */
		...
		sc0e_put(E_SC0351_IIROLE_GET_ERROR, (DB_ERROR *)NULL, 0,1,
...
)
{
	...
	*/
	...
	sc0e_0_put(E_SC035E_LOAD_ROLE_DBPRIV, (DB_ERROR *)NULL, 0);
    }
    return status;
}
