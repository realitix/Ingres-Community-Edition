...
**	05-Apr-11 (wanfr01) b125244
**	    Removed accidental comments which reduced output
[@history_template@]...
*/
VOID
opt_state(
...
**	5-Apr-11 (wanfr01) b125244
**	    Removed unintended comments that reduced output
[@history_template@]...
*/
static VOID
opt_subquery(
	...
	OPS_SUBQUERY	*subqry )
{
	...
	TRformat(opt_scc, (i4*)NULL, global->ops_cstate.opc_prbuf,
	    OPT_PBLEN, "opl_mask: %x\t opl_id: %d\n\n",
	    oj->opl_mask, oj->opl_id);
