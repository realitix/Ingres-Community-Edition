		...
		OPC_EQ		*oceq)
{
    ...
    */
    ...
    ops[1].opr_collID = seop->pst_left->pst_left->pst_sym.pst_dataval.db_collID;	
    ...
    */
	    ...
	    )
	{
	    ...
	    */
	    ...
	    ops[1].opr_len = OPC_UNKNOWN_LEN;
	    ops[1].opr_prec = OPC_UNKNOWN_PREC;
	    ops[1].opr_collID = corratt->opv_sevar->pst_sym.pst_dataval.db_collID;
    ...
    */
    ...
    ops[1].opr_len = OPC_UNKNOWN_LEN;
    ops[1].opr_prec = OPC_UNKNOWN_PREC;
    ops[1].opr_collID = seop->pst_left->pst_right->pst_sym.pst_dataval.db_collID;
