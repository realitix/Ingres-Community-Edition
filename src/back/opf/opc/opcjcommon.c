...
**      24-may-2011 (huazh01)
**          restart function attribute processing from eqcno 0 if ceq[]
**          has been updated. back out the fix b121824 as this change
**          fixes b121824 as well. (b125324)
[@history_template@]...
*/
VOID
opc_jmerge(
		    ...
		    )
		{
			   ...
			   )
			{
			    ...
			    ceq[eqcno].opc_attno = attno;
                            ...
                            /* b125324: start over since some other (nested) 
                            ** function attributes may be depending on this
                            ** eqc, those attributes may be available now. 
                            */
                            BTset(eqcno, &avail_eqcmp); 
                            eqcno = -1; 
			    break;
			}
		    }
		...
		*/
		    ...
		    )
		{
			...
			*/
			...
			keyvalop.opr_len = 0;
			keyvalop.opr_prec = 0;
			keyvalop.opr_collID = DB_UNSET_COLL;
	...
	QEF_KOR	    *qekor )
{
	...
	*/
	...
	key_ops[0].opr_len = 2;
	key_ops[0].opr_collID = DB_UNSET_COLL;
	...
	key_ops[4].opr_collID = DB_UNSET_COLL;
		...
		OPC_EQ		*child_ceq)
{
	...
	*/
	...
	opc_adempty(global, &dv,
		adeops[0].opr_dt, adeops[0].opr_prec,
		adeops[0].opr_len, adeops[0].opr_collID);
