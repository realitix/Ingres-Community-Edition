	...
	OPS_ALTER          *altercb)
{
	...
	case OPF_HASH:
	{
	    altercb->ops_amask |= (OPS_AHASHAGG | OPS_AHASHJOIN); /* enable hash agg & join */
	    break;
	}
	case OPF_NOHASH:
	{
	    altercb->ops_amask &= ~(OPS_AHASHAGG | OPS_AHASHJOIN); /* disable hash agg & join */
	    break;
	}
	case OPF_HASHAGG:
	{
	    altercb->ops_amask |= OPS_AHASHAGG; /* enable hash aggregation */
	    break;
	}
	case OPF_NOHASHAGG:
	{
	    altercb->ops_amask &= ~OPS_AHASHAGG; /* disable hash aggregation */
	    break;
	}
	case OPF_HASHJOIN:
	{
	    altercb->ops_amask |= OPS_AHASHJOIN; /* enable hash join */
	    break;
	}
	case OPF_NOHASHJOIN:
	{
	    altercb->ops_amask &= ~OPS_AHASHJOIN; /* disable hash join */
	    break;
	}
	case OPF_NEWENUM:
	{
	...
	case OPF_REUSE:
	{
	    altercb->ops_reuse = TRUE;		/* enable subquery reuse */
	    break;
	}
	case OPF_NOREUSE:
	{
	    altercb->ops_reuse = FALSE;		/* disable subquery reuse */
	    break;
	}
	case OPF_ARESOURCE:
	{
