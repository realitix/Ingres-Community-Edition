	...
	PST_STATEMENT	    *sp)
{
	...
	case PST_QT_TYPE:
	{
	    ...
	    if (qheader->pst_mask1 & PST_X100_QUERY)
		global->ops_gmask |= OPS_X100;
	    if (qheader->pst_mask1 & PST_X100ONLY_QUERY)
	...
	OPF_CB             *opf_cb)
{
    ...
    MEfill(sizeof(global), 0, (PTR)&global);
