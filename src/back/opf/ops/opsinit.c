	...
	PST_STATEMENT      *statementp)
{
    ...
    }
   {
	...
	global->ops_goj.opl_antijmap = (OPL_BMOJ *) NULL;
	global->ops_goj.opl_semijmap = (OPL_BMOJ *) NULL;
	global->ops_goj.opl_subqjmap = (OPL_BMOJ *) NULL;
...
** boolean parameter */
    ...
    */
    ...
    global->ops_estate.opn_statistics = FALSE; /* statistics has not been
				    ** turned on yet */
    global->ops_estate.opn_reset_statistics = FALSE;
	...
	OPS_STATE          *global)
{
	...
	** to deallocated memory */
    ...
    global->ops_cstate.opc_topahd = (QEF_AHD *) NULL;
