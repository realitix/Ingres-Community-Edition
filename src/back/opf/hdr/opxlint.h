...
**	9-apr-2010 (dougi)
**	    Added opc_x100_derck() so it can be shared between opc & opn.
**	08-Nov-2010 (kiria01) SIR 124685
**	    Rationalise function prototypes
**	4-july-2011 (dougi) m2196
**	    Add opa_gresolve().
**	29-Jul-2011 (kiria01) b125613
**	    Updated call interfaces of opa_resolve, opa_gresolve, opl_resolve
**	    in line with pst_resolve.
**/
...
FUNC_EXTERN void opa_resolve(
	OPS_SUBQUERY *subquery,
	PST_QNODE **nodep);
FUNC_EXTERN void opa_gresolve(
	OPS_STATE *global,
	PST_QNODE **nodep);
FUNC_EXTERN void opa_cosubquery(
	OPS_STATE *global,
	OPV_GBMVARS *varmap,
	PST_QNODE *qnode);
...
FUNC_EXTERN void opa_link(
	OPS_STATE *global);
/* opanode.c */
FUNC_EXTERN PST_QNODE *opa_makeop(
	OPS_STATE *global,
	PST_TYPE optype,
	ADI_OP_ID opid,
	PST_QNODE *operand1,
...
FUNC_EXTERN void opn_sm1(
	...
	OPV_BMVARS *vmap);
/* opnsm2.c */
FUNC_EXTERN bool opn_nojoinixck(
	OPE_EQCLIST *eqclp,
	OPV_BMVARS *lvmap,
	OPV_BMVARS *rvmap,
	OPV_IVARS maxvar);
...
FUNC_EXTERN OPO_ISORT opo_kordering(
	...
	OPV_VARS *varp,
	OPE_BMEQCLS *eqcmap);
FUNC_EXTERN void opo_clustpr_rsort(
	OPS_SUBQUERY *,
	OPO_CO *);
FUNC_EXTERN void opo_clustsj(
	OPS_SUBQUERY *,
	OPO_CO *);
FUNC_EXTERN void opo_FDsj(
	OPS_SUBQUERY *,
	OPO_CO *);
FUNC_EXTERN void opo_upr_rsort(
	OPS_SUBQUERY *,
	OPO_CO *);
FUNC_EXTERN void opo_usj(
	OPS_SUBQUERY *,
	OPO_CO *);
...
FUNC_EXTERN void opt_eclass(
	OPE_IEQCLS eqcls);
FUNC_EXTERN void opt_morder(
	OPE_IEQCLS eqcls);
FUNC_EXTERN void opt_eall(void);
FUNC_EXTERN void opt_mall(void);
...
FUNC_EXTERN PST_QNODE *opv_i1const(
	OPS_STATE *global,
	i4 intvalue);
FUNC_EXTERN PST_QNODE *opv_dblconst(
	OPS_STATE *global,
	f8 dblvalue);
FUNC_EXTERN PST_QNODE *opv_nullconst(
	OPS_STATE *global);
...
FUNC_EXTERN void opv_ijnbl(
	OPS_SUBQUERY *subquery);
FUNC_EXTERN VOID opv_x100_pagecount(
	OPS_SUBQUERY *subquery);
FUNC_EXTERN VOID opv_x100_joinsetup(
	OPS_SUBQUERY *subquery);
/* opvindex.c */
...
FUNC_EXTERN PST_QNODE *opv_opnode(
	...
	ADI_OP_ID operator,
	OPL_IOUTER ojid);
FUNC_EXTERN PST_QNODE *opv_casenode(
	OPS_STATE *global,
	i4 type);
FUNC_EXTERN PST_QNODE *opv_whlistop(
	OPS_STATE *global);
FUNC_EXTERN PST_QNODE *opv_operand(
	OPS_STATE *global,
	PST_QNODE *opndp);
/* opvparser.c */
...
FUNC_EXTERN PST_QNODE *opv_resdom(
	...
	PST_QNODE *function,
	DB_DATA_VALUE *datatype);
FUNC_EXTERN void opv_norm_resdom(
	OPS_STATE *global,
	PST_QNODE *resdom,
	bool force);
/* opvsmap.c */
...
FUNC_EXTERN void opz_savequal(
	...
	bool right_iftrue);
/* opcx100.c */
FUNC_EXTERN void opc_x100_derck(
	OPS_SUBQUERY *subquery,
	PST_QNODE *bylistp,
	bool drop_const);
FUNC_EXTERN void opc_x100ahd_build(
	OPS_STATE *global,
	QEF_AHD **x100_action);
FUNC_EXTERN void opa_x100_xform(
	OPS_STATE *global,
	PST_QNODE **nodep);
