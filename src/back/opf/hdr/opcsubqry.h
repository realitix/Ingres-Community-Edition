...
**          defined
**	9-dec-2008 (dougi)
**	    Added opc_bfsaggnext, opc_prsaggnext for X100 compilation.
*/
struct _OPC_SUBQUERY
{
	...
	*/
    ...
    struct _OPS_SUBQUERY    *opc_bfsaggnext; /* chain of BF SAGGs for X100 */
    struct _OPS_SUBQUERY    *opc_prsaggnext; /* chain of PR SAGGs for X100 */
