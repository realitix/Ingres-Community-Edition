...
**	28-jan-2009 (dougi)
**	    Init ope_repjoin, ope_joinrep, ope_rjreded, ope_rjrefing introduced
**	    for X100 join index support.
*/
OPE_IEQCLS
ope_neweqcls(
	OPS_SUBQUERY	   *subquery,
	OPZ_IATTS          attr)
{
	...
	eqcls_ptr->ope_rjrefed = (OPV_BMVARS *) NULL;
	eqcls_ptr->ope_rjrefing = (OPV_BMVARS *) NULL;
	eqcls_ptr->ope_repjoin = (OPE_BMEQCLS *) NULL;
	eqcls_ptr->ope_joinrep = (OPE_BMEQCLS *) NULL;
	eqcls_ptr->ope_nojoinix = (OPV_BMVARS *) NULL;
