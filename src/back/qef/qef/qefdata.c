/*
** Copyright (c) 1995, 2008 Actian Corporation
*/
...
**      11-Feb-2009 (gefei01)
**          Add E_QE0311_X100_ERROR to QEF_ERR_MAP.
...
**      05-Oct-2009 (gefei01)
**          ADD E_QE0312_X100_INDEX_EXISTS to QEF_ERR_MAP.
**	15-Jan-2010 (jonj)
...
**	    Add VW1015 to the map, it's the x100 interrupt code.
...
GLOBALDEF const QEF_ERR_MAP Qef_err_map[] = 
{
    ...
    0L,				    E_QE0311_X100_ERROR,            -1,	    1,
    0L,				    E_QE0312_X100_INDEX_EXISTS,     -1,	    1,
    0L,				    E_QE0313_IVW_NO_SP_ABORT,	    -1,	    1,
...
/* X100 error codes start here */
    0L,                             E_QE0600_X100_ERROR,            -1,     1,
    0L,                             E_QE0601_X100_ERROR,            -1,     1,
...
/*  QEF/STAR error codes end here */
    ...
    0L,                             I_QE2037_DROP_RESTRICT_ERR,      9360,  1,
...
*/
    ...
    /* VW messages will mostly have been controled in vw_error and qeferror
    ** will treat them as E_VWxxx_yyy, E_QE0122_ALREADY_REPORTED, -1, 0,
    ** unless listed in here for particular QEF handling */
    E_VW1031_COMMIT,		    E_QE0087_ERROR_COMMITING_TRAN,  -1,	    0,
    E_VW1015_KILL,		    E_QE0022_QUERY_ABORTED,	  4708,	    0,
