...

{
    ...
    */
    ...
    qec_tprintf(rcb, cbufsize, cbuf);
    STprintf(cbuf, "Build row count: %lld, probe row count: %lld, result row count: %lld\n",
...
**      26-Sep-2011 (hanal04) Bug 125774
**          Always set HASH_NOHASHT during a reset to prevent subsequent 
**          attempts to use a hash table that has been dropped.
*/
static DB_STATUS
qen_hjoin_reset(QEF_RCB	*rcb,
	QEE_DSH		*dsh,
