...
**	28-aug-2008 (dougi)
**	    Add qea_x100() for preliminary X100 support.
...
**	    Replace DB_QMODE with PSQ_MODE.
**	    Drop qeu-d-check-conix.
*/
...
FUNC_EXTERN DB_STATUS qea_x100_drconstraint(
QEF_AHD		*,
QEF_RCB		*);
...
FUNC_EXTERN DB_STATUS
qea_x100_begin_session(QEF_CB *);

FUNC_EXTERN DB_STATUS
qea_x100_end_session(QEF_CB *);
