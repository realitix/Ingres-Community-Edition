...
#define		RDR2_REFREL	  0x40000000L /* refrel information */
...
**	17-dec-2008 (dougi)
**	    Add rdr_refrel to address referential relationship info.
*/
typedef struct _RDR_INFO
{
	...
	DMT_COLCOMPARE	*rdr_colcompare; /* Pointer to column comparison 
					** structure/array */
	DMT_REFREL	*rdr_refrel;	/* Pointer to referential relationship
					** structure array */
