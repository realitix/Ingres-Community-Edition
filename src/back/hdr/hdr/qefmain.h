...
**	    Add X100 drop temp table function (used by DMF).
...
#define	QEF_T_PROCERR	131	/*
				...
				*/
#define	QEF_T_X100_STRUCT 132	/* server flag to treat all DDL as being
				** for X100 tables */
...
#define E_QE0311_X100_ERROR             (E_QEF_MASK + 0x0311L)
#define E_QE0312_X100_INDEX_EXISTS      (E_QEF_MASK + 0x0312L)
#define E_QE0313_IVW_NO_SP_ABORT	(E_QEF_MASK + 0x0313L)

...
/* X100 errors: 600 to 6FF */

#define E_QE0600_X100_ERROR		(E_QEF_MASK + 0x0600L)
#define E_QE0601_X100_ERROR		(E_QEF_MASK + 0x0601L)
...
#define I_QE2037_DROP_RESTRICT_ERR	(E_QEF_MASK + 0x2037L)
...
#define	QEU_X100DBU	    107	    /* DROP TABLE, etc. on X100 */
