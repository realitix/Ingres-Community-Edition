...

/*}
** Name: DB_REFREL	- Referential relationship catalog tuple
**
** Description:
**      This structure defines a tuple in the IIREFREL catalog table.
**
** History:
**	15-dec-2008 (dougi)
**	    Written for X100 (but also applicable to old Ingres).
*/
typedef struct _DB_REFREL
{
    DB_TAB_ID	dbrr_refedtabid;	/* Table id of referenced table */
    DB_TAB_ID	dbrr_refingtabid;	/* Table id of referencing table */
    DB_CONSTRAINT_ID	dbrr_consid;	/* constraint id */
    DB_SCHEMA_ID	dbrr_schemaid;
    DB_CONSTRAINT_NAME	dbrr_relname;	/* relationship name */
    i4		dbrr_refingixcol;	/* Colno of refing join ix col */
    i4		dbrr_colcount;		/* Number of columns in relationship */
    u_i2	dbrr_refedcols[16];	/* Array of referenced colnos */
    u_i2	dbrr_refingcols[16];	/* Array of referencing colnos */
    u_i4	dbrr_relflags;		/* Flag field */
}   DB_REFREL;

/*}
...
**
** Description:
**      This type is used to define the query mode for the catalogs.
**
** History:
**	22-apr-88 (seputis)
**          initial creation
...
**	16-Jun-2012 (kschendel) SIR 126676
**	    Drop definitions that have to match psq-mode values.
**	    Move PSQ_MODE enum here from psfparse.h.
...
/* Other values match various PSQ_MODE values, e.g. PSQ_VIEW.  DB_QMODE is
** not defined as an enum psq_mode_enum here because DB_QMODE is meant to
** explicitly be an i2.
*/

/*
** Definitions of parser modes.  While these have parser-like names, lots
** of places use the definition, so it's more global than just parser use.
**
**	* Beware *
**	You can't randomly change some of these, because the PSQ_MODE is also
**	used as the dependency type in the iidbdepends catalog.  If you
**	change the value of any of the dependency types, you will invalidate
**	existing catalogs!
**
**	The qmodes used for dependencies are:
**		PSQ_VIEW	PSQ_PROT	PSQ_INTEG
**		PSQ_CREDBP	PSQ_0_CRT_LINK	PSQ_REG_LINK
**		PSQ_REG_IMPORT	PSQ_RULE	PSQ_EVENT
**		PSQ_INDEX	PSQ_CSYNONYM	PSQ_CONS
**		PSQ_CALARM	PSQ_CSEQUENCE
**
**	In addition, stored query trees for views etc may have stored
**	PSQ_MODE values in them.
*/

/* Did you read the above note about not changing existing values? */

typedef enum psq_mode_enum {
#define PSQ_MODES_MACRO \
_DEFINE(PSQ_DB_TABLE,		 0,"DB_TABLE" /* Fake mode for iidbdepends */)\
...
_DEFINE(PSQ_INDEX,              10,"CREATE INDEX" /* iidbdepends */)\
...
_DEFINE(PSQ_VIEW,               17,"CREATE VIEW" /* iidbdepends */)\
_DEFINE(PSQ_ABSAVE,             18,"ABORT TO SAVEPOINT")\
_DEFINE(PSQ_PROT,               19,"CREATE PERMIT" /* iidbdepends */)\
_DEFINE(PSQ_INTEG,              20,"CREATE INTEGRITY" /* iidbdepends */)\
...
_DEFINE(PSQ_EVENT,              33,"CREATE DBEVENT" /* iidbdepends */)\
_DEFINE(PSQ_34_unused,          34,"PSQ_34_unused")\
...
_DEFINE(PSQ_SPARALLEL,          59,"SET PARALLEL")\
...
_DEFINE(PSQ_CREDBP,             87,"CREATE PROCEDURE" /* iidbdepends */)\
...
_DEFINE(PSQ_0_CRT_LINK,        100,"CREATE LINK" /* iidbdepends */)\
_DEFINE(PSQ_REG_LINK,          101,"REGISTER...AS LINK" /* iidbdepends */)\
_DEFINE(PSQ_SECURE,            102,"PREPARE TO COMMIT")\
_DEFINE(PSQ_REG_IMPORT,        103,"REGISTER...AS IMPORT" /* iidbdepends */)\
...
_DEFINE(PSQ_RULE,              110,"CREATE RULE" /* iidbdepends */)\
...
_DEFINE(PSQ_CALARM,            131,"CREATE SECURITY_ALARM" /* iidbdepends */)\
...
_DEFINE(PSQ_CSYNONYM,          138,"CREATE SYNONYM" /* iidbdepends */)\
...
_DEFINE(PSQ_SNUMOVFL,          145,"SET NUMERIC_OVERFLOW")\
...
_DEFINE(PSQ_CONS,              149,"ANSI CONSTRAINT declaration" /* iidbdepends */)\
...
_DEFINE(PSQ_CSEQUENCE,         179,"CREATE SEQUENCE" /* iidbdepends */)\
...
_DEFINE(PSQ_X100_DGTT,         194,"VW DECLARE TEMPORARY TABLE")\
_DEFINE(PSQ_X100_CRCONST,      195,"VW CREATE CONSTRAINT")\
_DEFINE(PSQ_X100_CRINDEX,      196,"VW CREATE INDEX")\
_DEFINE(PSQ_SSTRTRUNC,         197,"SET STRING_TRUNCATION")\
_DEFINE(PSQ_X100_DRCONST,      198,"VW DROP CONSTRAINT")\
_DEFINE(PSQ_X100_DRINDEX,      199,"VW DROP INDEX")\
_DEFINE(PSQ_200_unused,        200,"PSQ_200_unused")\
_DEFINE(PSQ_201_unused,        201,"PSQ_201_unused")\
_DEFINE(PSQ_IVWCALL,           202,"PSQ_IVWCALL")\
_DEFINE(PSQ_X100_ALTABLE,      203,"VW ALTER TABLE")\
_DEFINE(PSQ_204_unused,        204,"PSQ_204_unused")\
_DEFINE(PSQ_205_unused,        205,"PSQ_205_unused")\
_DEFINE(PSQ_X100_DGTT_AS,      206,"VW DECLARE (temporary) AS SELECT")\
_ENDDEFINE
