...
**          Added tbl_key_count
**      22-mar-2011 (stial01)
**          Remove DMT_C_VIEWS and DMT_BASE_VIEW since 
...
**	    Correct datatype of att_collID
*/
typedef struct
{
...
#define                 DMT_F_TPROCPARM    0x8000 /* This attribute is actually
                                                   ...
                                                   ** (flag used ONLY in
                                                   ** DMT_ATT_ENTRYs) */
#define			DMT_F_VWJOINIX	   0x10000 /* This attribute is a VW
						   ** joinix and has already 
						   ** been acknowledged (flag
						   ** used ONLY in ATT_ENTRYs) */
    ...
    i4	    att_intlid;		   /* internal attribute id not altered
					   ...
					   ** effect att_number.
					   */
    DB_COLL_ID	att_collID;		/* collation ID */
...
typedef struct
{
    ...
    i8		pp_reltups;		/* Physical partition row-count */
    i8		pp_relpages;		/* Physical partition page count */
...

/*}
** Name: DMT_REFREL	- referential relationship info descriptor
**
** Description:
**	Referential relationship descriptions - most importantly the map
**	of referencing to referenced columns - are kept in an array by
**	table.
**
** History:
**	17-dec-2008 (dougi)
...
typedef struct
{
    i4		refrel_cnt;		/* count of entries in descr array */
    DB_REFREL	refrel_array[1];	/* descriptor array */
} DMT_REFREL;

/*}
...
#define DMT_M_STATS	    0x400L	/* current row/page counts */ 
    ...
    */
    i8		    dmt_reltups;	/* Latest value of # of rows */
    i8		    dmt_relpages;	/* Latest value of # of pages */
}   DMT_SHW_CB;

/*}
...
**	26-aug-2008 (dougi)
**	    Add TPROC and X100 to storage types - for completeness.
**	5-jan-2009 (dougi)
**	    Add X100CL, X100IX to storage types (clustered/indexed X100).
...
**	15-sep-2010 (dougi)
**	    Add X100RW to storage types (For IVW PAX).
*/
typedef struct _DMT_TBL_ENTRY
{
    ...
    i4	       tbl_key_count;		/* Count of keys in table */
...
#define		       DMT_X100_TYPE	    19L
#define		       DMT_X100CL_TYPE	    23L
#define		       DMT_X100IX_TYPE	    29L
#define		       DMT_X100RW_TYPE	    31L
...
#define                DMT_SECURE        0x40000000L
					    ...
					    ** view
					    */
    i8        tbl_record_count;        /* Table estimated record count. */
    i8        tbl_page_count;          /* Estimated page count in table. */
...
#define	DMT_X100_INVIEW		    0x00080000L /* X100 table in this view */
