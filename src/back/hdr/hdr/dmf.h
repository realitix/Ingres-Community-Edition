...
**	19-Mar-2010 (galjo01) fix for hpux
**          removed vestigal struct _DM_ERR and its typedef DM_ER
**          which hp/ux aCC did not like, and are unused
**	14-May-2010 (stial01)
...
**	    Add "temp table is being updated" call, used for x100 DML ops
**	    to notify DMF to update a gtt savepoint ID.  (non-x100 does
**	    this notification within DMF itself.)
*/
...
/* 42 thru 48 unused */
#define		DMT_GTT_UPD		49 /* Temp table update notification */
...
**	      (*, 34) or (*, 35)
**
**	      When I added entries for IIREFREL (78), all numbers from 1 thru 77
**	      were taken EXCEPT for 10-19. But I was afraid to take one of them 
**	      for fear they were already used for something else.  DougI.
** History:
**      09-jul-86 (jennifer)
**          Created.
**	10-dec-86 (fred)
...
#define		DM_B_REFREL_TAB_ID		78L	/* iirefrel */
#define		DM_I_REFREL_TAB_ID		0L
#define		DM_1_REFREL_KEY			3L	/* refingid */
#define		DM_2_REFREL_KEY			4L	/* refingidx */
...
**	    Correct datatype of attr_collID
*/
...
#define 		DMU_F_LEGAL_ATTR_BITS  (\
    ...
    DB_IIDEFAULT    *attr_defaultTuple;
			...
			*/
    DB_COLL_ID	attr_collID;	/* collation ID (for character columns) */
...
#define			DSC_V0		0L	/* Vectorwise pre CLUSTERED
						**		INDEXES */
#define			DSC_V1		1L	/* Vectorwise 1.0 */
