...
**	16-oct-2009 (dougi)
**	    Added qef_dbname for convenience (in the X100 interface).
**	8-mar-2010 (dougi)
**	    Added qef_syscxxx fields for IVW "syscall" interface.
...
**	27-aug-2010 (dougi)
**	    Add qef_dba for combine auth checking in IVW.
**	20-Aug-2010 (thaju02) B123876
**	    Add qef_retcurspos. 
**	6-Jan-2011 (kschendel)
**	    Add table name for temp table drop function.
*/
struct _QEF_RCB
{
    /* standard stuff */
...
#define QEFRCB_ASCII_ID  CV_C_CONST_MACRO('Q', 'E', 'R', 'C')
    ...
    i8	qef_rowcount;   /*
				...
				*/
    i8	qef_targcount;	/* how many rows were touched in query */
...
#define	QEF_UPGRADEDB_SESSION		0x01
    ...
    DB_TRAN_ID	qef_tran_id;	/* Transaction identifier.
				...
				*/
    DB_DB_NAME	qef_dbname;		/* name of connected to database */
    DB_TEXT_STRING	*qef_sysccmd;	/* IVW syscall command */
    DB_TEXT_STRING	*qef_syscargs;	/* optional IVW syscall arguments */
    DB_TAB_NAME		*qef_tabname_p;	/* Name for X100 drop temp table */
};

/*}
