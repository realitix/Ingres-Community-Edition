/*
** Copyright (c) 1990, 2007 Actian Corporation
** All Rights Reserved
*/
#ifndef	GL_INCLUDE
#define                 GL_INCLUDE      0
...
**	19-Sep-2011 (drivi01)
**	    Update service name to be 'VectorWise'.
**/

/*
...
#if defined(conf_IVW)
# define SYSTEM_PRODUCT_NAME           "VectorWise"
...
# define SYSTEM_COPYRIGHT_MSG          \
         "-- Copyright (c) 1989, 2007 Actian Corporation"
