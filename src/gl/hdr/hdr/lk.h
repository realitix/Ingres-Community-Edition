...
**	    Renamed LK_LOCK_MODE_MEANING to LOCK_MODE, removed
**	    obsolete LK_EXTEND_FILE, LK_OWNER_ID, LK_PH_PAGE lock
**	    types, renumbered the remaining. Replaced LLB_INFO_?
**	    with unified LLB_? bits. This file is now the defining
**	    repository of all public/private status bits and 
**	    string mappings. Removed obsolete function LKnode()
**	    function definition.
*/

...
#define LOCK_MODE "N,IS,IX,S,SIX,U,X"
...
**	04-Jan-2011 (jonj) SIR 124894 LG/LK/IPM unification
**	    Remove deprecated LK_EXTEND_FILE, LK_OWNER_ID, LK_PH_PAGE types,
...
#define			LK_PAGE			3
#define			LK_BM_PAGE		4
#define                 LK_CREATE_TABLE         5
#define                 LK_CONFIG               6
#define                 LK_DB_TEMP_ID           7
#define			LK_SV_DATABASE		8
#define			LK_SV_TABLE		9
#define			LK_SS_EVENT		10
#define                 LK_TBL_CONTROL		11
#define			LK_JOURNAL		12
#define                 LK_OPEN_DB		13
#define			LK_CKP_DB		14
#define			LK_CKP_CLUSTER		15
#define                 LK_BM_LOCK		16
#define                 LK_BM_DATABASE		17
#define                 LK_BM_TABLE		18
#define			LK_CONTROL		19
#define			LK_EVCONNECT		20
#define			LK_AUDIT		21
#define			LK_ROW			22
#define                 LK_CKP_TXN              23
#define			LK_VAL_LOCK		24
#define			LK_SEQUENCE		25
#define			LK_XA_CONTROL		26
#define			LK_CSP			27
#define			LK_CMO			28
#define			LK_MSG			29
#define			LK_ONLN_MDFY		30
#define			LK_CROW			31
#define			LK_TBL_MVCC		32
/* Kindly maintain... */
#define			LK_MAX_TYPE		32

#define LK_LOCK_TYPE_MEANING \
/*  0 -  10 */ "0,DATABASE,TABLE,PAGE,BM_PAGE,CREATE,CONFIG,DB_TEMP_ID,SV_DATABASE," \
/* 11 -  20 */ "SV_TABLE,SS_EVENT,TBL_CONTROL,JOURNAL,OPEN_DB,CKP_DB,CKP_CLUSTER,BM_LOCK,BM_DATABASE,BM_TABLE," \
/* 21 -  30 */ "CONTROL,EVCONNECT,AUDIT,ROW,CKP_TXN,VAL_LOCK,SEQUENCE,XA_CONTROL,CSP," \
