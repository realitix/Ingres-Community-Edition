...
**	    Moved MO_MAX_NUM_BUF definition here where client code can
**	    use it.
*/
...
/*
** MOlongout/MOulongout preferred output size for possible 64 bit machines
*/
# define MO_MAX_NUM_BUF (MAX_I8_DIGITS_AND_SIGN + 1) /* + 1 for '\0' */
