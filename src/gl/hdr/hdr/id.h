...
**      14-oct-2011 (maspa05) bug 123595
**          ID_UUI_SEM_LOCK and _UNLOCK to use CS_cp_synch_lock and _unlock
**          i.e. make consistent with above change
**/
...
#define ID_UUID_SEM_LOCK(exclusive,mutex)    CS_cp_synch_lock(mutex)
#define ID_UUID_SEM_UNLOCK(mutex)            CS_cp_synch_unlock(mutex)
#endif
