...
**      27-Sep-2011 (hanal04) Bug 125775
**          Don't add default justification to a format that already has
**          already error free and then pass in incomplete format block around
**          until someone SEGVs on the content.
*/
