:
#
# Copyright Actian Corporation 2007, 2011. All Rights Reserved.
#
#
...
##          Check for available diskspace under LOCATION/ingres if it exists 
##          in case it's on a different device to LOCATION.
##	08-Apr-2011 (hanje04)
##	    Include header in distributed file
