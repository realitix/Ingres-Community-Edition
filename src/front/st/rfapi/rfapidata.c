...
**	22-Nov-2010 (hanje04)
**	    Add new parameter and default for II_VWCFG_MAX_PARALLELIS
**	30-Sep-2011 (hanje04)
**	    Bug 125688
...
static RFAPI_VAR ii_config_type = {
			II_CONFIG_TYPE,
			"II_CONFIG_TYPE",
			"Configuration to be applied to instance",
			II_RF_DP_ALL,
			II_RF_DP_ALL,
			"TXN",
			"TXN"
...
static RFAPI_VAR ii_mt_java_home = {
			II_MTS_JAVA_HOME,
			"II_MTS_JAVA_HOME",
			"JRE used by Remote Manager Service",
			II_RF_DP_LINUX,
			II_RF_DP_LINUX,
			"",
			""
...
static RFAPI_VAR ii_vwcfg_max_parallelism = {
