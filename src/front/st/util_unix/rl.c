...
{"7","1",3489660928,(INT64_C(0)),            (INT64_C(35184372088832))}, /*7.1*/ 
{NULL, NULL,      0,                       0,                       0 } 
};
 ...
 if ( !found )
  {
   ...
   /* for OS 7.1, 6.1 or OS 5.3 with 64-bit kernel  */
 if( ( aix_uname.version[0] == '7' && aix_uname.release[0] == '1' ) ||
     ( aix_uname.version[0] == '6' && aix_uname.release[0] == '1' ) ||
...
# elif defined(sparc_sol)
	...
	if(su4_uname.release[2] != '1' )
	    STprintf( buf, "%lld", seminfo.semmns );
	else
	    status = FAIL;
