...
**	23-Apr-2010 (hweho01)
**	    For Ingres Vectorwise, set Full Installation to be a default 
**	    in PackageInstall display.
*/
...
/*
** For Ingres Vectorwise, set Full Installation to be a default
** in PackageInstall form. 04/23/2010 
*/
#if defined(conf_IVW)
		 	if( !(STcompare(pkg->name, "Full Installation")) &&
			     !custChoice )
			    tagp = yesWord;
			else
#endif
