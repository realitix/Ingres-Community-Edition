:
##
##  Copyright (c) 2004, 2011 Ingres Corperation. All rights reserved.
##
...
##	08-Apr-2011 (hanje04)
##	    Add support for DEB builds
##	17-May-2011 (hanje04)
##	    Mantis 1939
##	    Correct "accept prompt" to be consistent with ingbuild version.
##	22-Jun-2011 (hanje04)
##	    Mantis 2144
##	    Add loop to argument processing, debs support means there can be
##	    more than one.
##	04-Aug-2011 (hanje04)
##	    Remove reference to II_RPM_PREFIX, not used.
...
usage:
	${self} [-deb|-rpm] [-l gpl|com|beta|pre|eval]|[-help]

	    where:
		  -deb - Create license for use with DEB saveset
		  -rpm - Create license for use with RPM saveset (default)
...
[ "\$accepted" ] && {
    echo "The Ingres license agreement has already been accepted."
    exit 0
}
...
#!/bin/sh
#
#  Copyright (c) 2006, 2011 Actian Corporation. All rights reserved.
#
#  Name: $INGLIC_EXE -- setup script for Ingres Licensing.
#
#  Usage:
