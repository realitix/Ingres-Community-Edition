...
$!!     16-Mar-2011 (ashco01) Bug 125195
$!!             INGSTOP of a Net-Client installation reports 'image file not 
$!!             found' when trying to run rcpstat. Added check for DBMS 
$!!             installation before attempting to shutdown logging system.
$!=========================================================================
$!
...
$ done_rcp_shutdown=0
$!
$!!Check we are in a dbms installation before stopping the logging system.
$ CONFIG_HOST = f$getsyi( "NODENAME" )
$ iigetres ii.'CONFIG_HOST'.dbms.connect_max DBMS_CONFIG 
$ dbms_config = F$TRNLNM("DBMS_CONFIG")
$ if dbms_config .ne. "0" 
$ then
$             rcpstat -online -silent
$ else
$             gosub LOGGING_OFF_LINE
$             goto STOP_LOGGING_EXIT
$ endif
$!
$ on error then goto GENERIC_ERROR_HANDLER
$ say
