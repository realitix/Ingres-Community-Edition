$! -----------------------------------------------------------------------
$!
$!  Copyright (c) 1994, 2006 Actian Corporation
$!
...
$!!     03-Jun-2011 (horda03) Bug 125395
$!!         Ensure logicals exist before deassigning.
$!!     05-Oct-2011 (maspa05) Bug 122669
$!!         Remove references to II_GCN_LCL_VNODE - no longer used
$!!    
$!------------------------------------------------------------------------	
$!
...
databases in this installation.  You should contact Actian Corporation
Technical Support to resolve this problem.

$    else
$       say
An error occurred while upgrading your system catalogs.  You should
contact Actian Corporation Technical Support to resolve this problem.
...
You should contact Actian Corporation Technical Support to
...
$ endif
$
$ call Check_Job_Logical "ii_compatlib_def" "ii_compatlib"
$ call Check_Job_Logical "ii_libqlib_def"   "ii_libqlib"
$ call Check_Job_Logical "ii_framelib_def"  "ii_framelib"
$
$ cleanup "''script_id'"
$
...
$ if 'sym .eqs. ""
$ then
$    if f$trnlnm("''log_nm'","LNM$JOB") .nes.""
$    then
$       deassign/job 'log_nm
$    endif
$ else
$    val = 'sym
$    define/job/nolog 'log_nm "''val'"
$ endif
$
$ endsubroutine
