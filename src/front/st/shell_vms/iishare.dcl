...
$!!     23-Feb-2011 (ashco01) Bug 125085
$!!         Tidy up job-level logical names when executing in 'DELETE' mode.
$!!     24-Feb-2011 (ashco01) Bug125085
$!!         Correct exisiting mis-check of ii_framelib for value of 
$!!         ii_interplib logical name.
$!!     31-May-2011 (ashco01) Bug 125395
$!!         IISUDBMS fails during new installation due to missing
$!!         Logical Name. Logical Name creation/deletion re-organised. 
$!------------------------------------------------------------------------	
$!
...
$!
$! Define/Deassign temporary definitions for shared library logicals if necessary.
$!
$ if (operation .eqs. "ADD")
$ then
$!    We are installing images, go ahead and try to delete them
...
$!
$     if ( ii_compatlib_def .nes. "" ) then deassign/job ii_compatlib
$     if ( ii_libqlib_def .nes. "" ) then deassign/job ii_libqlib
$     if ( ii_framelib_def .nes. "" ) then deassign/job ii_framelib
$     if ( ii_interplib_def .nes. "" ) then deassign/job ii_interplib 
$     if ( ii_apilib_def .nes. "" ) then deassign/job ii_apilib
$     if ( ii_odbclib_def .nes. "" ) then deassign/job ii_odbclib
$     if ( ii_odbcrolib_def .nes. "" ) then deassign/job ii_odbcrolib
$     if ( ii_odbc_clilib_def .nes. "" ) then deassign/job ii_odbc_clilib
$     if ( ii_kerberoslib_def .nes. "" ) then deassign/job ii_kerberoslib
$ endif
