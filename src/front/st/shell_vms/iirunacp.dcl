...
$!!     28-Feb-2011 (ashco01) Bug: 125101.
$!!         Ensure that the DCL command verb 'run' has not been redirected
$!!         to an alternate command file or execuatble. 
$!------------------------------------------------------------------------
$!
$ on error then exit $status
$ on warning then exit $status
$!Delete global symbol 'run' if it exists
$ if f$type(run) .nes. ""
$ then
$    delete/symbol/global run
$ endif
$ run -
	/proc = dmfacp'p2' -
