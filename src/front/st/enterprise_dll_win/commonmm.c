...
**          as it is a bug.
**	29-Sep-2011 (drivi01)
**	    Remove INGRESSVCNAME definition.  We want to get away from hard-coded
**	    service names.
*/
...
**	    Created.
**	23-May-2011 (drivi01)
**	    The dialog keeps popping up behind
**	    other Windows.  This change will
...
{   
	...
	hWnd=FindWindow(NULL, lpCaption);
	return ((MessageBox(hWnd, lpText, lpCaption, MB_YESNO|MB_ICONQUESTION|MB_SETFOREGROUND|MB_TOPMOST)==IDYES));
}
/*
