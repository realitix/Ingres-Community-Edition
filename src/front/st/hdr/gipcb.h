...
**	22-Nov-2010 (hanje04)
**	   Improve handling of version based differences in GTL
**	   Add prototypes for IVW max parallelism config option
**	18-Mar-2011
**	    Mantis 1767
**	    Change on_ivw_cfg_prcmem_changed & on_ivw_cfg_buffpoolmem_changed
**	    to be attached to GtkEditable signal "changed" instead of the
**	    GtkSpinButton signal "value_changed".
*/
