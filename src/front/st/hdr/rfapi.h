/*
** Copyright Actian Corporation 2006. All rights reserved
*/
...
**	22-Nov-2010 (hanje04)
**	    Add IVW config parameter IIVWCFG_MAX_PARALLELISM
**	10-Feb-2010 (hanje04)
**	    Mantis 1303, 1348 & 1434
**	    Change RFAPI_DEFAULT_VWCFG_BLOCK_SIZE_MB_INT to
**	    RFAPI_DEFAULT_VWCFG_BLOCK_SIZE_KB_INT to match value used.
**	30-Sep-2011 (hanje04)
**	    Bug 125688
**	    Define II_MTS_JAVA_HOME to rfapi
** 
*/
...
# ifdef conf_IVW
# define RFAPI_DEFAULT_TXLOG_SIZE_MB "512"
# define RFAPI_DEFAULT_TXLOG_SIZE_MB_INT 512
# define RFAPI_LNX_DEFAULT_CHARSET "UTF8"
# else
...
# define RFAPI_DEFAULT_VWCFG_BLOCK_SIZE_KB_INT 512
