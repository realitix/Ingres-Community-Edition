...
**	10-Dec-2010 (drivi01)
**		Update the images and the title to be specific to Ingres,
**		Ingres VectorWise and DBA Tools, depending on which install
**		is being performed.
**		
*/
...
:CPropertySheet(pszCaption, pParentWnd, iSelectPage)
{
	...
	if (theInstall.m_IngresVW)
		m_psh.pszbmWatermark = MAKEINTRESOURCE(IDB_BLOCK_VW);
	else
