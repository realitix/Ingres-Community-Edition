...
**	10-Dec-2010 (drivi01)
**	    Update configuration dialog to use Ingres VectorWise
**	    text when performing configuration for Ingres VectorWise,
**	    Ingres text when performing Ingres configuration and
**	    make sure for DBA Tools, it still displays DBA Tools text.
**		
*/
...
CPostInst::OnInitDialog() 
{
	...
	else if (theInstall.m_IngresVW)
	{
		...
		theInstall.ConvertTextToIVW(this);
	}
