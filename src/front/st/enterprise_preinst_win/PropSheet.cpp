...
**  10-Dec-2010 (drivi01)
**		Add code to allow custom titles.  Load custom images for 
**		Ingres VectorWise install.
*/
	...
	:CPropertySheet(nIDCaption, pParentWnd, iSelectPage)
{
	...
	m_psh.dwFlags |= PSH_WIZARD97|PSH_USEHBMHEADER|PSH_WATERMARK|PSH_PROPTITLE ;
	...
	if (thePreInstall.m_IngresVW)
	{
		...
		m_psh.pszbmWatermark = MAKEINTRESOURCE(IDB_200_VW);
		thePreInstall.m_uHeaderID=IDB_BITMAPTOP_VW;
	}
