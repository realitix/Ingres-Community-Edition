$ goto beginning !		KITINSTAL.COM
	...
	21-Sep-2007 (upake01)
        ...
        05-mar-2010 (joea)
            ...
            defaults.
        21-Feb-2011 (ashco01) Bug 125070
            PURGE_FILES.COM reports failure to find some of the files listed 
            for purge.
...
$ TYPE SYS$INPUT
	...
	Actian Corporation strongly recommends reading all appropriate
...
complete. 
	...
	be made while the installation is up and running. Actian Corporation
...
$ purge_files_record:
$ pfile="II_SYSTEM:''F$ELEMENT(0," ",rec)'''F$ELEMENT(1," ",rec)'"
$ rec="$IF F$SEARCH( ""''pfile'"" ) .NES."""" THEN PURGE ''pfile'"
$ RETURN
...
$		TYPE SYS$INPUT
	...
	Actian Corporation STRONGLY RECOMMENDS reading the Ingres
