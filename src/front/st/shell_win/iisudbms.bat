...
REM     05-Oct-2011 (maspa05) bug 122669
REM         Remove reference to II_GCNxx_LCL_VNODE 
REM
...
call ipset SERVER_HOST iigetres ii."*".gcn.local_vnode
...
echo.
echo You should contact Actian Corporation Technical Support to resolve
echo this problem. 
