...
**      22-Aug-2011 (hanal04) Bug 121663 & 125648
**         Add environment variable II_BASE64_ENCODE to provide a simple
**         mechanism to turn 64bit encoding off.
*/
...
char	**argv;
{
    ...
    NMgtAt(ERx("II_BASE64_ENCODE"), &iicp);
    iicp = STalloc(iicp);
    if ( iicp != NULL && *iicp != EOS )
    {
        if(STcompare(iicp, "OFF") == 0)
        {
