...
**	12-feb-2010 (dougi)
**	    Added ivw_tabs, ivw_ixes.
**	21-apr-2010 (toumi01) SIR 122403
**	    Add encryption support and With_r1000_catalogs.
**	24-Feb-2011 (kschendel)
**	    Add with-spatial flag since we aren't creating the spatial
**	    catalogs for IVW (no point to it).
**      12-Apr-2011 (hanal04) SIR 125256
**          Add Xf_on_logfull to hold the -on_logfull value.
*/
...
GLOBALDEF bool With_spatial_catalogs = FALSE;
...
GLOBALDEF bool ivw_tabs = FALSE;
GLOBALDEF bool ivw_ixes = FALSE;
...
GLOBALDEF char  *Xf_on_logfull = NULL;
