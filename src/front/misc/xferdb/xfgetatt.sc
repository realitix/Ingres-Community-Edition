...
EXEC SQL END DECLARE SECTION;
    ...
    {
    if (With_r1000_catalogs && With_spatial_catalogs)
    {
    ...
    else if (With_r1000_catalogs)	/* ie no spatial */
    {
    EXEC SQL REPEATED SELECT c.table_owner,
            c.column_name, c.column_datatype,
            c.column_internal_datatype, c.column_internal_ingtype,
...
**	   cleared with REQMEM.
**	14-Dec-2010 (troal01)
**	    The XF_COLINFO->srid should default to
**	    SRID_UNDEFINED
*/
...
attnode()
{
	...
	*/
    ...
    tmp->col_next = NULL;
    /*
    ** SRID should default to -1
    */
    tmp->srid = SRID_UNDEFINED;
