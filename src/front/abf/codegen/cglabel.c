...
**	    i4's are to be formatted with %d, not %ld.  The world is LPI32
**	    and LP64 (or LLP64) these days.
*/
...
static const char	_Label[]	= ERx("%s%d: ");
static const char	_Goto[]		= ERx("goto %s%d");
