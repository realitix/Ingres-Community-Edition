...
**      16-Jun-2011 (smeke01) b125451
**          Improve the online help for DROP. Add CREATE/DROP SEQUENCE. 
**          Add DROP TABLE/VIEW/INDEX.
**/
...
static	QRSQKEYWD	qrsq_2ndkeys[] =
{
	...
	{ ERx("index"),			2018,	QRSECONDHALF,	QRDROP},
	{ ERx("table"),			2019,	QRSECONDHALF,	QRDROP},
	{ ERx("view"),			2020,	QRSECONDHALF,	QRDROP},
	...
	{ ERx("sequence"),		2280,	QRSECONDHALF,	QRCREATE},
	...
	{ ERx("sequence"),		2338,	QRSECONDHALF,	QRDROP},
