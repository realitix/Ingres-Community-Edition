...
**  12-Aug-2009 (zhayu01) SIR 121210
**      Redo some prototypes for VS 2005 and Windows Mobile 5 for Windows
**      CE and Smart Phones.
...
**          Change FE_UNRML_MAXNAME to be derived from DB_MAXINAME.
*/
...
# if defined(NT_GENERIC) && !defined(WCE_WM5)
...
#ifdef WCE_WM5
FUNC_EXTERN i4          IIUFccConfirmChoice();
#else
...
*/
#define		FE_UNRML_MAXNAME ((DB_MAXNAME * 2) + 2)
/*
