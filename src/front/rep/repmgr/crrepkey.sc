...
**	03-Jan-2011 (wanfr01)
**	    Bug 124890 - nvch_cnt/nch_cnt is supposed to contain the number of
**	    nvarchars/nchars for each row.  Since the value is incremented, it
**	    needs to reset prior to processing each row.
*/
STATUS
