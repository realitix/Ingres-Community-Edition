...
static BOOL BuildVariableDeclaration(HWND hwnd, LPPROCADD lpProcAdd)
{
  ...
  // variable name
  GetDlgItemText(hwnd, IDC_PROC_SUBADD_NAME , pCur, (int)(size - (pCur-pString)));
  pCur += x_strlen(pCur);
  ...
  switch (uDataType) {
    ...
    case INGTYPE_FLOAT:    
      ...
      GetDlgItemText(hwnd, IDC_PROC_SUBADD_WIDTH, pCur, (int)(size - (pCur-pString)));
      pCur += x_strlen(pCur);
