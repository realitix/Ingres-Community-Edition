...
//
INT_PTR CALLBACK EXPORT PasswordSaveEnvDlgProc(HWND hwnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
  switch(msg) {
...
//
#ifndef MAINWIN
UINT_PTR CALLBACK EXPORT SaveEnvHookProc(HWND hwnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
    switch(msg) {
