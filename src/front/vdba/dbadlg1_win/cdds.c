...
static void InitializeContainers(HWND hwnd)
{
    ...
    cntColData.fp = (WNDPROC) SetWindowLongPtr(GetWindow(hCntCol,GW_CHILD),GWLP_WNDPROC,(LONG) ColCntWndProc);
    ...
    cntPathData.fp = (FARPROC) SetWindowLongPtr(GetWindow(hCntPath,GW_CHILD),GWLP_WNDPROC,(LONG) PathCntWndProc);
