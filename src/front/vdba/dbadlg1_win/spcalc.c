...
INT_PTR CALLBACK __export DlgSpaceCalcDlgProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam);
...
static BOOL LGetEditCtrlMinMaxValue (HWND hwnd, HWND hwndCtl, DWORD_PTR FAR * lpdwMin, DWORD_PTR FAR * lpdwMax);
static void Adjust4FillFactors(HWND hwnd);
static void SetCalcError(HWND hwnd);

static void DoCalculation (HWND hwnd);
static DWORD_PTR CalculateHash(HWND hwnd, LPSTRUCTINFO lpinfo);
static DWORD_PTR CalculateIsam(HWND hwnd, LPSTRUCTINFO lpinfo);
static DWORD_PTR CalculateHeap(HWND hwnd, LPSTRUCTINFO lpinfo);
static DWORD_PTR CalculateBtree(HWND hwnd, LPSTRUCTINFO lpinfo);
...
**
*/
static DWORD_PTR CalculateRowsSpan (LPSTRUCTINFO lpinfo)
{
	LONG_PTR iPagesPerRow;
	long itemp1;
...
static DWORD_PTR CalculateHash(HWND hwnd, LPSTRUCTINFO lpinfo)
{
	DWORD_PTR dwRowsPerPage;
	DWORD_PTR dwTotalHashPages;
	DWORD_PTR dwPageFreeSpace;
	DWORD_PTR dwTupleOverhead;
...
{
	DWORD_PTR dwFree;
	DWORD_PTR dwDataPages;
	DWORD_PTR dwKeysPerPage;
	DWORD_PTR dwRowsPerPage;
	DWORD_PTR dwIndexPages;
	DWORD_PTR dwTotalIsamPages;
	DWORD_PTR dwPageFreeSpace;
	DWORD_PTR dwTupleOverhead;
...
static DWORD_PTR CalculateBtree(HWND hwnd, LPSTRUCTINFO lpinfo)
{
	DWORD_PTR dwRowsPerPage;
	DWORD_PTR dwFree;
	DWORD_PTR dwKeysPerLPage;
	DWORD_PTR dwKeysPerIPage;
	DWORD_PTR dwMaxKeys;
	DWORD_PTR dwLeafPages;
	DWORD_PTR dwDataPages;
	DWORD_PTR dwSprigPages;
	DWORD_PTR dwIndexPages;
	DWORD_PTR dwTotalBtreePages;
	DWORD_PTR dwTupleOverhead;
	DWORD_PTR dwPageFreeSpace;
	DWORD_PTR dwLeafFreeSpace;
	int nLeafPageRem;
...
static void GetDialogInfo (HWND hwnd, LPSTRUCTINFO lpinfo)
{
	...
	if (lpinfo->nIngresVersion >= OIVERS_26)   {
		...
		int ipos = 0;
		DWORD_PTR lpagesize = lpinfo->dwPageSize;
