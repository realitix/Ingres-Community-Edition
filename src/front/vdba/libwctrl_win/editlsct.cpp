/*
**  Copyright (C) 2005-2006 Actian Corporation.
*/
...
LRESULT CuEditableListCtrl::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrl::OnEditDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrl::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrl::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrl::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrl::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrl::OnComboDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrl::OnComboDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
...
void CuEditableListCtrl::CreateChildren()
{
	if (!IsWindow(this->m_hWnd))
		return;
	LONG_PTR style = GetWindowLongPtr (this->m_hWnd, GWL_STYLE);
...
LRESULT CuEditableListCtrl::OnEditIntegerDlgOK (WPARAM wParam, LPARAM lParam)
{
	CuLayoutSpinDlg* pEditIntegerDlgPtr = (CuLayoutSpinDlg*)m_EditIntegerDlgPtr;
...
LRESULT CuEditableListCtrl::OnEditIntegerDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrl::OnEditIntegerSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrl::OnEditIntegerSpinDlgCancel(WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
