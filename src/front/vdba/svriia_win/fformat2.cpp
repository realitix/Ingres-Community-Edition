...
LRESULT CuDlgPageFixedWidth::OnCleanData (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgPageFixedWidth::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgPageFixedWidth::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int nMode = (int)wParam;
