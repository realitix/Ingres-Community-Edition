...
LRESULT CuListCtrlDoubleUpper::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LPARAM CuListCtrlDoubleUpper::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LPARAM CuListCtrlDoubleUpper::OnComboDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
