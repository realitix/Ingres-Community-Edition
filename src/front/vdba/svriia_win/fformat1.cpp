...
LRESULT CuDlgPageDbf::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgPageDbf::OnCleanData (WPARAM wParam, LPARAM lParam)
{
	if (!m_pData)
		return 0;
	//
...
LRESULT CuDlgPageDbf::OnGetData (WPARAM wParam, LPARAM lParam)
{
	int nMode = (int)wParam;
	switch (nMode)
	{
