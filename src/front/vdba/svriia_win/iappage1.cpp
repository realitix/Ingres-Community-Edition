...
** 29-Aug-2011 (drivi01) b125697
**    Default Format Identification to 100 kb, remove
**    "Optional" from the name of the field.
**/
...
BOOL CuPPage1::OnInitDialog() 
{
	...
	try
	{
		...
		//
		// Format Identification On
		m_cEditKB2Scan.SetWindowTextA("100");
...
void CuPPage1::Loading(LPCTSTR lpszFile)
{
	...
	CTreeCtrl& cTree = m_cTreeIgresTable;
	HTREEITEM hItem = cTree.GetRootItem();
	int nSize = (int)itemPath.GetSize();
	int nLevel = nSize-1;
