...
LRESULT CuDlgIpmDetailSession::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailSession::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailSession::OnGetData (WPARAM wParam, LPARAM lParam)
{
