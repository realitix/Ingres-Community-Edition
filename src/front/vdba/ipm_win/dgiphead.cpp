...
LRESULT CuDlgIpmPageHeader::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageHeader::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageHeader::OnGetData (WPARAM wParam, LPARAM lParam)
{
