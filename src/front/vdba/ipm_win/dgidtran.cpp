...
LRESULT CuDlgIpmIceDetailTransaction::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int res = RES_ERR;
...
LRESULT CuDlgIpmIceDetailTransaction::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIceDetailTransaction::OnGetData (WPARAM wParam, LPARAM lParam)
{
