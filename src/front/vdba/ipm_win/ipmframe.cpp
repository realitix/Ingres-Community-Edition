...
LRESULT CfIpmFrame::OnDbeventIncoming (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CfIpmFrame::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
	CuDlgIpmTabCtrl* pTab = GetTabDialog ();
	if (pTab)
...
LRESULT CfIpmFrame::OnExpressRefresh(WPARAM wParam, LPARAM lParam)
{
