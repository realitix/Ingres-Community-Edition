...
LRESULT CuDlgIpmPageTransactions::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageTransactions::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageTransactions::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageTransactions::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
