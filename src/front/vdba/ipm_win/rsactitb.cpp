...
LRESULT CuDlgReplicationStaticPageActivityPerTable::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuDlgReplicationStaticPageActivityPerTable::OnLoad (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuDlgReplicationStaticPageActivityPerTable::OnGetData (WPARAM wParam, LPARAM lParam)
{
	return (LRESULT)NULL;
}
