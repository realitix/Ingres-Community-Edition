...
LRESULT CuDlgIpmPageStaticActiveusers::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageStaticActiveusers::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticActiveusers::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticActiveusers::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
