...
LRESULT CuDlgReplicationStaticPageServer::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageServer::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageServer::OnGetData (WPARAM wParam, LPARAM lParam)
{
	LV_COLUMN lvcolumn;
...
LRESULT CuDlgReplicationStaticPageServer::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
