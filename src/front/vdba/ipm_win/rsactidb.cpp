...
LRESULT CuDlgReplicationStaticPageActivityPerDatabase::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuDlgReplicationStaticPageActivityPerDatabase::OnLoad (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuDlgReplicationStaticPageActivityPerDatabase::OnGetData (WPARAM wParam, LPARAM lParam)
{
	return (LRESULT)NULL;
}
