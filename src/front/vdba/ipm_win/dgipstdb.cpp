...
LRESULT CuDlgIpmPageStaticDatabases::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageStaticDatabases::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticDatabases::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticDatabases::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
