...
LRESULT CuDlgIpmDetailLock::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailLock::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailLock::OnGetData (WPARAM wParam, LPARAM lParam)
{
