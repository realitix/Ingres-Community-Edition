...
LRESULT CuDlgReplicationServerPageRaiseEvent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageRaiseEvent::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageRaiseEvent::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageRaiseEvent::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
