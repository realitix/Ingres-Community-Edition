...
LRESULT CuDlgIpmTabCtrl::OnHideProperty (WPARAM wParam, LPARAM lParam)
{
	if (m_pCurrentPage)
	{
...
LRESULT CuDlgIpmTabCtrl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgIpmTabCtrl::OnSettingChange(WPARAM wParam, LPARAM lParam)
{
