...
LRESULT CuDlgReplicationStaticPageActivity::OnDbeventIncoming (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageActivity::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageActivity::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageActivity::OnGetData (WPARAM wParam, LPARAM lParam)
{
	int i, nCount;
	LV_COLUMN lvcolumn;
...
LRESULT CuDlgReplicationStaticPageActivity::OnLeavingPage(WPARAM wParam, LPARAM lParam)
{
	return 0L;
}


LRESULT CuDlgReplicationStaticPageActivity::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
