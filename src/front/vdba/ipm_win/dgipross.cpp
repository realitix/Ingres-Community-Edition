...
LRESULT CuDlgIpmDetailProcess::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailProcess::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailProcess::OnGetData (WPARAM wParam, LPARAM lParam)
{
