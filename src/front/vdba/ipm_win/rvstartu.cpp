...
LRESULT CuDlgReplicationServerPageStartupSetting::OnHideProperty (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStartupSetting::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStartupSetting::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStartupSetting::OnGetData (WPARAM wParam, LPARAM lParam)
{
	LV_COLUMN lvcolumn;
...
LRESULT CuDlgReplicationServerPageStartupSetting::OnDataChanged  (WPARAM wParam, LPARAM lParam)
{
	GetDlgItem(IDC_BUTTON1)->EnableWindow (TRUE);
	return 0L;
}

LRESULT CuDlgReplicationServerPageStartupSetting::OnLeavingPage(WPARAM wParam, LPARAM lParam)
{
	int answ;
...
LRESULT CuDlgReplicationServerPageStartupSetting::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
