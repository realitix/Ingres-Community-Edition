...
LRESULT CuDlgIpmPageLockResources::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageLockResources::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockResources::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockResources::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
