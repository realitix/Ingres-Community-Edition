...
LRESULT CuDlgIpmIcePageActiveUser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageActiveUser::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageActiveUser::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageActiveUser::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
