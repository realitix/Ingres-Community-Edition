...
LRESULT CuDlgIpmIcePageConnectedUser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageConnectedUser::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageConnectedUser::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageConnectedUser::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
