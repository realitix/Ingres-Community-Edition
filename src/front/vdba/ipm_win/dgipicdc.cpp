...
LRESULT CuDlgIpmIcePageDatabaseConnection::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageDatabaseConnection::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageDatabaseConnection::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageDatabaseConnection::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
