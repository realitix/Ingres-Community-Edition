...
LRESULT CuEditableListCtrlStartupSetting::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlStartupSetting::OnEditDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrlStartupSetting::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlStartupSetting::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
...
LRESULT CuEditableListCtrlStartupSetting::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
	int iMin, iMax;
...
LRESULT CuEditableListCtrlStartupSetting::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
