...
LRESULT CuDlgIpmDetailTransaction::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailTransaction::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailTransaction::OnGetData (WPARAM wParam, LPARAM lParam)
{
