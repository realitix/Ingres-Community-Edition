...
LRESULT CuDlgIpmIceDetailCachePage::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int res = RES_ERR;
...
LRESULT CuDlgIpmIceDetailCachePage::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIceDetailCachePage::OnGetData (WPARAM wParam, LPARAM lParam)
{
