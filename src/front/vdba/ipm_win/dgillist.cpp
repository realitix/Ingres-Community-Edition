...
LRESULT CuDlgIpmDetailLockList::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailLockList::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailLockList::OnGetData (WPARAM wParam, LPARAM lParam)
{
