...
LRESULT CuDlgIpmIceDetailHttpServerConnection::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int res = RES_ERR;
...
LRESULT CuDlgIpmIceDetailHttpServerConnection::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIceDetailHttpServerConnection::OnGetData (WPARAM wParam, LPARAM lParam)
{
