...
LRESULT CuDlgIpmPageLockLists::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageLockLists::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockLists::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockLists::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
