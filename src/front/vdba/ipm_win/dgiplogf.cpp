...
LRESULT CuDlgIpmPageLogFile::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageLogFile::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLogFile::OnGetData (WPARAM wParam, LPARAM lParam)
{
