...
LRESULT CuDlgIpmIcePageCachePage::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageCachePage::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageCachePage::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageCachePage::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
