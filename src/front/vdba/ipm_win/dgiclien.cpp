...
LRESULT CuDlgIpmPageClient::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageClient::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageClient::OnGetData (WPARAM wParam, LPARAM lParam)
{
