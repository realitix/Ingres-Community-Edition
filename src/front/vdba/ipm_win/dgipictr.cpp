...
LRESULT CuDlgIpmIcePageTransaction::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageTransaction::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageTransaction::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageTransaction::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
