...
LRESULT CuDlgReplicationServerPageAssignment::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageAssignment::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageAssignment::OnGetData (WPARAM wParam, LPARAM lParam)
{
	LV_COLUMN lvcolumn;
...
LRESULT CuDlgReplicationServerPageAssignment::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
