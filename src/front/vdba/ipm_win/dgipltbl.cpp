...
LRESULT CuDlgIpmPageLockTables::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageLockTables::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockTables::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageLockTables::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
