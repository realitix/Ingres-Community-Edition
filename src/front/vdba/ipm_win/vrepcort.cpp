...
LRESULT CvReplicationPageCollisionViewRight::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvReplicationPageCollisionViewRight::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
	if (m_pDlg && IsWindow (m_pDlg->m_hWnd))
