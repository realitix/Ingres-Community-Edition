...
LRESULT CuDlgIpmPageActiveDatabases::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageActiveDatabases::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageActiveDatabases::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageActiveDatabases::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
