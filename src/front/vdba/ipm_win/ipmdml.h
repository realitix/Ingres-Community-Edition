...
BOOL IPM_QueryIntegrityOutput (CdIpmDoc* pIpmDoc, CaReplicIntegrityRegTable *pItem, DWORD_PTR iDb1, DWORD_PTR iDb2,DWORD_PTR iCddsNo, TCHAR *tcTimeBegin, TCHAR *tcTimeEnd, TCHAR *tcColOrder, CString& strOutput);
