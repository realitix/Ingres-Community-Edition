...
LRESULT CuDlgIpmPageStaticServers::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageStaticServers::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticServers::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticServers::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
