...
LRESULT CuDlgIpmIcePageCursor::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmIcePageCursor::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageCursor::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIcePageCursor::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
