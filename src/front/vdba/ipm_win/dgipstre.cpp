...
LRESULT CuDlgIpmPageStaticReplications::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmPageStaticReplications::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticReplications::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmPageStaticReplications::OnPropertiesChange(WPARAM wParam, LPARAM lParam)
{
