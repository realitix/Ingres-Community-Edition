...
LRESULT CuDlgReplicationServerPageStatus::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStatus::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStatus::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationServerPageStatus::OnLeavingPage(WPARAM wParam, LPARAM lParam)
{
	/* if necessary: */
