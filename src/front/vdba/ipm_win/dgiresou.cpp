...
LRESULT CuDlgIpmDetailResource::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	BOOL bOK = FALSE;
...
LRESULT CuDlgIpmDetailResource::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmDetailResource::OnGetData (WPARAM wParam, LPARAM lParam)
{
