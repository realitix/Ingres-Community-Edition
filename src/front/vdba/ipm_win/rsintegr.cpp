...
LRESULT CuDlgReplicationStaticPageIntegrity::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageIntegrity::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgReplicationStaticPageIntegrity::OnGetData (WPARAM wParam, LPARAM lParam)
{
	CString strItem;
	...
	try
	{
		...
		for (i=0; i<nCount; i++)
		{
			...
			CaReplicCommon *pItemCommon = (CaReplicCommon *) new CaReplicCommon (strItem,(int)value);
		...
		for (i=0; i<nCount; i++)
		{
			...
			DWORD_PTR Value = m_cComboDatabase1.GetItemData (i);
			CaReplicCommon *pItemCommon = (CaReplicCommon *) new CaReplicCommon ( strItem, (int)Value );
		...
		for (i=0; i<nCount; i++)
		{
			...
			DWORD_PTR Value = m_cComboDatabase2.GetItemData (i);
			CaReplicCommon *pItemCommon = (CaReplicCommon *) new CaReplicCommon ( strItem, (int)Value );
