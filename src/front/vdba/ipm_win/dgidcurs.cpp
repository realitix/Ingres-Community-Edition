...
LRESULT CuDlgIpmIceDetailCursor::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int res = RES_ERR;
...
LRESULT CuDlgIpmIceDetailCursor::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmIceDetailCursor::OnGetData (WPARAM wParam, LPARAM lParam)
{
