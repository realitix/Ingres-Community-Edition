...
public:
	...
	UINT_PTR   GetBarUnitCount ()    {return m_listUnit.GetCount();};
	UINT_PTR   GetBarCount (){return m_listBar.GetCount();};
	void   Cleanup();
...
public:
	...
	virtual void Serialize (CArchive& ar);
	UINT_PTR    GetPieCount () {return m_listPie.GetCount();};
	void    Cleanup();
...
public:
	...
	int AddItem2(LPCTSTR lpszItem, DWORD_PTR dwItemData);
	// Overrides
