...
protected:
	...
	//}}AFX_MSG
	afx_msg LRESULT OnDisplayRow  (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnEndFetchRows(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnFetchNewRows(WPARAM wParam, LPARAM lParam);
