...
protected:
	...
	BOOL AnalyseNonKey    (CStringArray& arryToken, INT_PTR& nCurrentIndex);
	BOOL AnalyseKey       (CStringArray& arryToken, INT_PTR& nCurrentIndex, CaKeyValueArg* pKey);
	BOOL AnalyseKeyValue  (CStringArray& arryToken, INT_PTR& nCurrentIndex, CaKeyValueArg* pKey);
	BOOL AnalyseKeyEqValue(CStringArray& arryToken, INT_PTR& nCurrentIndex, CaKeyValueArg* pKey);
