...
** 23-Feb-2011 (drivi01)
**    Functions that were missed in previous change, should
**    return LRESULT.
**/
...
public:
	...
	virtual LRESULT ManageEditDlgOK (WPARAM wParam, LPARAM lParam)           { ASSERT (FALSE); return 0L; }
	virtual LRESULT ManageEditNumberDlgOK (WPARAM wParam, LPARAM lParam)     { ASSERT (FALSE); return 0L; }
	virtual LRESULT ManageEditSpinDlgOK (WPARAM wParam, LPARAM lParam)       { ASSERT (FALSE); return 0L; }
	virtual LRESULT ManageComboDlgOK (WPARAM wParam, LPARAM lParam)          { ASSERT (FALSE); return 0L; }
	virtual LRESULT ManageEditIntegerDlgOK (WPARAM wParam, LPARAM lParam)    { ASSERT (FALSE); return 0L; }
	virtual LRESULT ManageEditIntegerSpinDlgOK (WPARAM wParam, LPARAM lParam){ ASSERT (FALSE); return 0L; }
...
protected:
	...
	afx_msg LRESULT OnComboDlgCancel          (WPARAM wParam, LPARAM lParam);
	//
	// Negative integer management
	afx_msg LRESULT OnEditIntegerDlgOK        (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnEditIntegerDlgCancel    (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnEditIntegerSpinDlgOK    (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnEditIntegerSpinDlgCancel(WPARAM wParam, LPARAM lParam);
