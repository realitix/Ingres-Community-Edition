...
** 11-Jan-2011 (drivi01)
**    Add VectorWise structure type defines.
** 27-Oct-2011 (drivi01)
**    Add consttchszVWProd for VectorWise product.
**/
...
#define INGTYPE_DEFAULT	     39	    //default vectorwise table structure (config.dat)
#define INGTYPE_VW           40     //vectorwise table structure
#define INGTYPE_VWROW	     41     //vectorwise_row table structure
...
#define consttchszVWProd	TEXT("Vectorwise")
#endif
