...
void CuDlgDomPropUserXGrantedRole::AddUserXGrantedRole (CuGrantedRole* pGrantedRole)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pGrantedRole);
}
...
LRESULT CuDlgDomPropUserXGrantedRole::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXGrantedRole::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedRole::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedRole::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXGrantedRole::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXGrantedRole.GetCount();
  ASSERT (size > 0);
