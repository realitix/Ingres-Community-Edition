...
void CuDlgDomPropStaticProfile::AddProfile (CuNameOnly *pProfile)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pProfile);
}
...
LRESULT CuDlgDomPropStaticProfile::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropStaticProfile::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticProfile::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticProfile::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropStaticProfile::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaStaticProfile.GetCount();
  ASSERT (size > 0);
