...
void CuDlgDomPropDbProc::AddProc (CuNameWithOwner *pDbProc)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbProc);
}
...
LRESULT CuDlgDomPropDbProc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbProc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbProc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbProc::OnGetData (WPARAM wParam, LPARAM lParam)
{
