...
LRESULT CuDlgDomPropIceLocation::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropIceLocation::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceLocation::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceLocation::OnGetData (WPARAM wParam, LPARAM lParam)
{
