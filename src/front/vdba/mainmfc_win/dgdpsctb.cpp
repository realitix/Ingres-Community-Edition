...
void CuDlgDomPropSchemaTbl::AddTbl (CuNameWithOwner *pSchemaTbl)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pSchemaTbl);
}
...
LRESULT CuDlgDomPropSchemaTbl::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropSchemaTbl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSchemaTbl::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSchemaTbl::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropSchemaTbl::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaSchemaTbl.GetCount();
