...
LRESULT CuDlgDomPropIndexLinkSource::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropIndexLinkSource::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIndexLinkSource::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIndexLinkSource::OnGetData (WPARAM wParam, LPARAM lParam)
{
