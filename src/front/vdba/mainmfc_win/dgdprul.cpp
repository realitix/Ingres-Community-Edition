...
LRESULT CuDlgDomPropRule::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropRule::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRule::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRule::OnGetData (WPARAM wParam, LPARAM lParam)
{
