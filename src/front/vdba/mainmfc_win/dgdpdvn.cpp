...
LRESULT CuDlgDomPropViewNative::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_BOTH;
...
LRESULT CuDlgDomPropViewNative::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewNative::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewNative::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropViewNative::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsViewComponents.GetSize();
  ASSERT (size > 0);
