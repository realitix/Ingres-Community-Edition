...
void CuDlgDomPropDDbTbl::AddTbl (CuNameWithOwner *pDbTbl)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbTbl);
}
...
LRESULT CuDlgDomPropDDbTbl::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDDbTbl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDDbTbl::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDDbTbl::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDDbTbl::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbTbl.GetCount();
