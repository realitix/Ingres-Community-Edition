...
LRESULT CuDlgDomPropRoleXGrantedEvent::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropRoleXGrantedEvent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedEvent::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedEvent::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedEvent::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaRoleXGrantedEvent.GetCount();
  ASSERT (size > 0);
