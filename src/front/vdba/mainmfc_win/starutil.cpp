...
static INT_PTR DlgRegisterGenericAsLink(HWND hwndParent, LPCSTR destNodeName, LPCSTR destDbName, BOOL bDragDrop, LPCSTR srcNodeName, LPCSTR srcDbName, LPCSTR srcObjName, LPCSTR srcOwnerName, int linkType)
{
