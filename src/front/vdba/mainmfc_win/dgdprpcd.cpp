...
LRESULT CuDlgDomPropReplicCdds::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropReplicCdds::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicCdds::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicCdds::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropReplicCdds::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsReplicCdds.GetSize();
