...
LRESULT CuDlgDomPropViewNativeSource::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropViewNativeSource::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewNativeSource::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewNativeSource::OnGetData (WPARAM wParam, LPARAM lParam)
{
