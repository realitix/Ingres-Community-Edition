...
LRESULT CuDlgDomPropSeq::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropSeq::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSeq::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSeq::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
