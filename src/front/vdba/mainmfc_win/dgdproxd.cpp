...
LRESULT CuDlgDomPropRoleXGrantedDb::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropRoleXGrantedDb::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedDb::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedDb::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedDb::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaRoleXGrantedDb.GetCount();
  ASSERT (size > 0);
