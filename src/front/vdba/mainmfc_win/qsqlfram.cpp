...
LRESULT CfSqlQueryFrame::OnGetMfcDocType(WPARAM uu, LPARAM ll)
{
...
LRESULT CfSqlQueryFrame::OnGetNodeHandle(WPARAM uu, LPARAM ll)
{
	if (!m_pSqlDoc)
...
LRESULT CfSqlQueryFrame::OnHasToolbar(WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}

LRESULT CfSqlQueryFrame::OnIsToolbarVisible(WPARAM wParam, LPARAM lParam)
{
	return (LONG)m_wndToolBar.IsWindowVisible();
}

LRESULT CfSqlQueryFrame::OnSetToolbarState(WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CfSqlQueryFrame::OnSetToolbarCaption(WPARAM wParam, LPARAM lParam)
{
