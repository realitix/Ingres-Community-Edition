...
**   can then avoid confusion with views granted to non-existing 
...
void CuDlgDomPropUserXGrantedView::AddUserXGrantedView (CuGrantedView* pGrantedView)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pGrantedView);
}
...
LRESULT CuDlgDomPropUserXGrantedView::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXGrantedView::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedView::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedView::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXGrantedView::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXGrantedView.GetCount();
  ASSERT (size > 0);
