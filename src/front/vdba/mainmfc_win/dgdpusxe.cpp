...
**   Pass on OT_USER to DOMGetFirstObject via bufComplim. The function
**   can then avoid confusion with dbevents granted to non-existing 
**   roles or groups of the same name as the user in question.
*/
...
void CuDlgDomPropUserXGrantedEvent::AddUserXGrantedEvent (CuGrantedEvent* pGrantedEvent)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pGrantedEvent);
}
...
LRESULT CuDlgDomPropUserXGrantedEvent::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXGrantedEvent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedEvent::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedEvent::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXGrantedEvent::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXGrantedEvent.GetCount();
  ASSERT (size > 0);
