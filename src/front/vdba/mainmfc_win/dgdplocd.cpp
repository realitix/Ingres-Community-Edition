...
LRESULT CuDlgDomPropLocationDbs::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropLocationDbs::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocationDbs::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocationDbs::OnGetData (WPARAM wParam, LPARAM lParam)
{
