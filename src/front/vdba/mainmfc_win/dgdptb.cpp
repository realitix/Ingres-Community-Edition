...
** 07-Jan-2011 (drivi01)
**    Add a new table structure VECTORWISE_ROW.
*/
...
void CuDlgDomPropTable::AddTblConstraint(CuTblConstraint* pTblConstraint)
{
  ...
  m_cListConstraints.SetItemData(index, (DWORD_PTR)pTblConstraint);
}
...
LRESULT CuDlgDomPropTable::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropTable::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTable::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTable::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTable::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaConstraints.GetCount();
  ASSERT (size > 0);
