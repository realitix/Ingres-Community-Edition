...
void CuDlgDomPropTblRule::AddTblRule (CuNameWithOwner *pTblRule)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTblRule);
}
...
LRESULT CuDlgDomPropTblRule::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTblRule::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblRule::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblRule::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTblRule::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTblRule.GetCount();
