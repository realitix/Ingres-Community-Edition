...
void CuDlgDomPropDbGrantees::AddDbGrantee (CuDbGrantee* pDbGrantee)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbGrantee);
}
...
LRESULT CuDlgDomPropDbGrantees::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbGrantees::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbGrantees::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbGrantees::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDbGrantees::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbGrantees.GetCount();
  ASSERT (size > 0);
