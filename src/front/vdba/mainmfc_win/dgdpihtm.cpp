...
LRESULT CuDlgDomPropIceHtml::OnQueryType(WPARAM wParam, LPARAM lParam)
{
	ASSERT (wParam == 0);
	ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropIceHtml::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
#if !defined (DOMPROP_HTML_SIMULATE)
...
LRESULT CuDlgDomPropIceHtml::OnLoad (WPARAM wParam, LPARAM lParam)
{
#if !defined (DOMPROP_HTML_SIMULATE)
...
LRESULT CuDlgDomPropIceHtml::OnGetData (WPARAM wParam, LPARAM lParam)
{
#if !defined (DOMPROP_HTML_SIMULATE)
