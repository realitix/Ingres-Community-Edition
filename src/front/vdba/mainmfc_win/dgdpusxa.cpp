...
void CuDlgDomPropUserXAlarms::AddUserXAlarm (CuUserXAlarm* pUserXAlarm)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pUserXAlarm);
}
...
LRESULT CuDlgDomPropUserXAlarms::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXAlarms::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXAlarms::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXAlarms::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXAlarms::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXAlarm.GetCount();
  ASSERT (size > 0);
