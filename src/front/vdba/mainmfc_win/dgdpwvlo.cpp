...
//                                                                                     //
//  dgdpwvlo.cpp : implementation file                                                  //
//                                                                                     // 
//  History:                                                                           //										 
//                                                                                     //
//    13-Dec-2010 (drivi01)                                                            //
...
void CuDlgDomPropIceServerLocations::AddRole (CuNameOnly *pIceServerLocations)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceServerLocations);
}
...
LRESULT CuDlgDomPropIceServerLocations::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceServerLocations::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceServerLocations::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceServerLocations::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceServerLocations::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceServerLocations.GetCount();
