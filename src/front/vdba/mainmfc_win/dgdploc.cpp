...
LRESULT CuDlgDomPropLocation::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropLocation::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocation::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocation::OnGetData (WPARAM wParam, LPARAM lParam)
{
