...
LRESULT CuDlgDomPropStarDbComponent::OnChangeFont (WPARAM wParam, LPARAM lParam)
{
	if (lParam)
...
LRESULT CuDlgDomPropStarDbComponent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int iret = RES_ERR;
...
LRESULT CuDlgDomPropStarDbComponent::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStarDbComponent::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
HTREEITEM CuDlgDomPropStarDbComponent::FindItem (CStringList* pStrList)
{
	...
	POSITION pos = NULL;
	HTREEITEM hRoot = m_cTree1.GetRootItem();
	int nCount = (int)pStrList->GetCount();
	//
	// Virtual Node Level:
	while (hRoot)
	{
