...
LRESULT CuDlgDomPropTableRows::OnUpdateQuery (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableRows::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableRows::OnLoad(WPARAM wParam, LPARAM lParam) 
{
...
LRESULT CuDlgDomPropTableRows::OnQueryType(WPARAM wParam, LPARAM lParam)
{
	ASSERT (wParam == 0);
	ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropTableRows::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	USES_CONVERSION;
	int iret = RES_ERR;
...
LRESULT CuDlgDomPropTableRows::OnChangeProperty (WPARAM wParam, LPARAM lParam)
{
	if ((int)lParam == 0)
	{
		m_bExecuted = FALSE;
...
LRESULT CuDlgDomPropTableRows::OnQueryOpenCursor(WPARAM wParam, LPARAM lParam)
{
	/*UKS
...
LRESULT CuDlgDomPropTableRows::OnSettingChange(WPARAM wParam, LPARAM lParam)
{
#if defined (USES_DOM_FONT)
	USES_CONVERSION;
...
LRESULT CuDlgDomPropTableRows::OnCloseCursor (WPARAM wParam, LPARAM lParam)
{
	ASSERT(FALSE);
	return 0;
}
