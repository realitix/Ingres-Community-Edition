...
LRESULT CuDlgDomPropLocationSpace::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropLocationSpace::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocationSpace::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocationSpace::OnGetData (WPARAM wParam, LPARAM lParam)
{
