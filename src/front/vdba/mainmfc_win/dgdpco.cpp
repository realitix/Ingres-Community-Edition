...
LRESULT CuDlgDomPropConnection::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropConnection::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropConnection::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropConnection::OnGetData (WPARAM wParam, LPARAM lParam)
{
