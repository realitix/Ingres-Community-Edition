...
void CuDlgDomPropIceSecProfiles::AddProfile (CuNameOnly *pIceSecProfiles)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceSecProfiles);
}
...
LRESULT CuDlgDomPropIceSecProfiles::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceSecProfiles::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecProfiles::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecProfiles::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceSecProfiles::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceSecProfiles.GetCount();
