...
LRESULT CuDlgDomPropGroupXGrantedSeq::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropGroupXGrantedSeq::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedSeq::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedSeq::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroupXGrantedSeq::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaGroupXGrantedSeq.GetCount();
  ASSERT (size > 0);
