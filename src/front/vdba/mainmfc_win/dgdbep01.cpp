...
void CuDlgDBEventPane01::OnRefresh()
{
    ...
    for (i = 0; i < nCount; i++)
    {
        ...
        if (index != LB_ERR)
        {
            ...
            m_cListDBEvent.SetItemData (i, (DWORD_PTR)lpszOwner);
...
void CuDlgDBEventPane01::InitializeDBEvent (CString& str, CCheckListBox* pList)
{
    ...
    while (ires == RES_SUCCESS)
    {
        ...
        if (cur != LB_ERR)
        {
            ...
            if (pList)
                pList->SetItemData (cur, (DWORD_PTR)lpszOwner);
            else
                m_cListDBEvent.SetItemData (cur, (DWORD_PTR)lpszOwner);
        }
    ...
    if (pDoc->m_bDBInit)
    {
        ...
        while  (pos != NULL)
        {
            ...
            if (index != LB_ERR)
            {
                ...
                m_cListDBEvent.SetItemData (index, (DWORD_PTR)lpszOwner);
