...
LRESULT CuDlgDomPropDbSeq::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbSeq::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSeq::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSeq::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDbSeq::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbSeq.GetCount();
