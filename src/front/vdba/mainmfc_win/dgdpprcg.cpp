...
void CuDlgDomPropProcGrantees::AddProcGrantee (CuProcGrantee* pProcGrantee)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pProcGrantee);
}
...
LRESULT CuDlgDomPropProcGrantees::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropProcGrantees::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcGrantees::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcGrantees::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropProcGrantees::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaProcGrantees.GetCount();
  ASSERT (size > 0);
