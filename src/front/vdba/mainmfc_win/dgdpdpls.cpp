...
LRESULT CuDlgDomPropProcLinkSource::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropProcLinkSource::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcLinkSource::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcLinkSource::OnGetData (WPARAM wParam, LPARAM lParam)
{
