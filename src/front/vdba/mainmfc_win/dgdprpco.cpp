...
void CuDlgDomPropReplicConn::AddConn (CuNameWithNumber *pReplicConn)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pReplicConn);
}
...
LRESULT CuDlgDomPropReplicConn::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropReplicConn::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicConn::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicConn::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropReplicConn::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaReplicConn.GetCount();
