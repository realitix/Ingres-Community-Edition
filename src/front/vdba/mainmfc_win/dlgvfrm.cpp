...
LRESULT CuDlgViewFrame::OnQueryType (WPARAM wParam, LPARAM lParam)
{
  CView* pView = GetActiveView();
  if (pView)
...
LRESULT CuDlgViewFrame::OnLeavingPage(WPARAM wParam, LPARAM lParam)
{
    CView* pView = GetActiveView();
    if (pView)
...
LRESULT CuDlgViewFrame::OnGetData (WPARAM wParam, LPARAM lParam)
{
    CView* pView = GetActiveView();
    if (pView)
...
LRESULT CuDlgViewFrame::OnLoad (WPARAM wParam, LPARAM lParam)
{
    CView* pView = GetActiveView();
    if (pView)
