...
LRESULT CuDlgDomPropUser::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropUser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUser::OnLoad (WPARAM wParam, LPARAM lParam)
{
  SubclassControls();
...
LRESULT CuDlgDomPropUser::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUser::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsGroupsContainingUser.GetSize();
