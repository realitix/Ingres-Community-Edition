...
void CuDlgDomPropIceSecDbconns::AddDbconn (CuNameOnly *pIceSecDbconns)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceSecDbconns);
}
...
LRESULT CuDlgDomPropIceSecDbconns::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceSecDbconns::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecDbconns::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecDbconns::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceSecDbconns::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceSecDbconns.GetCount();
