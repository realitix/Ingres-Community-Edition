...
LRESULT CuDlgDomPropGroupXGrantedView::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropGroupXGrantedView::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedView::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedView::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroupXGrantedView::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaGroupXGrantedView.GetCount();
  ASSERT (size > 0);
