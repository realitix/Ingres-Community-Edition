...
void CuDlgDomPropIceBunitUsers::AddBunitUser (CuIceBunitUserGrant *pIceBunitUser)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceBunitUser);
}
...
LRESULT CuDlgDomPropIceBunitUsers::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceBunitUsers::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunitUsers::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunitUsers::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceBunitUsers::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceBunitUsers.GetCount();
