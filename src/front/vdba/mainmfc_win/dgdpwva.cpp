...
//                                                                                     //
//  dgdpwva.cpp : implementation file                                                  //
//                                                                                     // 
//  History:                                                                           //										 
//                                                                                     //
//    13-Dec-2010 (drivi01)                                                            //
...
LRESULT CuDlgDomPropIceVariable::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropIceVariable::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceVariable::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceVariable::OnGetData (WPARAM wParam, LPARAM lParam)
{
