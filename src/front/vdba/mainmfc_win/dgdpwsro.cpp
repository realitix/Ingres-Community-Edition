...
void CuDlgDomPropIceSecRoles::AddRole (CuNameOnly *pIceSecRoles)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceSecRoles);
}
...
LRESULT CuDlgDomPropIceSecRoles::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceSecRoles::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecRoles::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceSecRoles::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceSecRoles::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceSecRoles.GetCount();
