...
LRESULT CuDlgDomPropInstallationLevelEnabledLevel::OnQueryType(WPARAM wParam, LPARAM lParam)
{
	ASSERT (wParam == 0);
	ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropInstallationLevelEnabledLevel::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropInstallationLevelEnabledLevel::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropInstallationLevelEnabledLevel::OnGetData (WPARAM wParam, LPARAM lParam)
{
