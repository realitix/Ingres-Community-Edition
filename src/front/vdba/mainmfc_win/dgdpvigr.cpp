...
void CuDlgDomPropViewGrantees::AddViewGrantee (CuViewGrantee* pViewGrantee)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pViewGrantee);
}
...
LRESULT CuDlgDomPropViewGrantees::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropViewGrantees::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewGrantees::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewGrantees::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropViewGrantees::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaViewGrantees.GetCount();
  ASSERT (size > 0);
