...
void CuDlgDomPropReplicRegTbl::AddRegTbl (CuNameWithOwner *pReplicRegTbl)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pReplicRegTbl);
}
...
LRESULT CuDlgDomPropReplicRegTbl::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropReplicRegTbl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicRegTbl::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicRegTbl::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropReplicRegTbl::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaReplicRegTbl.GetCount();
