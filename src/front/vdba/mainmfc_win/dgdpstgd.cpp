...
void CuDlgDomPropStaticGwDb::AddGwDb (CuNameOnly *pGwDb)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pGwDb);
}
...
LRESULT CuDlgDomPropStaticGwDb::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropStaticGwDb::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticGwDb::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticGwDb::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropStaticGwDb::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaStaticGwDb.GetCount();
  ASSERT (size > 0);
