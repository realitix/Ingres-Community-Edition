...
LRESULT CuDlgDomPropRoleXGrantedProc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropRoleXGrantedProc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedProc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedProc::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedProc::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaRoleXGrantedProc.GetCount();
  ASSERT (size > 0);
