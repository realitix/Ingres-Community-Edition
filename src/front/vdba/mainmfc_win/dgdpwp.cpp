...
void CuDlgDomPropIcePages::AddPage (CuNameOnly *pIcePages)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIcePages);
}
...
LRESULT CuDlgDomPropIcePages::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIcePages::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIcePages::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIcePages::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIcePages::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIcePages.GetCount();
