...
void CuDlgDomPropDbSyn::AddSyn (CuNameWithOwner *pDbSyn)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbSyn);
}
...
LRESULT CuDlgDomPropDbSyn::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbSyn::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSyn::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSyn::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDbSyn::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbSyn.GetCount();
