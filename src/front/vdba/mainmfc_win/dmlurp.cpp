...
extern "C" INT_PTR WINAPI __export DlgCreateRole (HWND hwndOwner, LPROLEPARAMS lprole)
{
	int nNodeHandle = GetCurMdiNodeHandle();
	if (nNodeHandle == -1)
		return 0;
...
extern "C" INT_PTR WINAPI __export DlgAlterRole (HWND hwndOwner, LPROLEPARAMS lprole)
{
	int nNodeHandle = GetCurMdiNodeHandle();
	if (nNodeHandle == -1)
		return 0;
...
extern "C" INT_PTR WINAPI __export DlgCreateUser (HWND hwndOwner, LPUSERPARAMS lpuser)
{
	int nNodeHandle = GetCurMdiNodeHandle();
	if (nNodeHandle == -1)
		return 0;
...
extern "C" INT_PTR WINAPI __export DlgAlterUser (HWND hwndOwner, LPUSERPARAMS lpuserparams)
{
