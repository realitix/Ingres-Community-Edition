...
void CuDlgDomPropDbSchema::AddSchema (CuNameOnly *pDbSchema)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbSchema);
}
...
LRESULT CuDlgDomPropDbSchema::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbSchema::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSchema::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbSchema::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDbSchema::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbSchema.GetCount();
