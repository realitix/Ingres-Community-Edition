...
LRESULT CuDlgDomPropRoleXGrantedView::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropRoleXGrantedView::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedView::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedView::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedView::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaRoleXGrantedView.GetCount();
  ASSERT (size > 0);
