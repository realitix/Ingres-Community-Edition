...
LRESULT CuDlgIpmSummaryLocations::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmSummaryLocations::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmSummaryLocations::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgIpmSummaryLocations::OnApply (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
