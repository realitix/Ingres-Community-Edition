...
void CuDlgDomPropTableAlarms::AddTableAlarm (CuTableAlarm* pTableAlarm)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTableAlarm);
}
...
LRESULT CuDlgDomPropTableAlarms::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTableAlarms::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableAlarms::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableAlarms::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTableAlarms::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTableAlarms.GetCount();
  ASSERT (size > 0);
