...
void CuDlgDomPropIceBunitRoles::AddBunitRole (CuIceBunitRoleGrant *pIceBunitRole)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceBunitRole);
}
...
LRESULT CuDlgDomPropIceBunitRoles::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceBunitRoles::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunitRoles::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunitRoles::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceBunitRoles::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceBunitRoles.GetCount();
