...
void CuDlgDomPropIceFacetNPageRoles::AddFacetNPageAccessDef (CuIceFacetNPageAccessdef *pIceFacetNPageAccessDef)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceFacetNPageAccessDef);
}
...
LRESULT CuDlgDomPropIceFacetNPageRoles::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceFacetNPageRoles::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetNPageRoles::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetNPageRoles::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceFacetNPageRoles::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceFacetNPageAccessdef.GetCount();
