...
void CuDlgDomPropCdds::AddCddsDbInfo (CuCddsDbInfo* pCddsDbInfo)
{
  ...
  m_cListDbInfo.SetItemData(index, (DWORD_PTR)pCddsDbInfo);
}
...
void CuDlgDomPropCdds::AddCddsPath (CuCddsPath* pCddsPath)
{
  ...
  // Attach pointer for future sort purposes
  m_cListPath.SetItemData(index, (DWORD_PTR)pCddsPath);
}
...
LRESULT CuDlgDomPropCdds::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropCdds::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropCdds::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropCdds::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropCdds::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbInfos.GetCount();
  ...
  size = (int)m_Data.m_uaPropagationPaths.GetCount();
  for (cnt = 0; cnt < size; cnt++) {
