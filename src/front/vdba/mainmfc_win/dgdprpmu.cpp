...
LRESULT CuDlgDomPropReplicMailU::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropReplicMailU::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicMailU::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropReplicMailU::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropReplicMailU::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsReplicMailU.GetSize();
