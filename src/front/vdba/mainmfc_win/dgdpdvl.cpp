...
LRESULT CuDlgDomPropViewLink::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropViewLink::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewLink::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewLink::OnGetData (WPARAM wParam, LPARAM lParam)
{
