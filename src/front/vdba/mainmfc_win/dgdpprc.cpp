...
LRESULT CuDlgDomPropProcedure::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropProcedure::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcedure::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcedure::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropProcedure::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsRulesExecutingProcedure.GetSize();
