...
LRESULT CuDlgDomPropUserXGrantedProc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXGrantedProc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedProc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedProc::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXGrantedProc::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXGrantedProc.GetCount();
  ASSERT (size > 0);
