...
void CuDlgDomPropStaticUser::AddUser (CuNameOnly *pUser)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pUser);
}
...
LRESULT CuDlgDomPropStaticUser::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropStaticUser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticUser::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticUser::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropStaticUser::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaStaticUser.GetCount();
  ASSERT (size > 0);
