...
LRESULT CuDlgDomPropIceFacetAndPage::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropIceFacetAndPage::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetAndPage::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetAndPage::OnGetData (WPARAM wParam, LPARAM lParam)
{
