...
LRESULT CuDlgDomPropGroupXGrantedEvent::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropGroupXGrantedEvent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedEvent::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroupXGrantedEvent::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroupXGrantedEvent::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaGroupXGrantedEvent.GetCount();
  ASSERT (size > 0);
