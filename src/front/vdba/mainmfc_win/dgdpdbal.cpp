...
void CuDlgDomPropDbAlarms::AddDbAlarm (CuDbAlarm* pDbAlarm)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pDbAlarm);
}
...
LRESULT CuDlgDomPropDbAlarms::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropDbAlarms::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbAlarms::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropDbAlarms::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropDbAlarms::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaDbAlarms.GetCount();
  ASSERT (size > 0);
