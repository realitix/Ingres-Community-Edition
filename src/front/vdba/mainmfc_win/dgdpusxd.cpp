...
LRESULT CuDlgDomPropUserXGrantedDb::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropUserXGrantedDb::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedDb::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropUserXGrantedDb::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropUserXGrantedDb::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaUserXGrantedDb.GetCount();
  ASSERT (size > 0);
