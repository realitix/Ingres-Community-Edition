...
void CuDlgDomPropSeqGrantees::AddSeqGrantee (CuSeqGrantee* pSeqGrantee)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pSeqGrantee);
}
...
LRESULT CuDlgDomPropSeqGrantees::OnQueryType(WPARAM wParam, LPARAM lParam)
{
	ASSERT (wParam == 0);
	ASSERT (lParam == 0);
	return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropSeqGrantees::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSeqGrantees::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSeqGrantees::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropSeqGrantees::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaSeqGrantees.GetCount();
  ASSERT (size > 0);
