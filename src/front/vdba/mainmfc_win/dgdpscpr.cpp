...
void CuDlgDomPropSchemaProc::AddProc (CuNameWithOwner *pSchemaProc)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pSchemaProc);
}
...
LRESULT CuDlgDomPropSchemaProc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropSchemaProc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSchemaProc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropSchemaProc::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropSchemaProc::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaSchemaProc.GetCount();
