...
void CuDlgDomPropTableLinkIdx::AddTblIdx (CuNameWithOwner *pTblIdx)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTblIdx);
}
...
LRESULT CuDlgDomPropTableLinkIdx::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTableLinkIdx::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableLinkIdx::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableLinkIdx::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTableLinkIdx::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTblIdx.GetCount();
