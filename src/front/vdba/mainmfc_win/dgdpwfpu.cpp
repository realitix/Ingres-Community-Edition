...
LRESULT CuDlgDomPropIceFacetNPageUsers::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceFacetNPageUsers::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetNPageUsers::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacetNPageUsers::OnGetData (WPARAM wParam, LPARAM lParam)
{
