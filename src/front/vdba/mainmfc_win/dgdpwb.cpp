...
void CuDlgDomPropIceBunits::AddRole (CuNameOnly *pIceBunits)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceBunits);
}
...
LRESULT CuDlgDomPropIceBunits::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceBunits::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunits::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceBunits::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceBunits::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceBunits.GetCount();
