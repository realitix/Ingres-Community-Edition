...
LRESULT CuDlgDomPropView::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropView::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropView::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropView::OnGetData (WPARAM wParam, LPARAM lParam)
{
