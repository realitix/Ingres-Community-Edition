...
LRESULT CuDlgDomPropProcLink::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropProcLink::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcLink::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProcLink::OnGetData (WPARAM wParam, LPARAM lParam)
{
