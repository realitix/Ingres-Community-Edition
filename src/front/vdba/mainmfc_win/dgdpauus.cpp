...
LRESULT CuDlgDomPropInstallationLevelAuditAllUsers::OnQueryType(WPARAM wParam, LPARAM lParam)
{
	ASSERT (wParam == 0);
	ASSERT (lParam == 0);
	return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropInstallationLevelAuditAllUsers::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropInstallationLevelAuditAllUsers::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropInstallationLevelAuditAllUsers::OnGetData (WPARAM wParam, LPARAM lParam)
{
	CuNameOnly* p = NULL;
...
void CuDlgDomPropInstallationLevelAuditAllUsers::AddItem (LPCTSTR lpszItem, CuNameOnly* pData)
{
	...
	if (nPos != -1)
		m_cListCtrl.SetItemData (nPos, (DWORD_PTR)pData);
}
