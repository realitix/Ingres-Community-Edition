...
LRESULT CuDlgDomPropProfile::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropProfile::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropProfile::OnLoad (WPARAM wParam, LPARAM lParam)
{
  SubclassControls();
...
LRESULT CuDlgDomPropProfile::OnGetData (WPARAM wParam, LPARAM lParam)
{
