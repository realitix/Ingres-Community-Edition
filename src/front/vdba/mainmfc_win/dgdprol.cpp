...
LRESULT CuDlgDomPropRole::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropRole::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRole::OnLoad (WPARAM wParam, LPARAM lParam)
{
  SubclassControls();
...
LRESULT CuDlgDomPropRole::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRole::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsGranteesOnRole.GetSize();
