...
LRESULT CuDlgDomPropViewLinkSource::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropViewLinkSource::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewLinkSource::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropViewLinkSource::OnGetData (WPARAM wParam, LPARAM lParam)
{
