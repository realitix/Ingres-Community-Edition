...
LRESULT CuDlgDomPropLocations::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropLocations::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocations::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocations::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropLocations::OnApply (WPARAM wParam, LPARAM lParam)
{
    return 0L;
}
