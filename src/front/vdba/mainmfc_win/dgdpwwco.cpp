...
void CuDlgDomPropIceWebuserDbconns::AddDbconn (CuNameOnly *pIceWebuserDbconns)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceWebuserDbconns);
}
...
LRESULT CuDlgDomPropIceWebuserDbconns::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceWebuserDbconns::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceWebuserDbconns::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceWebuserDbconns::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceWebuserDbconns::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceWebuserDbconns.GetCount();
