...
void CuDlgDomPropTableGrantees::AddTableGrantee (CuTableGrantee* pTableGrantee)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTableGrantee);
}
...
LRESULT CuDlgDomPropTableGrantees::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTableGrantees::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableGrantees::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableGrantees::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTableGrantees::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTableGrantees.GetCount();
  ASSERT (size > 0);
