...
**  05-Apr-2011 (drivi01)
**    Update CuDomPropDataIndex class to contain m_bIVW field which
**    will be set to TRUE if vectorwise_ix index structure 
**    is detected, b/c the information for this index is a subset
**    of information provided for any Ingres index.
**    Initialize m_bIVW field to FALSE.
*/
