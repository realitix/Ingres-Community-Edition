...
void CuDlgDomPropGroup::AddUser (LPCTSTR usrName)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)usrName);
...
LRESULT CuDlgDomPropGroup::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropGroup::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroup::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropGroup::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroup::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_acsUsersInGroup.GetSize();
