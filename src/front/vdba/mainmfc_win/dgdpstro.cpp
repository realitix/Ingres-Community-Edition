...
void CuDlgDomPropStaticRole::AddRole (CuNameOnly *pRole)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pRole);
}
...
LRESULT CuDlgDomPropStaticRole::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropStaticRole::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticRole::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropStaticRole::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropStaticRole::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaStaticRole.GetCount();
  ASSERT (size > 0);
