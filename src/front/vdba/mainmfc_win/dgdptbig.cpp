...
void CuDlgDomPropTblInteg::AddTblInteg (CuNameWithOwner *pTblInteg)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTblInteg);
}
...
LRESULT CuDlgDomPropTblInteg::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTblInteg::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblInteg::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblInteg::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTblInteg::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTblInteg.GetCount();
