...
void CuDlgDomPropTableColumns::AddTblColumn(CuTblColumn* pTblColumn)
{
  ...
  m_cListColumns.SetItemData(index, (DWORD_PTR)pTblColumn);
}
...
LRESULT CuDlgDomPropTableColumns::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LRESULT CuDlgDomPropTableColumns::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableColumns::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTableColumns::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTableColumns::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaColumns.GetCount();
  ASSERT (size > 0);
