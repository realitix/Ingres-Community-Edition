...
void CaExecParamExpandBranch::SetExecParam (HWND hwndMdi, LPDOMDATA lpDomData, DWORD_PTR dwItem)
{
  ASSERT (hwndMdi);
  ASSERT (lpDomData);
  m_hwndMdi   = hwndMdi;
...
void CaExecParamForceRefreshCurSub::SetExecParam (HWND hwndMdi, LPDOMDATA lpDomData, DWORD_PTR dwItem)
{
  ASSERT (hwndMdi);
  ASSERT (lpDomData);
  m_hwndMdi   = hwndMdi;
