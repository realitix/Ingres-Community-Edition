...
void CuDlgDomPropIceFacets::AddFacet (CuNameOnly *pIceFacets)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pIceFacets);
}
...
LRESULT CuDlgDomPropIceFacets::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropIceFacets::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacets::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropIceFacets::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceFacets::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaIceFacets.GetCount();
