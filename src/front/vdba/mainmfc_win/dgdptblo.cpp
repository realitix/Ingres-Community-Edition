...
void CuDlgDomPropTblLoc::AddTblLoc (CuNameWithOwner *pTblLoc)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD_PTR)pTblLoc);
}
...
LRESULT CuDlgDomPropTblLoc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropTblLoc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblLoc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropTblLoc::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropTblLoc::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaTblLoc.GetCount();
