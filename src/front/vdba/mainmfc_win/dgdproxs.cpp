...
LRESULT CuDlgDomPropRoleXGrantedSeq::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LRESULT CuDlgDomPropRoleXGrantedSeq::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedSeq::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDomPropRoleXGrantedSeq::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedSeq::RefreshDisplay()
{
  ...
  size = (int)m_Data.m_uaRoleXGrantedSeq.GetCount();
  ASSERT (size > 0);
