...
LRESULT CuDlgParameterInstallation::OnEnableControl(WPARAM w, LPARAM l)
{
	UINT nState = (UINT)w;
...
LRESULT CuDlgParameterInstallation::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	int nCheck = m_cCheckShowUnsetParameter.GetCheck();
	if (m_pCurrentPage && IsWindow (m_pCurrentPage->m_hWnd))
	{
...
LRESULT CuDlgParameterInstallation::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgParameterInstallation::OnFind (WPARAM wParam, LPARAM lParam)
{
