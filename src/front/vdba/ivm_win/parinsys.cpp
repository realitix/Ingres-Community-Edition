...
LRESULT CuDlgParameterInstallationSystem::OnEnableControl(WPARAM w, LPARAM l)
{
	UINT nState = ST_ADD;
	int iNameCol  = 0;
	int iValueCol = 1;
...
LRESULT CuDlgParameterInstallationSystem::OnListCtrlEditing (WPARAM w, LPARAM l)
{
	CRect r, rCell;
	int iValueCol = 1;
	int nSelected = m_cListCtrl.GetNextItem (-1, LVNI_SELECTED);
...
LRESULT CuDlgParameterInstallationSystem::OnListCtrlEditOK(WPARAM w, LPARAM l)
{
	SetUnsetVariable (FALSE); // SET
	return 0;
}

LRESULT CuDlgParameterInstallationSystem::OnUnsetVariable(WPARAM w, LPARAM l)
{
...
LRESULT CuDlgParameterInstallationSystem::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgParameterInstallationSystem::OnAddParameter (WPARAM wParam, LPARAM lParam)
{
	CaModalUp modalUp;
...
LRESULT CuDlgParameterInstallationSystem::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgParameterInstallationSystem::OnFind (WPARAM wParam, LPARAM lParam)
{
