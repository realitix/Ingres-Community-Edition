...
LRESULT CuDlgLogEventGeneric::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogEventGeneric::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogEventGeneric::OnRemoveEvent(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogEventGeneric::OnRepaint (WPARAM wParam, LPARAM lParam)
{
	CRect r;
...
LRESULT CuDlgLogEventGeneric::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgLogEventGeneric::OnFind (WPARAM wParam, LPARAM lParam)
{
