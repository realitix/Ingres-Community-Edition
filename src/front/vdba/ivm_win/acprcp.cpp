...
LRESULT CuDlgArchiverRecoverLog::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	TCHAR tchszText [512];
#ifdef MAINWIN
...
LRESULT CuDlgArchiverRecoverLog::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgArchiverRecoverLog::OnFind (WPARAM wParam, LPARAM lParam)
{
