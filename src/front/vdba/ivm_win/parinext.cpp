...
LRESULT CuDlgParameterInstallationExtra::OnListCtrlEditOK(WPARAM w, LPARAM l)
{
	SetUnsetVariable (FALSE); // SET
	return 0;
}

LRESULT CuDlgParameterInstallationExtra::OnUnsetVariable(WPARAM w, LPARAM l)
{
...
LRESULT CuDlgParameterInstallationExtra::OnListCtrlEditing (WPARAM w, LPARAM l)
{
	CRect r, rCell;
	int iValueCol = 1;
	int nSelected = m_cListCtrl.GetNextItem (-1, LVNI_SELECTED);
...
LRESULT CuDlgParameterInstallationExtra::OnEnableControl(WPARAM w, LPARAM l)
{
	UINT nState = ST_ADD;
	int iNameCol  = 0;
	int iValueCol = 1;
...
LRESULT CuDlgParameterInstallationExtra::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	RefreshParameter();
	return 0;
}

LRESULT CuDlgParameterInstallationExtra::OnAddParameter (WPARAM wParam, LPARAM lParam)
{
	CaModalUp modalUp;
...
LRESULT CuDlgParameterInstallationExtra::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgParameterInstallationExtra::OnFind (WPARAM wParam, LPARAM lParam)
{
