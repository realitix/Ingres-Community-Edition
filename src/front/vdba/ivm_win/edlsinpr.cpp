...
LRESULT CuEditableListCtrlInstallationParameter::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlInstallationParameter::OnEditAssistant (WPARAM wParam, LPARAM lParam)
{
	...
	if (pData->GetType() == P_PATH)
	{
		...
		//
		// Display the browser.
		ITEMIDLIST __unaligned *browseList = NULL;
...
LRESULT CuEditableListCtrlInstallationParameter::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlInstallationParameter::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrlInstallationParameter::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
	int nMin, nMax;
...
LRESULT CuEditableListCtrlInstallationParameter::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrlInstallationParameter::OnComboDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
