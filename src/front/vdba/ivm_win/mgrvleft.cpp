...
LRESULT CvManagerViewLeft::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CaIvmTree& treeData = theApp.GetTreeData();
...
LRESULT CvManagerViewLeft::OnGetItemData (WPARAM wParam, LPARAM lParam)
{
	CaTreeComponentItemData* pItem = NULL;
	CTreeCtrl& cTree = GetTreeCtrl();
...
LRESULT CvManagerViewLeft::OnUpdateComponent(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvManagerViewLeft::OnUpdateComponentIcon(WPARAM wParam, LPARAM lParam)
{
	try
	{
		int nChange = 0;
...
LRESULT CvManagerViewLeft::OnUpdateAlert(WPARAM wParam, LPARAM lParam)
{
	BOOL bAlert = FALSE;
...
LRESULT CvManagerViewLeft::OnUpdateUnalert(WPARAM wParam, LPARAM lParam)
{
	if ((int)wParam == 0)
	{
...
LRESULT CvManagerViewLeft::OnReactivateSelection(WPARAM wParam, LPARAM lParam)
{
	CWaitCursor doWaitCursor;
	CfManagerFrame* pFrame = (CfManagerFrame*)GetParentFrame();
	ASSERT (pFrame);
...
LRESULT CvManagerViewLeft::OnGetState(WPARAM wParam, LPARAM lParam)
{
	BOOL bStarted = FALSE;
	try
	{
...
LRESULT CvManagerViewLeft::OnShutDownIngres(WPARAM wParam, LPARAM lParam)
{
	try
	{
		CTreeCtrl& cTree = GetTreeCtrl();
...
LRESULT CvManagerViewLeft::OnErrorOccurred(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvManagerViewLeft::OnRunProgram(WPARAM wParam, LPARAM lParam)
{
