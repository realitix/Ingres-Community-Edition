...
LRESULT CfMainFrame::OnTrayNotificationCallback (WPARAM wParam, LPARAM lParam)
{
	switch (lParam)
	{
...
LRESULT CfMainFrame::OnPopupMenu(WPARAM wParam, LPARAM lParam)
{
	CMenu menu;
...
LRESULT CfMainFrame::OnSystemShutDown(WPARAM wParam, LPARAM lParam)
{
	m_bEndSession = TRUE;
	OnHaltProgram();
	m_bEndSession = FALSE;
...
LRESULT CfMainFrame::OnExternalRequestShutDown(WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CfMainFrame::OnNotifyNewEvent (WPARAM wParam, LPARAM lParam)
{
	try
	{
		SetForegroundWindow();
...
LRESULT CfMainFrame::OnUpdateComponent(WPARAM wParam, LPARAM lParam)
{
	CWaitCursor doWaitCursor;
	try
	{
...
LRESULT CfMainFrame::OnUpdateEvent(WPARAM wParam, LPARAM lParam)
{
	CWaitCursor doWaitCursor;
...
LRESULT CfMainFrame::OnUpdateShellIcon(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CfMainFrame::OnIvmMessageBox(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CfMainFrame::OnReinitializeEvent(WPARAM wParam, LPARAM lParam)
{
	CWaitCursor doWaitCursor;
	try
	{
...
LRESULT CfMainFrame::OnSaveData(WPARAM wParam, LPARAM lParam)
{
	try
	{
		CdMainDoc* pDoc = NULL;
...
LRESULT CfMainFrame::OnFindReplace(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CfMainFrame::OnMakeActive(WPARAM wParam, LPARAM lParam)
{
	OnActivateProgram();
	return 0;
}
...
LRESULT CfMainFrame::OnRunProgram(WPARAM wParam, LPARAM lParam)
{
	CdMainDoc* pDoc = (CdMainDoc*)GetActiveDocument();
	if (pDoc)
	{
