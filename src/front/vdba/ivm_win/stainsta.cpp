...
LRESULT CuDlgStatusInstallation::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	try
	{
...
LRESULT CuDlgStatusInstallation::OnComponentChanged (WPARAM wParam, LPARAM lParam)
{
	OnUpdateData (0, 0);
	return 0;
}
...
LRESULT CuDlgStatusInstallation::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgStatusInstallation::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgStatusInstallation::OnFind (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgStatusInstallation::OnTimer(UINT_PTR nIDEvent)
{
