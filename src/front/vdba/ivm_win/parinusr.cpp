...
LRESULT CuDlgParameterInstallationUser::OnListCtrlEditing (WPARAM w, LPARAM l)
{
	CRect r, rCell;
	int iValueCol = 1;
...
LRESULT CuDlgParameterInstallationUser::OnListCtrlEditOK(WPARAM w, LPARAM l)
{
	SetUnsetVariable (FALSE); // SET
	return 0;
}

LRESULT CuDlgParameterInstallationUser::OnUnsetVariable(WPARAM w, LPARAM l)
{
...
LRESULT CuDlgParameterInstallationUser::OnEnableControl(WPARAM w, LPARAM l)
{
	UINT nState = ST_ADD;
	int iNameCol  = 0;
	int iValueCol = 1;
...
LRESULT CuDlgParameterInstallationUser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgParameterInstallationUser::OnAddParameter (WPARAM wParam, LPARAM lParam)
{
	CaModalUp modalUp;
...
LRESULT CuDlgParameterInstallationUser::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgParameterInstallationUser::OnFind (WPARAM wParam, LPARAM lParam)
{
