...
LRESULT CuDlgStatusSingleInstanceComponent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	try
	{
...
LRESULT CuDlgStatusSingleInstanceComponent::OnComponentChanged (WPARAM wParam, LPARAM lParam)
{
	OnUpdateData (0, 0);
	return 0;
}
...
LRESULT CuDlgStatusSingleInstanceComponent::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgStatusSingleInstanceComponent::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgStatusSingleInstanceComponent::OnFind (WPARAM wParam, LPARAM lParam)
{
