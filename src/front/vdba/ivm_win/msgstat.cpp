...
LRESULT CuDlgMessageStatistic::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgMessageStatistic::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgMessageStatistic::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}
...
LRESULT CuDlgMessageStatistic::OnFind (WPARAM wParam, LPARAM lParam)
{
