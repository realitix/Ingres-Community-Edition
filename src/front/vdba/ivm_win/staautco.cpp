...
LRESULT CuDlgStatusAutoStartComponent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	try
	{
...
LRESULT CuDlgStatusAutoStartComponent::OnComponentChanged (WPARAM wParam, LPARAM lParam)
{
	OnUpdateData (0, 0);
	return 0;
}

LRESULT CuDlgStatusAutoStartComponent::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgStatusAutoStartComponent::OnFind (WPARAM wParam, LPARAM lParam)
{
	//
	// This pane is not currently used !
	ASSERT (FALSE);
