...
LRESULT CuDlgStatusInstance::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	try
	{
...
LRESULT CuDlgStatusInstance::OnComponentChanged (WPARAM wParam, LPARAM lParam)
{
	OnUpdateData (0, 0);
	return 0;
}
...
LRESULT CuDlgStatusInstance::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
	//
...
LRESULT CuDlgStatusInstance::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LRESULT CuDlgStatusInstance::OnFind (WPARAM wParam, LPARAM lParam)
{
