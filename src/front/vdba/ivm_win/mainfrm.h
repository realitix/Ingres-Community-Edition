...
protected:  // control bar embedded members
	...
	BOOL m_bDoAlert;
	LONG_PTR m_nNewEventCount; // total number of events comming per thread activity (sum of number of event arrived by block)
...
protected:
	...
	afx_msg LRESULT OnTrayNotificationCallback (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnPopupMenu(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnSystemShutDown(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnNotifyNewEvent (WPARAM wParam, LPARAM lParam);
	afx_msg void OnWindowPosChanging(WINDOWPOS* lpwndpos);
	afx_msg LRESULT OnUpdateComponent(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnUpdateEvent(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnUpdateShellIcon(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnReinitializeEvent(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnExternalRequestShutDown(WPARAM wParam, LPARAM lParam);
	...
	afx_msg LRESULT OnIvmMessageBox(WPARAM wParam, LPARAM lParam);
	//
	// Periodical save data:
	afx_msg LRESULT OnSaveData(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnFindReplace(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnMakeActive(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnRunProgram(WPARAM wParam, LPARAM lParam);
