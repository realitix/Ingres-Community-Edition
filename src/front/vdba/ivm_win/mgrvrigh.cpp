...
LRESULT CvManagerViewRight::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	if (m_pMainTab && IsWindow (m_pMainTab->m_hWnd))
	{
...
LRESULT CvManagerViewRight::OnRemoveEvent(WPARAM wParam, LPARAM lParam)
{
	if (m_pMainTab && IsWindow (m_pMainTab->m_hWnd))
	{
...
LRESULT CvManagerViewRight::OnGetHelpID  (WPARAM wParam, LPARAM lParam)
{
	if (m_pMainTab && IsWindow (m_pMainTab->m_hWnd))
...
LRESULT CvManagerViewRight::OnComponentChanged  (WPARAM wParam, LPARAM lParam)
{
	if (m_pMainTab && IsWindow (m_pMainTab->m_hWnd))
...
LRESULT CvManagerViewRight::OnNewEvents  (WPARAM wParam, LPARAM lParam)
{
	if (m_pMainTab && IsWindow (m_pMainTab->m_hWnd))
	{
		CWnd* pWnd = m_pMainTab->GetCurrentPage();
...
LRESULT CvManagerViewRight::OnReinitializeEvent(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvManagerViewRight::OnReactivateSelection(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvManagerViewRight::OnLastNameServerStartedup(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvManagerViewRight::OnGetCreatedPane(WPARAM wParam, LPARAM lParam)
{
	CWnd* pWndCreated = NULL;
