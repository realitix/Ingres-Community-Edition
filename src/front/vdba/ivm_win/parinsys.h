...
protected:
	...
	afx_msg LRESULT OnListCtrlEditing (WPARAM w, LPARAM l);
	afx_msg LRESULT OnListCtrlEditOK(WPARAM w, LPARAM l);
	afx_msg LRESULT OnUnsetVariable(WPARAM w, LPARAM l);
	afx_msg LRESULT OnEnableControl(WPARAM w, LPARAM l);
	afx_msg LRESULT OnUpdateData (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnAddParameter (WPARAM wParam, LPARAM lParam);
