...
protected:
	...
	afx_msg LRESULT OnUpdateComponentIcon(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnUpdateAlert(WPARAM wParam, LPARAM lParam);
	//
	// wParam = 0 (Update Unalert event by event)
	// wParam = 1 (Update Unalert all events)
	afx_msg LRESULT OnUpdateUnalert(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnReactivateSelection(WPARAM wParam, LPARAM lParam);

	afx_msg LRESULT OnGetState(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnShutDownIngres(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnErrorOccurred(WPARAM wParam, LPARAM lParam);
