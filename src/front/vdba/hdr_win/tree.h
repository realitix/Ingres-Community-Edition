...
typedef struct  _sTreeRecord
{
  ...
  DWORD_PTR m_pPageInfo;      // cast into CuPageInformation on the C++ side
...
extern DWORD_PTR  TreeAddRecord(LPDOMDATA lpDomData, LPSTR lpString, DWORD_PTR parentId, DWORD_PTR insertAfter, DWORD_PTR insertBefore, LPVOID lpData);
extern DWORD_PTR  AddDummySubItem(LPDOMDATA lpDomData, DWORD_PTR idParent);
extern DWORD_PTR  AddProblemSubItem(LPDOMDATA lpDomData, DWORD_PTR idParent, int errortype, int iobjecttype, LPTREERECORD lpRefRecord);
extern BOOL   TreeDeleteRecord(LPDOMDATA lpDomData, DWORD_PTR recordId);
...
extern DWORD_PTR  GetAnchorId(LPDOMDATA lpDomData, int iobjecttype, int level, LPUCHAR *parentstrings, DWORD_PTR previousId, LPUCHAR bufPar1, LPUCHAR bufPar2, LPUCHAR bufPar3, int iAction, DWORD_PTR idItem, BOOL bTryCurrent, BOOL *pbRootItem);
extern UCHAR *GetObjName(LPDOMDATA lpDomData, DWORD_PTR dwItem);
extern DWORD_PTR  GetCurSel(LPDOMDATA lpDomData);
extern int    GetCurSelObjType(LPDOMDATA lpDomData);
extern int    GetItemObjType(LPDOMDATA lpDomData, DWORD_PTR dwItem);
extern int    GetUnsolvedItemObjType(LPDOMDATA lpDomData, DWORD_PTR dwItem);
extern int    GetItemDisplayObjType(LPDOMDATA lpDomData, DWORD_PTR dwItem);
extern BOOL   IsCurSelObjStatic(LPDOMDATA lpDomData);
extern BOOL   IsItemObjStatic(LPDOMDATA lpDomData, DWORD_PTR dwItem);
extern DWORD_PTR  GetFirstImmediateChild(LPDOMDATA lpDomData, DWORD_PTR idParentReq, DWORD *pParentLevel);
extern DWORD_PTR  GetNextImmediateChild(LPDOMDATA lpDomData, DWORD_PTR idParentReq, DWORD_PTR idCurChild, DWORD dwParentLevel);
extern DWORD_PTR  FindImmediateSubItem(LPDOMDATA lpDomData, DWORD_PTR idParentReq, DWORD_PTR idFirstChildObj, DWORD_PTR idLastChildObj, int iobjecttype, LPUCHAR objName,
                                   LPUCHAR objOwnerName, LPUCHAR parentName, LPUCHAR bufComplim, DWORD_PTR *pidInsertAfter, DWORD_PTR *pidInsertBefore);
extern VOID   TreeDeleteAllChildren(LPDOMDATA lpDomData, DWORD_PTR idParent);
...
extern DWORD_PTR  GetPreviousSibling(LPDOMDATA lpDomData, DWORD_PTR dwReq);
extern DWORD_PTR  GetNextSibling(LPDOMDATA lpDomData, DWORD_PTR dwReq);
extern DWORD_PTR  GetLastRecordId(LPDOMDATA lpDomData);
extern DWORD_PTR  GetFirstLevel0Item(LPDOMDATA lpDomData);
extern DWORD_PTR  GetNextLevel0Item(LPDOMDATA lpDomData, DWORD_PTR idCurItem);
extern DWORD_PTR  GetParentAtLevel(LPDOMDATA lpDomData, DWORD_PTR dwItem, DWORD pParentLevel);

//  Test if the item in the tree belongs to IVW table
extern int  IsVWTreeItem(LPDOMDATA lpDomData, DWORD_PTR dwCurSel);
...
void MT_MfcUpdateRightPane(HWND hwndDoc, LPDOMDATA lpDomData, BOOL bCurSelStatic, DWORD_PTR dwCurSel, int CurItemObjType, LPTREERECORD lpRecord, BOOL bHasProperties, BOOL bUpdate, int initialSel, BOOL bClear);
void TS_MfcUpdateRightPane(HWND hwndDoc, LPDOMDATA lpDomData, BOOL bCurSelStatic, DWORD_PTR dwCurSel, int CurItemObjType, LPTREERECORD lpRecord, BOOL bHasProperties, BOOL bUpdate, int initialSel, BOOL bClear);
