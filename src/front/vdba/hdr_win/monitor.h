...
typedef struct LogSummaryDataMin {
    ...
    LONGLONG lgd_Commit_Average;
    LONGLONG lgd_Commit_Current;
    LONGLONG lgd_Commit_Max;
    LONGLONG lgd_Commit_Min;
    LONGLONG lgd_Write_Average;
    LONGLONG lgd_Write_Current;
    LONGLONG lgd_Write_Max;
    LONGLONG lgd_Write_Min;
