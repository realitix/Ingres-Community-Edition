...
**    Add MAX_BUF_USERTYPE to store grantee type.
**    
*/
...
#define MAX_BUF_USERTYPE       10          // Maximum length of grantee type (OT_USER/GROUP/ROLE)
...
typedef struct tagEDITMINMAX
{
   ...
   DWORD_PTR dwMin;                        // Minimum value allowed in edit control
   DWORD_PTR dwMax;                        // Maximum value allowed in edit control
...
INT_PTR WINAPI VdbaDialogBox(HINSTANCE, LPCSTR, HWND, DLGPROC);
INT_PTR WINAPI VdbaDialogBoxParam(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM);
