...
LRESULT CuEditableListCtrlSqlWizardSelectOrderColumn::OnComboDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlSqlWizardSelectOrderColumn::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
