...
LRESULT CuEditableListCtrlSqlWizardInsertValue::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlSqlWizardInsertValue::OnEditAssistant (WPARAM wParam, LPARAM lParam)
{
