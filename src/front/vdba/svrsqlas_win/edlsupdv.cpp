...
LRESULT CuEditableListCtrlSqlWizardUpdateValue::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlSqlWizardUpdateValue::OnEditAssistant (WPARAM wParam, LPARAM lParam)
{
