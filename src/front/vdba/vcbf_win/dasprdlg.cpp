...
LRESULT CuDlgDASVRProtocol::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDASVRProtocol::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDASVRProtocol::OnEditListenAddress (WPARAM wParam, LPARAM lParam)
{
