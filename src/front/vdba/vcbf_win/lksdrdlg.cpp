...
LRESULT CuDlgLockingSystemDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgLockingSystemDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLockingSystemDerived::OnButton3...\n");
	return 0;
}

LRESULT CuDlgLockingSystemDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLockingSystemDerived::OnButton4...\n");
	return 0;
}

LRESULT CuDlgLockingSystemDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
