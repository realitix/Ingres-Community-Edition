...
LRESULT CvDbmsCacheViewLeft::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CvDbmsCacheViewLeft::OnButton1 (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CvDbmsCacheViewLeft::OnButton2 (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CvDbmsCacheViewLeft::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
