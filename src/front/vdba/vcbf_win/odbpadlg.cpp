...
LRESULT CuDlgGW_ODBCParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_ODBCParameter::OnButton2 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_ODBCParameter::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_ODBCParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgGW_ODBCParameter::OnButton4 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_ODBCParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgGW_ODBCParameter::OnButton5 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_ODBCParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgGW_ODBCParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}
