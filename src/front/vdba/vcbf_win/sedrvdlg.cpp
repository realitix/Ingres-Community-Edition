...
LRESULT CuDlgSecurityDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	//
	// First of all:
...
LRESULT CuDlgSecurityDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgSecurityDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityDerived::OnButton3...\n");
	return 0;
}

LRESULT CuDlgSecurityDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityDerived::OnButton4...\n");
	return 0;
}

LRESULT CuDlgSecurityDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
