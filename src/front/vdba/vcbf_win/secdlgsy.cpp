...
LRESULT CuDlgSecuritySystem::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecuritySystem::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecuritySystem::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	if (lParam) 
	{
