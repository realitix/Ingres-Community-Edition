...
LRESULT CuDlgNetParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgNetParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgNetParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgNetParameter::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgNetParameter::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgNetParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgNetParameter::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgNetParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgNetParameter::OnButton5(WPARAM wParam, LPARAM lParam)
{
