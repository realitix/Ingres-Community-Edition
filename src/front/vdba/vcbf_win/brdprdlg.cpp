...
LRESULT CuDlgBridgeProtocol::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgBridgeProtocol::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgBridgeProtocol::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgBridgeProtocol::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgBridgeProtocol::OnButton3...\n");
	return 0;
}

LRESULT CuDlgBridgeProtocol::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgBridgeProtocol::OnButton4...\n");
	return 0;
}

LRESULT CuDlgBridgeProtocol::OnButton5(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrlBridge::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
