...
LRESULT CuDlgBridgeVNode::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	USES_CONVERSION;
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
...
LRESULT CuDlgBridgeVNode::OnButton1 (WPARAM wParam, LPARAM lParam)
{
	USES_CONVERSION;
	CxDlgAddVNode dlg;
	if (dlg.DoModal() == IDOK)
...
LRESULT CuDlgBridgeVNode::OnButton2(WPARAM wParam, LPARAM lParam)
{
	USES_CONVERSION;
