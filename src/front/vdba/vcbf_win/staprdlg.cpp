...
LRESULT CuDlgStarParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarParameter::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarParameter::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgStarParameter::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgStarParameter::OnButton5(WPARAM wParam, LPARAM lParam)
{
