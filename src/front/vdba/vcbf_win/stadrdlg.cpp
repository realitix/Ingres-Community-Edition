...
LRESULT CuDlgStarDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgStarDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgStarDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgStarDerived::OnButton3...\n");
	return 0;
}

LRESULT CuDlgStarDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgStarDerived::OnButton4...\n");
	return 0;
}

LRESULT CuDlgStarDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
