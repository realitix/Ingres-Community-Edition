...
LRESULT CuDlgCacheTab::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	return 0;
}

LRESULT CuDlgCacheTab::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (m_pCurrentPage)
...
LRESULT CuDlgCacheTab::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgCacheTab::OnButton2 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgCacheTab::OnButton3 (WPARAM wParam, LPARAM lParam)
{
