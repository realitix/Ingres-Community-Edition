...
LRESULT CuDlgLogfileConfigure::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
  //
...
LRESULT CuDlgLogfileConfigure::OnReformat (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileConfigure::OnDisable(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileConfigure::OnErase(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileConfigure::OnDestroyLog(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileConfigure::OnCreate(WPARAM wParam, LPARAM lParam)
{ CString strSize;
  TCHAR szSize[100];
...
void CuDlgLogfileConfigure::OnTimer(UINT_PTR nIDEvent) 
{
	LPTRANSACTINFO lpS = &m_pLogFileData->m_transactionInfo;
