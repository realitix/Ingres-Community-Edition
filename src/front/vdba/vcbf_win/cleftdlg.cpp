...
LRESULT CConfLeftDlg::OnComponentExit (WPARAM wParam, LPARAM lParam)
{
	int nCount;
	CuCbfListViewItem* pData = NULL;
...
LRESULT CConfLeftDlg::OnComponentEnter (WPARAM wParam, LPARAM lParam)
{
	int nCount;
	CuCbfListViewItem* pData = NULL;
...
LRESULT CConfLeftDlg::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CConfListViewLeft* pView = (CConfListViewLeft*)GetParent();
	ASSERT (pView);
	CSplitterWnd* pSplitter  = (CSplitterWnd*)pView->GetParent ();
...
LRESULT CConfLeftDlg::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_clistctrl.HideProperty();
	return 0L;
}
