...
LRESULT CuDlgJDBCParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgJDBCParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgJDBCParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgJDBCParameter::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgJDBCParameter::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgJDBCParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgJDBCParameter::OnButton4(WPARAM  wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgJDBCParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgJDBCParameter::OnButton5(WPARAM wParam, LPARAM lParam)
{
