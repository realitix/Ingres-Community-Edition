...
LRESULT CuDlgLogfileSecondary::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
  //
...
LRESULT CuDlgLogfileSecondary::OnReformat (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileSecondary::OnDisable(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileSecondary::OnErase(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileSecondary::OnDestroyLog(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLogfileSecondary::OnCreate(WPARAM wParam, LPARAM lParam)
{ CString strSize;
  TCHAR szSize[100];
...
void CuDlgLogfileSecondary::OnTimer(UINT_PTR nIDEvent) 
{
	LPTRANSACTINFO lpS = &m_pLogFileData->m_transactionInfo;
