...
LRESULT CConfigDlg::OnComponentExit (WPARAM wParam, LPARAM lParam)
{
	if (m_pConfDlgFrame)
...
LRESULT CConfigDlg::OnComponentEnter (WPARAM wParam, LPARAM lParam)
{
	if (m_pConfDlgFrame)
...
LRESULT CConfigDlg::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	if (m_pConfDlgFrame)
...
LRESULT CConfigDlg::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (m_pConfDlgFrame)
	{
