...
LRESULT CuDlgGW_SybaseParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_SybaseParameter::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_SybaseParameter::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_SybaseParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgGW_SybaseParameter::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_SybaseParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgGW_SybaseParameter::OnButton5(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_SybaseParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgGW_SybaseParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}
