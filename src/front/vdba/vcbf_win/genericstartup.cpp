...
LRESULT CuDlgGenericStartup::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGenericStartup::OnValidateData (WPARAM wParam, LPARAM lParam)
{ 
...
LRESULT CuDlgGenericStartup::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGenericStartup::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGenericStartup::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGenericStartup::OnButton3...\n");
	return 0;
}

LRESULT CuDlgGenericStartup::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGenericStartup::OnButton4...\n");
	return 0;
}

LRESULT CuDlgGenericStartup::OnButton5(WPARAM wParam, LPARAM lParam)
{
