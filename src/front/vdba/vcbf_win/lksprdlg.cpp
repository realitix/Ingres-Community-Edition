...
LRESULT CuDlgLockingSystemParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemParameter::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgLockingSystemParameter::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgLockingSystemParameter::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgLockingSystemParameter::OnButton5(WPARAM wParam, LPARAM lParam)
{
