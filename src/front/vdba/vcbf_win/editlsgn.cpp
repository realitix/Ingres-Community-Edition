...
LRESULT CuEditableListCtrlGeneric::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlGeneric::OnEditDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrlGeneric::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlGeneric::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
...
LRESULT CuEditableListCtrlGeneric::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
	int iMin, iMax;
...
LRESULT CuEditableListCtrlGeneric::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
