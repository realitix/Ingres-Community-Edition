...
LRESULT CuDlgNetRegistry::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgNetRegistry::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgNetRegistry::OnEditListenAddress (WPARAM wParam, LPARAM lParam)
{
