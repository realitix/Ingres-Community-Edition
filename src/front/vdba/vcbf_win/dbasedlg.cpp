...
LRESULT CuDlgDbmsDatabase::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
  //
...
LRESULT CuDlgDbmsDatabase::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDatabase::OnAdd (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDatabase::OnDelete (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDatabase::OnEditOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDatabase::OnEditCancel (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDbmsDatabaseListBox::OnEditOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDbmsDatabaseListBox::OnEditCancel (WPARAM wParam, LPARAM lParam)
{
