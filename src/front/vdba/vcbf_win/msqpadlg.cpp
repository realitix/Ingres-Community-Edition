...
LRESULT CuDlgGW_MSSQLParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_MSSQLParameter::OnButton2 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_MSSQLParameter::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_MSSQLParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgGW_MSSQLParameter::OnButton4 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_MSSQLParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgGW_MSSQLParameter::OnButton5 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_MSSQLParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgGW_MSSQLParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}
