...
LRESULT CuDlgDbmsCacheDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgDbmsCacheDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgDbmsCacheDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCacheDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCacheDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgDbmsCacheDerived::OnButton3...\n");
	return 0;
}

LRESULT CuDlgDbmsCacheDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgDbmsCacheDerived::OnButton4...\n");
	return 0;
}

LRESULT CuDlgDbmsCacheDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
