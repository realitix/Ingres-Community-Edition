...
LRESULT CuEditableListCtrlGenericDerived::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlGenericDerived::OnEditDlgCancel (WPARAM wParam, LPARAM lParam)
{
    return 0L;
}

LRESULT CuEditableListCtrlGenericDerived::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlGenericDerived::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}


LRESULT CuEditableListCtrlGenericDerived::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
	int iMin, iMax;
...
LRESULT CuEditableListCtrlGenericDerived::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
