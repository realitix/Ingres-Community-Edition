...
LRESULT CuDlgGW_OracleParameter::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_OracleParameter::OnButton2 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_OracleParameter::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_OracleParameter::OnButton3...\n");
	return 0;
}

LRESULT CuDlgGW_OracleParameter::OnButton4 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgGW_OracleParameter::OnButton4...\n");
	return 0;
}

LRESULT CuDlgGW_OracleParameter::OnButton5 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgGW_OracleParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LRESULT CuDlgGW_OracleParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}
