...
LRESULT CuEditableListCtrlNet::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlNet::OnEditDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}

LRESULT CuEditableListCtrlNet::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlNet::OnEditNumberDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
...
LRESULT CuEditableListCtrlNet::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
	int iMin, iMax;
...
LRESULT CuEditableListCtrlNet::OnEditSpinDlgCancel (WPARAM wParam, LPARAM lParam)
{
	return 0L;
}
...
LRESULT CuEditableListCtrlNet::ManageEditDlgOK (WPARAM wParam, LPARAM lParam)
{
