...
LRESULT CuDlgSecurityAuditing::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	//
	// First of all:
...
LRESULT CuDlgSecurityAuditing::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityAuditing::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityAuditing::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityAuditing::OnButton3...\n");
	return 0;
}

LRESULT CuDlgSecurityAuditing::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityAuditing::OnButton4...\n");
	return 0;
}

LRESULT CuDlgSecurityAuditing::OnButton5(WPARAM wParam, LPARAM lParam)
{
