...
LRESULT CuDlgCacheList::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0L;
	CleanCacheControl (m_ListCtrl);
...
LRESULT CuDlgCacheList::OnButton1 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgCacheList::OnButton1...\n");
	return 0L;
}

LRESULT CuDlgCacheList::OnButton2 (WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgCacheList::OnButton2...\n");
	return 0L;
}

LRESULT CuDlgCacheList::OnButton3 (WPARAM wParam, LPARAM lParam)
{
