...
LRESULT CuDlgSecurityLogFile::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityLogFile::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}

LRESULT CuDlgSecurityLogFile::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityLogFile::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSecurityLogFile::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityLogFile::OnButton3...\n");
	return 0;
}

LRESULT CuDlgSecurityLogFile::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityLogFile::OnButton4...\n");
	return 0;
}

LRESULT CuDlgSecurityLogFile::OnButton5(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrlAuditLog::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
