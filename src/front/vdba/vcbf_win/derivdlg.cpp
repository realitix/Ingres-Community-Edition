...
LRESULT CuDlgDbmsDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LRESULT CuDlgDbmsDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgDbmsDerived::OnButton3...\n");
	return 0;
}

LRESULT CuDlgDbmsDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgDbmsDerived::OnButton4...\n");
	return 0;
}

LRESULT CuDlgDbmsDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
