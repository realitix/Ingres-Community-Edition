...
LRESULT CuDlgDbmsCache::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCache::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCache::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCache::OnButton2 (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgDbmsCache::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	CvDbmsCacheViewLeft* pViewLeft = GetLeftPane ();
	if (pViewLeft)
