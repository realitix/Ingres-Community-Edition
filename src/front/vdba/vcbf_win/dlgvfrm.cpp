...
LRESULT CuDlgViewFrame::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgViewFrame::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
...
LRESULT CuDlgViewFrame::OnButton1 (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
...
LRESULT CuDlgViewFrame::OnButton2 (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
...
LRESULT CuDlgViewFrame::OnButton3 (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
...
LRESULT CuDlgViewFrame::OnButton4 (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
...
LRESULT CuDlgViewFrame::OnButton5 (WPARAM wParam, LPARAM lParam)
{
	CView* pView = GetActiveView();
	if (pView)
