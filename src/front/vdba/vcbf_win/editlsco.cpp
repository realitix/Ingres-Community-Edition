...
LRESULT CuEditableListCtrlComponent::OnEditDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlComponent::OnEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
	int iItem, iSubItem;
...
LRESULT CuEditableListCtrlComponent::OnEditNumberDlgOK (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuEditableListCtrlComponent::OnComboDlgOK (WPARAM wParam, LPARAM lParam)
{
	ASSERT (FALSE);   // NOT USED YET - NEED TO ADD CHECK BY LOW LEVEL
...
//
LRESULT CuEditableListCtrlComponent::ManageEditDlgOK (WPARAM wParam, LPARAM lParam)
{
  return OnEditDlgOK(wParam, lParam);
}

LRESULT CuEditableListCtrlComponent::ManageEditSpinDlgOK (WPARAM wParam, LPARAM lParam)
{
