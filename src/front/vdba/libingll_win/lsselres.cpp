...
LRESULT CuListCtrlSelectResult::OnDisplayRow (WPARAM wParam, LPARAM lParam)
{
	int i=0;
	CString strItem;
	...
	{
		INT_PTR nColumnCount = listFields.GetCount();
		if (m_bShowRowNumber)
			nColumnCount++;
...
LRESULT CuListCtrlSelectResult::OnFetchNewRows (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuListCtrlSelectResult::OnEndFetchRows(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuListCtrlSelectResult::OnChangeSetting(WPARAM wParam, LPARAM lParam)
{
