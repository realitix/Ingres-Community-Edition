...
** 27-Oct-2011 (drivi01)
**    When putting a path together for temporary directory
**    to store iiguis.prf, append Vectorwise for Vectorwise
**    product.  "#ifdef conf_IVW" for that portion of the path.
**/
