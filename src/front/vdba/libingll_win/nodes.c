...
static SIZE_TYPE     gcm_NLV_message();
...
static SIZE_TYPE gcm_mib_display(PTR start, LPMIBREQUEST pRequest)
{
	i4 error_status;
	i4 error_index, i;
	char* r = start;
...
static SIZE_TYPE gcm_mib_message( PTR start, LPMIBREQUEST pMibs )
{
	i4   i;
	char* q = start;
	int nCount = 0;
