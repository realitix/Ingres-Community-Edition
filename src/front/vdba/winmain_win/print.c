 ...
 *                                                                          *
 ****************************************************************************/
LRESULT WINAPI __export PrintDlgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  switch (msg)
  {
...
static BOOL PageOnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
  ...
  {
    SetWindowLongPtr(hwnd, DWLP_USER, (LONG_PTR)lpdata);
  }
	...
	lpfnOldEdit = (FARPROC)SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_TOPEDIT),GWLP_WNDPROC,(LONG_PTR) lpdata->lpfnEditSub);
	lpfnOldEdit = (FARPROC)SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_LEFTEDIT),GWLP_WNDPROC,(LONG_PTR) lpdata->lpfnEditSub);
	lpfnOldEdit = (FARPROC)SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_BOTTOMEDIT),GWLP_WNDPROC,(LONG_PTR) lpdata->lpfnEditSub);
	lpfnOldEdit = (FARPROC)SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_RIGHTEDIT),GWLP_WNDPROC,(LONG_PTR) lpdata->lpfnEditSub);
	return (FALSE);
}

static void PageOnDestroy(HWND hwnd)
{
    LPPAGEDWLSTRUCT lpdata = (LPPAGEDWLSTRUCT)GetWindowLongPtr(hwnd, DWLP_USER);
	SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_TOPEDIT),GWLP_WNDPROC,(LONG_PTR) lpfnOldEdit);
	SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_LEFTEDIT),GWLP_WNDPROC,(LONG_PTR) lpfnOldEdit);
	SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_BOTTOMEDIT),GWLP_WNDPROC,(LONG_PTR) lpfnOldEdit);
	SetWindowLongPtr(GetDlgItem(hwnd, IDD_PSETUP_RIGHTEDIT),GWLP_WNDPROC,(LONG_PTR) lpfnOldEdit);
