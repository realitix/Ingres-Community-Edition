...
protected:
	...
	//}}AFX_MSG
	afx_msg LRESULT OnRedrawLinks   (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnOpenPopupInfo (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnClosePopupInfo(WPARAM wParam, LPARAM lParam);
	DECLARE_MESSAGE_MAP()
};
