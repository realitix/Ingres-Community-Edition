...
LRESULT CuDlgSqlQueryPageResult::OnGetTabBitmap (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageResult::OnCloseCursor (WPARAM wParam, LPARAM lParam)
{
	CaExecParamQueryRows* pExecParam = m_ListCtrl.GetQueryRowParam();
	if (!m_bLoaded)
	{
...
LRESULT CuDlgSqlQueryPageResult::OnDisplayHeader (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageResult::OnHighlightStatement (WPARAM wParam, LPARAM lParam)
{
	if (m_bStandAlone)
	{
		//
...
LRESULT CuDlgSqlQueryPageResult::OnDisplayResult (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageResult::OnGetData (WPARAM wParam, LPARAM lParam)
{
	LVCOLUMN lvcolumn;
...
BOOL CuDlgSqlQueryPageResult::OnInitDialog() 
{
	...
	LONG_PTR style = GetWindowLongPtr (m_ListCtrl.m_hWnd, GWL_STYLE);
	style |= LVS_SHOWSELALWAYS;
	SetWindowLongPtr (m_ListCtrl.m_hWnd, GWL_STYLE, style);
...
LRESULT CuDlgSqlQueryPageResult::OnFetchRows (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageResult::OnChangeSetting(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageResult::OnGetSqlFont (WPARAM wParam, LPARAM lParam)
{
