...
LRESULT CuDlgSqlQueryPageQep::OnDisplayHeader (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageQep::OnHighlightStatement (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageQep::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageQep::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	TC_ITEM tcitem;
...
LRESULT CuDlgSqlQueryPageQep::OnGetTabBitmap (WPARAM wParam, LPARAM lParam)
{
	return (LONG)BM_QEP;
}