			...
			if (!bFoundStylesheet)
			{
				...
				while (nPos0x0d != -1)
				{
					...
					else
					{
						...
						wf.Write ((const void*)consttchszReturn, (UINT)_tcslen(consttchszReturn));
					}
...
LRESULT CuDlgSqlQueryPageXML::OnDisplayHeader (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageXML::OnHighlightStatement (WPARAM wParam, LPARAM lParam)
{
	CfSqlQueryFrame* pParent = (CfSqlQueryFrame*)GetParentFrame();
	ASSERT_VALID (pParent);
	if (!pParent)
...
LRESULT CuDlgSqlQueryPageXML::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageXML::OnGetTabBitmap (WPARAM wParam, LPARAM lParam)
{
	return (LONG)BM_XML;
}

LRESULT CuDlgSqlQueryPageXML::OnDisplayResult (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageXML::OnFetchRows (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageXML::OnChangeSetting(WPARAM wParam, LPARAM lParam)
{
