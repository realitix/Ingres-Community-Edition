...
LRESULT CuDlgSqlQueryPageRaw::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageRaw::OnDisplayResult (WPARAM wParam, LPARAM lParam)
{
	return (LONG)0L;
}
...
LRESULT CuDlgSqlQueryPageRaw::OnGetTabBitmap (WPARAM wParam, LPARAM lParam)
{
	return (LONG)BM_TRACE;
}


LRESULT CuDlgSqlQueryPageRaw::OnHighlightStatement (WPARAM wParam, LPARAM lParam)
{
	CfSqlQueryFrame* pFrame = (CfSqlQueryFrame*)GetParentFrame();
	ASSERT (pFrame);
	if (!pFrame)
...
LRESULT CuDlgSqlQueryPageRaw::OnChangeSetting (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageRaw::OnGetSqlFont    (WPARAM wParam, LPARAM lParam)
{
