...
protected:
	...
	//}}AFX_MSG
	afx_msg LRESULT OnDisplayHeader      (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnHighlightStatement (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnDisplayResult      (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnGetData            (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnFetchRows          (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnCloseCursor        (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnGetTabBitmap       (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnChangeSetting      (WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnGetSqlFont         (WPARAM wParam, LPARAM lParam);
