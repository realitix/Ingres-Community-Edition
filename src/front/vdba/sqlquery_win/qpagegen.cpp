...
LRESULT CuDlgSqlQueryPageGeneric::OnDisplayHeader (WPARAM wParam, LPARAM lParam)
{
	m_bShowStatement = TRUE;
	return 0L;
}

LRESULT CuDlgSqlQueryPageGeneric::OnHighlightStatement (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageGeneric::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
LRESULT CuDlgSqlQueryPageGeneric::OnGetTabBitmap (WPARAM wParam, LPARAM lParam)
{
