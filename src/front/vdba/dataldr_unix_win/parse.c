...
{
   size_t len=STlength(lpString2Find);
   while(*lpstring !=EOS) {
      if (!STbcompare(lpstring, (i4)STlength(lpstring), lpString2Find,(i4)len, 1))
...
{
	size_t nLen = STlength(pCurrentToken);
