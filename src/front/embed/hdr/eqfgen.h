...
**	    Drop obsolete ports.
**              23-May-2011 (maspa05) Bug 125361
**                      Definitions of CONT_STATE and CONT_STR no longer
**                      depend on STRICT_F77_STD. They now refer to the F77
**                      versions (tab format). Added CONT_STATE_STD and
**                      CONT_STR_STD to refer to Ansi (standard format).
**                      This is to allow dynamic switching based on environment
**                      variable II_FORTRAN_FORMAT
**              23-May-2011 (maspa05) Bug 125361
**                      G_LINELEN also needs to correspond to output format.
**                      Added G_LINELEN_STD
**			
*/
...
#	 define CONT_STR_STD	ERx("\n     &")
#	 define CONT_STATE_STD	ERx("\n     &")
