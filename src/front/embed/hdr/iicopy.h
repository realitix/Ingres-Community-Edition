...
typedef struct {
    ...
    */
    ...
    u_char	cp_delim[CPY_MAX_DELIM+2];/* domain delimiter; the +2 is to
...
typedef struct {
    ...
    bool	cp_vwload;		/* Is this a VWLOAD pseudo-copy? */
    ...
    II_CP_TOKEN_STRUCT *cp_token_struct;  /* Connect info, only if vwload */
