...
**	22-mar-2010 (dougi)
**	    Add "call vectorwise" double keyword.
**	12-Apr-2010 (gupsh01)
...
**	    Integrate r2355 fix to drop VALUE as a reserved word.
...
/* 93 */	"exists",	tIF_EXISTS,	"if exists",
/* 94 */	"vectorwise",	tCALLVW,	"call vectorwise",
/* 95 */	"diacritical",	tWODIACRIT,	"without diacritical",
/* 96 */	"diacritical",	tWITHDIACRIT,	"with diacritical"
};
